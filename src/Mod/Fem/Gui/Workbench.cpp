...
void Workbench::setupContextMenu(const char* recipient, Gui::MenuItem* item) const
{
    ...
    *item << "Separator" << "FEM_MeshClear" << "FEM_MeshDisplayInfo";
}
...
Gui::ToolBarItem* Workbench::setupToolBars() const
{
    ...
    *model << "FEM_Analysis" << "Separator" << "FEM_MaterialSolid" << "FEM_MaterialFluid"
           << "FEM_MaterialMechanicalNonlinear" << "FEM_MaterialReinforced" << "FEM_MaterialEditor"
           << "Separator" << "FEM_ElementGeometry1D" << "FEM_ElementRotation1D"
           << "FEM_ElementGeometry2D" << "FEM_ElementFluid1D";
    ...
    *fluid << "FEM_ConstraintInitialFlowVelocity" << "FEM_ConstraintInitialPressure" << "Separator"
           << "FEM_ConstraintFlowVelocity";

    Gui::ToolBarItem* geom = new Gui::ToolBarItem(root);
    geom->setCommand("Geometrical analysis features");
    *geom << "FEM_ConstraintPlaneRotation" << "FEM_ConstraintSectionPrint"
    ...
    *mech << "FEM_ConstraintFixed" << "FEM_ConstraintDisplacement" << "FEM_ConstraintContact"
          << "FEM_ConstraintTie" << "FEM_ConstraintSpring" << "Separator" << "FEM_ConstraintForce"
          << "FEM_ConstraintPressure" << "FEM_ConstraintCentrif" << "FEM_ConstraintSelfWeight";

    Gui::ToolBarItem* thermal = new Gui::ToolBarItem(root);
    thermal->setCommand("Thermal boundary conditions and loads");
    *thermal << "FEM_ConstraintInitialTemperature" << "Separator" << "FEM_ConstraintHeatflux"
             << "FEM_ConstraintTemperature" << "FEM_ConstraintBodyHeatSource";
...
#endif
    *mesh << "FEM_MeshGmshFromShape" << "Separator" << "FEM_MeshBoundaryLayer" << "FEM_MeshRegion"
          << "FEM_MeshGroup" << "Separator" << "FEM_FEMMesh2Mesh";
    ...
    *solve << "Separator" << "FEM_CompMechEquations" << "FEM_CompEmEquations" << "FEM_EquationFlow"
           << "FEM_EquationFlux" << "FEM_EquationHeat" << "Separator" << "FEM_SolverControl"
           << "FEM_SolverRun";
...
#ifdef FC_USE_VTK
    *results << "Separator" << "FEM_PostApplyChanges" << "FEM_PostPipelineFromResult" << "Separator"
             << "FEM_PostFilterWarp" << "FEM_PostFilterClipScalar" << "FEM_PostFilterCutFunction"
             << "FEM_PostFilterClipRegion" << "FEM_PostFilterContours"
             << "FEM_PostFilterDataAlongLine" << "FEM_PostFilterLinearizedStresses"
             << "FEM_PostFilterDataAtPoint" << "Separator" << "FEM_PostCreateFunctions";
#endif

    Gui::ToolBarItem* utils = new Gui::ToolBarItem(root);
    utils->setCommand("Utilities");
    *utils << "FEM_ClippingPlaneAdd" << "FEM_ClippingPlaneRemoveAll" << "FEM_Examples";
...
Gui::MenuItem* Workbench::setupMenuBar() const
{
    ...
    *material << "FEM_MaterialSolid" << "FEM_MaterialFluid" << "FEM_MaterialMechanicalNonlinear"
              << "FEM_MaterialReinforced" << "FEM_MaterialEditor";

    Gui::MenuItem* elegeom = new Gui::MenuItem;
    elegeom->setCommand("&Element Geometry");
    *elegeom << "FEM_ElementGeometry1D" << "FEM_ElementRotation1D" << "FEM_ElementGeometry2D"
             << "FEM_ElementFluid1D";

    Gui::MenuItem* elec = new Gui::MenuItem;
    elec->setCommand("&Electromagnetic boundary conditions");
    *elec << "FEM_ConstraintElectrostaticPotential" << "FEM_ConstraintCurrentDensity"
    ...
    *model << "FEM_Analysis" << "Separator" << material << elegeom << "Separator" << elec << fluid
           << geom << mech << thermal
           << "Separator"
           //        << nosolver
           //        << "Separator"
    ...
    *mesh << "FEM_MeshGmshFromShape" << "Separator" << "FEM_MeshBoundaryLayer" << "FEM_MeshRegion"
    ...
    solve->setCommand("&Solve");
    *solve << "FEM_SolverCalculixCxxtools" << "FEM_SolverElmer" << "FEM_SolverMystran"
           << "FEM_SolverZ88" << "Separator" << "FEM_CompMechEquations" << "FEM_CompEmEquations"
           << "FEM_EquationFlow" << "FEM_EquationFlux" << "FEM_EquationHeat" << "Separator"
           << "FEM_SolverControl" << "FEM_SolverRun";
