    ...
    , ui(new Ui_TaskFemConstraintBearing)
{
    ...
    // setup ranges
    ui->spinDiameter->setMinimum(FLT_MIN);
    ui->spinDiameter->setMaximum(FLT_MAX);
    ui->spinOtherDiameter->setMinimum(FLT_MIN);
    ui->spinOtherDiameter->setMaximum(FLT_MAX);
    ui->spinCenterDistance->setMinimum(FLT_MIN);
    ui->spinCenterDistance->setMaximum(FLT_MAX);
    ui->spinForce->setMinimum(FLT_MIN);
    ui->spinForce->setMaximum(FLT_MAX);
    ui->spinTensionForce->setMinimum(FLT_MIN);
    ui->spinTensionForce->setMaximum(FLT_MAX);
    ui->spinDistance->setMinimum(FLT_MIN);
