...
{  // Note change "RigidBody" in line above to new constraint name
    ...
    ui->qsb_ref_node_x->setMinimum(FLT_MIN);
    ui->qsb_ref_node_x->setMaximum(FLT_MAX);
    ui->qsb_ref_node_y->setMinimum(FLT_MIN);
    ui->qsb_ref_node_y->setMaximum(FLT_MAX);
    ui->qsb_ref_node_z->setMinimum(FLT_MIN);
    ...
    ui->qsb_disp_x->setMinimum(FLT_MIN);
    ui->qsb_disp_x->setMaximum(FLT_MAX);
    ui->qsb_disp_y->setMinimum(FLT_MIN);
    ui->qsb_disp_y->setMaximum(FLT_MAX);
    ui->qsb_disp_z->setMinimum(FLT_MIN);
    ...
    ui->qsb_force_x->setMinimum(FLT_MIN);
    ui->qsb_force_x->setMaximum(FLT_MAX);
    ui->qsb_force_y->setMinimum(FLT_MIN);
    ui->qsb_force_y->setMaximum(FLT_MAX);
    ui->qsb_force_z->setMinimum(FLT_MIN);
    ...
    ui->qsb_moment_x->setMinimum(FLT_MIN);
    ui->qsb_moment_x->setMaximum(FLT_MAX);
    ui->qsb_moment_y->setMinimum(FLT_MIN);
    ui->qsb_moment_y->setMaximum(FLT_MAX);
    ui->qsb_moment_z->setMinimum(FLT_MIN);
