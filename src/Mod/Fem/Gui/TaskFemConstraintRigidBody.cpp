...
{  // Note change "RigidBody" in line above to new constraint name
    ...
    ui->qsb_ref_node_x->setMinimum(-FLT_MAX);
    ui->qsb_ref_node_x->setMaximum(FLT_MAX);
    ui->qsb_ref_node_y->setMinimum(-FLT_MAX);
    ui->qsb_ref_node_y->setMaximum(FLT_MAX);
    ui->qsb_ref_node_z->setMinimum(-FLT_MAX);
    ui->qsb_ref_node_z->setMaximum(FLT_MAX);
    ...
    ui->qsb_disp_x->setMinimum(-FLT_MAX);
    ui->qsb_disp_x->setMaximum(FLT_MAX);
    ui->qsb_disp_y->setMinimum(-FLT_MAX);
    ui->qsb_disp_y->setMaximum(FLT_MAX);
    ui->qsb_disp_z->setMinimum(-FLT_MAX);
    ui->qsb_disp_z->setMaximum(FLT_MAX);
    ...
    ui->spb_rot_axis_x->setMinimum(-FLT_MAX);
    ui->spb_rot_axis_x->setMaximum(FLT_MAX);
    ui->spb_rot_axis_y->setMinimum(-FLT_MAX);
    ui->spb_rot_axis_y->setMaximum(FLT_MAX);
    ui->spb_rot_axis_z->setMinimum(-FLT_MAX);
    ui->spb_rot_axis_z->setMaximum(FLT_MAX);
    ui->qsb_rot_angle->setMinimum(-FLT_MAX);
    ...
    ui->qsb_force_x->setMinimum(-FLT_MAX);
    ui->qsb_force_x->setMaximum(FLT_MAX);
    ui->qsb_force_y->setMinimum(-FLT_MAX);
    ui->qsb_force_y->setMaximum(FLT_MAX);
    ui->qsb_force_z->setMinimum(-FLT_MAX);
    ui->qsb_force_z->setMaximum(FLT_MAX);
    ...
    ui->qsb_moment_x->setMinimum(-FLT_MAX);
    ui->qsb_moment_x->setMaximum(FLT_MAX);
    ui->qsb_moment_y->setMinimum(-FLT_MAX);
    ui->qsb_moment_y->setMaximum(FLT_MAX);
    ui->qsb_moment_z->setMinimum(-FLT_MAX);
    ui->qsb_moment_z->setMaximum(FLT_MAX);
