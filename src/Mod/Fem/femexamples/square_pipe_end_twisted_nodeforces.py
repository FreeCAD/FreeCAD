...
def setup(doc=None, solvertype="ccxtools"):
    ...
    points_forces = [Part.Vertex(-142.5, 142.5, 0.0), Part.Vertex(-142.5, -142.5, 0.0), Part.Vertex(-142.5, 95.0, 0.0),
                     Part.Vertex(-142.5, 47.5, 0.0), Part.Vertex(-142.5, 0.0, 0.0), Part.Vertex(-142.5, -47.5, 0.0),
                     Part.Vertex(-142.5, -95.0, 0.0), Part.Vertex(142.5, -142.5, 0.0), Part.Vertex(-95.0, -142.5, 0.0),
                     Part.Vertex(-47.5, -142.5, 0.0), Part.Vertex(0.0, -142.5, 0.0), Part.Vertex(47.5, -142.5, 0.0),
                     Part.Vertex(95.0, -142.5, 0.0), Part.Vertex(142.5, 142.5, 0.0), Part.Vertex(142.5, -95.0, 0.0),
                     Part.Vertex(142.5, -47.5, 0.0), Part.Vertex(142.5, 0.0, 0.0), Part.Vertex(142.5, 47.5, 0.0),
                     Part.Vertex(142.5, 95.0, 0.0), Part.Vertex(95.0, 142.5, 0.0), Part.Vertex(47.5, 142.5, 0.0),
                     Part.Vertex(0.0, 142.5, 0.0), Part.Vertex(-47.5, 142.5, 0.0), Part.Vertex(-95.0, 142.5, 0.0),
                     Part.Vertex(-142.5, 118.75, 0.0), Part.Vertex(-142.5, -118.75, 0.0),
                     Part.Vertex(-142.5, 71.25, 0.0), Part.Vertex(-142.5, 23.75, 0.0), Part.Vertex(-142.5, -23.75, 0.0),
                     Part.Vertex(-142.5, -71.25, 0.0), Part.Vertex(118.75, -142.5, 0.0),
                     Part.Vertex(-71.25, -142.5, 0.0), Part.Vertex(-118.75, -142.5, 0.0),
                     Part.Vertex(-23.75, -142.5, 0.0), Part.Vertex(23.75, -142.5, 0.0), Part.Vertex(71.25, -142.5, 0.0),
                     Part.Vertex(142.5, 118.75, 0.0), Part.Vertex(142.5, -71.25, 0.0), Part.Vertex(142.5, -118.75, 0.0),
                     Part.Vertex(142.5, -23.75, 0.0), Part.Vertex(142.5, 23.75, 0.0), Part.Vertex(142.5, 71.25, 0.0),
                     Part.Vertex(71.25, 142.5, 0.0), Part.Vertex(118.75, 142.5, 0.0), Part.Vertex(23.75, 142.5, 0.0),
                     Part.Vertex(-23.75, 142.5, 0.0), Part.Vertex(-71.25, 142.5, 0.0), Part.Vertex(-118.75, 142.5, 0.0)]

    points_fixes = [Part.Vertex(-142.5, 142.5, 1000.0), Part.Vertex(-142.5, -142.5, 1000.0),
                    Part.Vertex(-142.5, 95.0, 1000.0), Part.Vertex(-142.5, 47.5, 1000.0),
                    Part.Vertex(-142.5, 0.0, 1000.0), Part.Vertex(-142.5, -47.5, 1000.0),
                    Part.Vertex(-142.5, -95.0, 1000.0), Part.Vertex(142.5, -142.5, 1000.0),
                    Part.Vertex(-95.0, -142.5, 1000.0), Part.Vertex(-47.5, -142.5, 1000.0),
                    Part.Vertex(0.0, -142.5, 1000.0), Part.Vertex(47.5, -142.5, 1000.0),
                    Part.Vertex(95.0, -142.5, 1000.0), Part.Vertex(142.5, 142.5, 1000.0),
                    Part.Vertex(142.5, -95.0, 1000.0), Part.Vertex(142.5, -47.5, 1000.0),
                    Part.Vertex(142.5, 0.0, 1000.0), Part.Vertex(142.5, 47.5, 1000.0), Part.Vertex(142.5, 95.0, 1000.0),
                    Part.Vertex(95.0, 142.5, 1000.0), Part.Vertex(47.5, 142.5, 1000.0), Part.Vertex(0.0, 142.5, 1000.0),
                    Part.Vertex(-47.5, 142.5, 1000.0), Part.Vertex(-95.0, 142.5, 1000.0),
                    Part.Vertex(-142.5, 118.75, 1000.0), Part.Vertex(-142.5, -118.75, 1000.0),
                    Part.Vertex(-142.5, 71.25, 1000.0), Part.Vertex(-142.5, 23.75, 1000.0),
                    Part.Vertex(-142.5, -23.75, 1000.0), Part.Vertex(-142.5, -71.25, 1000.0),
                    Part.Vertex(118.75, -142.5, 1000.0), Part.Vertex(-71.25, -142.5, 1000.0),
                    Part.Vertex(-118.75, -142.5, 1000.0), Part.Vertex(-23.75, -142.5, 1000.0),
                    Part.Vertex(23.75, -142.5, 1000.0), Part.Vertex(71.25, -142.5, 1000.0),
                    Part.Vertex(142.5, 118.75, 1000.0), Part.Vertex(142.5, -71.25, 1000.0),
                    Part.Vertex(142.5, -118.75, 1000.0), Part.Vertex(142.5, -23.75, 1000.0),
                    Part.Vertex(142.5, 23.75, 1000.0), Part.Vertex(142.5, 71.25, 1000.0),
                    Part.Vertex(71.25, 142.5, 1000.0), Part.Vertex(118.75, 142.5, 1000.0),
                    Part.Vertex(23.75, 142.5, 1000.0), Part.Vertex(-23.75, 142.5, 1000.0),
                    Part.Vertex(-71.25, 142.5, 1000.0), Part.Vertex(-118.75, 142.5, 1000.0)]
