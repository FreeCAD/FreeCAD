...
@export(
    ...
    ReadOnly=["Nodes", "NodeCount", "Edges", "EdgesOnly", "EdgeCount", "Faces", "FacesOnly", "FaceCount", "TriangleCount", "QuadrangleCount", "PolygonCount", "Volumes", "VolumeCount", "TetraCount", "HexaCount", "PyramidCount", "PrismCount", "PolyhedronCount", "SubMeshCount", "GroupCount", "Groups", "Volume"],
