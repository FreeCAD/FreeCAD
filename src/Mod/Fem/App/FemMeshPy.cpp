...
PyMethodDef FemMeshPy::Methods[] = {
    ...
    {"setStandardHypotheses",
        (PyCFunction) staticCallback_setStandardHypotheses,
        METH_VARARGS,
    ...
    {"getFacesByFace",
        (PyCFunction) staticCallback_getFacesByFace,
        METH_VARARGS,
    ...
    {"getGroupName",
        (PyCFunction) staticCallback_getGroupName,
        METH_VARARGS,
        "Return a string of group name to a given group ID"
    },
    {"getGroupElementType",
        (PyCFunction) staticCallback_getGroupElementType,
        METH_VARARGS,
        "Return a string of group element type to a given group ID"
    },
    {"getGroupElements",
        (PyCFunction) staticCallback_getGroupElements,
        METH_VARARGS,
...
PyObject * FemMeshPy::staticCallback_getGroups (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::BaseExceptionFreeCADError, "Unknown exception while reading attribute 'Groups' of object 'FemMesh'");
        return NULL;
    }
}
