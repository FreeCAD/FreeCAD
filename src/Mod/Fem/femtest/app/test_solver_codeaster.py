...
# *   Derived from test_solver_mystran.py                                   *
# *                                                                         *
...
__title__ = "Solver Code Aster FEM unit tests"
...
class TestSolverCodeAster(unittest.TestCase):
    fcc_print("import TestSolverCodeAster")
    ...
    def setUp(self):
        ...
        # more inits
        self.pre_dir_name = "solver_codeaster_"
        self.ending = ".comm"
        self.infilename = "Mesh"
        self.test_file_dir = join(testtools.get_fem_test_home_dir(), "codeaster")
    ...
    def test_00print(self):
        ...
        fcc_print(
            "\n{0}\n{1} run FEM TestSolverCodeAster tests {2}\n{0}".format(
                100 * "*", 10 * "*", 55 * "*"
            )
        )
    ...
    def input_file_writing_test(self, base_name):
        ...
        # write input file
        machine = self.document.SolverCodeAster.Proxy.createMachine(
            self.document.SolverCodeAster, working_dir, True  # set testmode to True
        )
        ...
        self.assertFalse(ret, f"CodeAster write_solver_input for {base_name} test failed.\n{ret}")
