...
def calculate_unhighlighted_color(parent_part: "PartFeature") -> highlight_color_t:
    ...
    if len(initial_color) == num_faces:
        unhighlighted_color: highlight_color_t = copy.deepcopy(initial_color)
    else:
        unhighlighted_color: highlight_color_t = [copy.deepcopy(initial_color[0])] * num_faces
...
class HighlightContext:
    def __init__(self, parent_part: "PartFeature") -> None:
        ...
        self._initial_color = copy.deepcopy(parent_part.ViewObject.DiffuseColor)
