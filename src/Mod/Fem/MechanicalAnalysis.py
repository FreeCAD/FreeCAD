...
""" Refactoring warning: 
This class is under refactoring, this file has been split into several files

 MechanicalAnalysis -> CaeAnalysis (general class) + JobControlTaskPanel (general class) + FemResultTaskPanel+ FemCommands.py
Just split a big class into several class, thereby, half code is reusable. 

C++ code should load only FemCommands.py, instead of  MechanicalAnalysis
"""

from JobControlTaskPanel import _JobControlTaskPanel
from FemResultControlTaskPanel import _ResultControlTaskPanel
