...
def RePopulateIcons():
    ...
    a3.setIcon(QtGui.QIcon(":/icons/NavigationFusion360_" + StyleSheetType + ".svg"))
...
a3.setText("Fusion 360  ")
a3.setData("Gui::Fusion360NavigationStyle")
a3.setObjectName("Indicator_NavigationFusion360")
