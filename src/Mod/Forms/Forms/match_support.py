...
"""Support geometry and boundary helpers shared by Forms matching and curvature."""
...
def _validate_match_mode(continuity, tangent_mode, tangent_face):
    if continuity not in ("Connected", "Tangent", "Curvature"):
        raise ValueError("Match continuity must be Connected, Tangent, or Curvature")
    if continuity in ("Tangent", "Curvature") and tangent_face is None:
        raise ValueError("Tangent and Curvature Match require a face or planar closed wire")
