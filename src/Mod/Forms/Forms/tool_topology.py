...
class TopologyTool(ToolController):
    ...
    def stop_surface_tool(self):
        ...
        if self.surface_tool_callback is not None:
            try:
                ...
                # The view may already have removed its callbacks during document shutdown.
                pass
            self.surface_tool_callback = None
        ...
        if hasattr(self.session.view, "deactivateToolHandler"):
            try:
                ...
                # A closing view no longer needs its tool cursor reset.
                pass
    ...
    def _hovered_insert_point(self, position):
        ...
        try:
            ...
            # Fall back to object info when preselection is unavailable or stale.
            pass
        ...
        if info:
            ...
            if (
                ...
                try:
                    ...
                    # Keep the preselection point if object info has invalid coordinates.
                    pass
        shape_edge = None
        mapped = ()
        for name in names:
    ...
    def _restore_surface_tool_cursor(self):
        ...
        try:
            ...
            # A closing view cannot restore the cursor; tool cleanup can still finish.
            pass
