...
// This File is normaly build as an include in DrawPagePyImp.cpp! Its not intended to be in a project!
...
PyMethodDef DrawPagePy::Methods[] = {
    {"addView",
        (PyCFunction) staticCallback_addView,
        METH_VARARGS,
        "addView(DrawView) - Add a View to this Page"
    },
    {"removeView",
        (PyCFunction) staticCallback_removeView,
        METH_VARARGS,
        "removeView(DrawView) - Remove a View to this Page"
    },
    {"getPageWidth",
        (PyCFunction) staticCallback_getPageWidth,
        METH_VARARGS,
        "Return the width of this page"
    },
    {"getPageHeight",
        (PyCFunction) staticCallback_getPageHeight,
        METH_VARARGS,
        "Return the height of this page"
    },
    {"getPageOrientation",
        (PyCFunction) staticCallback_getPageOrientation,
        METH_VARARGS,
...
//--------------------------------------------------------------------------
PyObject *DrawPagePy::_repr(void)
{
...
//--------------------------------------------------------------------------
PyObject *DrawPagePy::_getattr(char *attr)				// __getattr__ function: note only need to handle new state
{
    try {
...
int DrawPagePy::_setattr(char *attr, PyObject *value) // __setattr__ function: note only need to handle new state
{
    try {
...
DrawPage *DrawPagePy::getDrawPagePtr(void) const
{
