...
#ifndef TECHDRAW_PropertyCosmeticList_H
#define TECHDRAW_PropertyCosmeticList_H
...
class TechDrawExport PropertyCosmeticList: public App::PropertyLists
{
    TYPESYSTEM_HEADER();

public:
    // virtual ~PropertyCosmeticList();
...
private:
    std::vector<Cosmetic*> _lValueList;
};

} // namespace TechDraw


#endif // TECHDRAW_PropertyCosmeticList_H
