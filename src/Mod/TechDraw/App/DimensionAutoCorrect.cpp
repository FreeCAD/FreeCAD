...
bool DimensionAutoCorrect::findExactEdge3d(ReferenceEntry& refToFix, const Part::TopoShape& refGeom) const
{
    ...
    for (auto& objectName : m_3dObjectCache) {
        auto object3d = getDimension()->getDocument()->getObject(objectName.c_str());
        auto shape3d = Part::Feature::getShape(object3d, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
                                                      ...
                                                      bool exact) const
{
    ...
    (void)exact;
    auto shape3d = Part::Feature::getShape(obj, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
    if (shape3d.IsNull()) {
        // how to handle this?
        return {};
    }
