...
// This File is normaly build as an include in DrawParametricTemplatePyImp.cpp! Its not intended to be in a project!
...
PyMethodDef DrawParametricTemplatePy::Methods[] = {
    {"drawLine",
        (PyCFunction) staticCallback_drawLine,
        METH_VARARGS,
        "Draw a line"
    },
...
PyObject * DrawParametricTemplatePy::staticCallback_getGeometryCount (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::BaseExceptionFreeCADError, "Unknown exception while reading attribute 'GeometryCount' of object 'DrawParametricTemplate'");
        return NULL;
    }
}
...
//--------------------------------------------------------------------------
PyObject *DrawParametricTemplatePy::_repr(void)
{
...
//--------------------------------------------------------------------------
PyObject *DrawParametricTemplatePy::_getattr(char *attr)				// __getattr__ function: note only need to handle new state
{
    try {
...
int DrawParametricTemplatePy::_setattr(char *attr, PyObject *value) // __setattr__ function: note only need to handle new state
{
    try {
...
DrawParametricTemplate *DrawParametricTemplatePy::getDrawParametricTemplatePtr(void) const
{
