...
TopoDS_Wire DrawComplexSection::makeProfileWire(App::DocumentObject* toolObj)
{
    ...
    TopoDS_Shape toolShape = Part::Feature::getShape(toolObj, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
    if (toolShape.IsNull()) {
        return {};
    }
...
bool DrawComplexSection::canBuild(gp_Ax2 sectionCS, App::DocumentObject* profileObject)
{
    ...
    TopoDS_Shape shape = Part::Feature::getShape(profileObject, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
...
bool DrawComplexSection::isProfileObject(App::DocumentObject* obj)
{
    ...
    TopoDS_Shape shape = Part::Feature::getShape(obj, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
    if (shape.IsNull()) {
        return false;
    }
