...
# *                                                                         *
# ***************************************************************************
"""Provides the TechDraw 3DLengthDimension GuiCommand."""

__title__ = "TechDrawTools.Command3DLengthDimension"
__author__ = "edi"
...
class Command3DLengthDimension:
    ...
    def GetResources(self):
        ...
        return {'Pixmap': 'actions/TechDraw_3DLengthDimension.svg',
                'Accel': "",
                'MenuText': QT_TRANSLATE_NOOP("TechDraw_3DLengthDimension", "3D length dimension"),
                'ToolTip': QT_TRANSLATE_NOOP("TechDraw_3DLengthDimension", "Create a 3D length dimension<br>\
                - select first edge to define direction and length of the dimension line<br>\
                - select second edge to define the (in 3D orthogonal) direction of the reference line<br>\
                - optional: select two more vertexes which define the measure")}

    def Activated(self):
        """Run the following code when the command is activated (button press)."""
        print("3D length dimension activated")
...
Gui.addCommand('TechDraw_3DLengthDimension', Command3DLengthDimension())
