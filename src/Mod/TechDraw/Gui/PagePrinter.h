...
public:
    ...
    static QPageLayout getDefaultLayout(TechDraw::DrawPage* pageObject);

    // TBD: Can be deleted as unnecessary. If references cleaned away
    // static PaperAttributes getPaperAttributes(TechDraw::DrawPage* pageObject);

    // TBD: Can be deleted as unnecessary.
    // static PaperAttributes getPaperAttributes(ViewProviderPage* vpPage);
    // static QPageLayout getPageLayout(TechDraw::DrawPage* pageObject);
