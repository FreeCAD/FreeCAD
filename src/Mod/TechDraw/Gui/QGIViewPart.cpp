...
void QGIViewPart::drawViewPart()
{
    ...
    // Draw Edges
    std::vector<edgeWrap> edges = viewpart->getEdgeGeometry();
    drawEdge(edges);
...
void QGIViewPart::drawEdge(std::vector<edgeWrap> edges) {
    TechDraw::BaseGeomPtrVector::const_iterator itEdge = geoms.begin();
