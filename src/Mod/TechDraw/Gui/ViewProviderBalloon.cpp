...
ViewProviderBalloon::ViewProviderBalloon()
{
    ...
    ADD_PROPERTY_TYPE(Fontsize, (Preferences::dimFontSizeMM()),
                                group, App::Prop_None, "Balloon text size in units");
    int lgNumber = Preferences::lineGroup();
    auto lg = TechDraw::LineGroup::lineGroupFactory(lgNumber);
    double weight = lg->getWeight("Thin");
    delete lg;                                   //Coverity CID 174670
    ADD_PROPERTY_TYPE(LineWidth, (weight), group, App::Prop_None, "Leader line width");
    ADD_PROPERTY_TYPE(LineVisible, (true), group, App::Prop_None, "Balloon line visible or hidden");
