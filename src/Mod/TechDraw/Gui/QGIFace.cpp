...
{
    QColor color = App::Color(static_cast<uint32_t>(Preferences::getPreferenceGroup("Colors")->GetUnsigned("FaceColor", COLWHITE)))
                   .asValue<QColor>();
...
{
    setHatchColor(App::Color::fromValue(color));
}
