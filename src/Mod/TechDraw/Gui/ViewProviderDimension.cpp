...
ViewProviderDimension::ViewProviderDimension()
{
    ...
    ADD_PROPERTY_TYPE(Fontsize, (Preferences::dimFontSizeMM()), group,App::Prop_None, "Dimension text size in units");
    ADD_PROPERTY_TYPE(LineWidth, (prefWeight()), group, App::Prop_None, "Dimension line width");
