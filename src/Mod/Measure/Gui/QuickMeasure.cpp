...
void QuickMeasure::printResult()
{
    ...
    slow down in selection of complex solids.
        ...
        print(tr("Area: %1, Radius: %2").arg(areaStr(measurement->area()), lenghtStr(measurement->radius())));
    }
        ...
        print(tr("Angle: %1, Total length: %2").arg(lenghtStr(measurement->angle()), lenghtStr(measurement->length())));
    }
