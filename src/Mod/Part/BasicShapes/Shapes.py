...
class TubeFeature:
    def __init__(self, obj):
        obj.Proxy = self
        obj.addLockedProperty("App::PropertyLength","OuterRadius","Tube","Outer radius").OuterRadius = 5.0
        obj.addLockedProperty("App::PropertyLength","InnerRadius","Tube","Inner radius").InnerRadius = 2.0
        obj.addLockedProperty("App::PropertyLength","Height","Tube", "Height of the tube").Height = 10.0
