...
)
{
    ...
    auto* linear = pattern->getExtension<Part::LinearPatternExtension>();
    auto* polar = pattern->getExtension<Part::PolarPatternExtension>();
    if (!linear && !polar) {
...
void TaskPatternParameters::bindPatternProperties()
{
    ...
    if (auto* linear = pattern->getExtension<Part::LinearPatternExtension>()) {
    ...
    if (auto* polar = pattern->getExtension<Part::PolarPatternExtension>()) {
        parametersWidget->bindProperties(
            &polar->Axis,
            &polar->Reversed,
            &polar->Mode,
...
void TaskPatternParameters::applyPatternParameters(App::DocumentObject* pattern) const
{
    ...
    if (pattern->getExtension<Part::LinearPatternExtension>()) {
    ...
    if (pattern->getExtension<Part::PolarPatternExtension>()) {
...
void TaskPatternParameters::updatePatternSpacingLabels()
{
    ...
    if (auto* linearPattern = pattern->getExtension<Part::LinearPatternExtension>()) {
    ...
    if (auto* polarPattern = pattern->getExtension<Part::PolarPatternExtension>()) {
        try {
