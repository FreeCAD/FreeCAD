...
std::vector<Base::Vector3d> ViewProviderPartExt::getModelPoints(const SoPickedPoint* pp) const
{
    try {
        ...
        const auto &shape = Part::Feature::getTopoShape(getObject(), Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
...
void ViewProviderPartExt::updateVisual()
{
    ...
    TopoDS_Shape cShape = Part::Feature::getShape(getObject(), Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
    if (cShape.IsNull()) {
