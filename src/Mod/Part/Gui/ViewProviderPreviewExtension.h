...
#ifndef VIEWPROVIDERPREVIEWEXTENSION_H
#define VIEWPROVIDERPREVIEWEXTENSION_H
...
class ViewProviderPreviewExtension : public Gui::ViewProviderExtension {
...
#endif //VIEWPROVIDERPREVIEWEXTENSION_H
