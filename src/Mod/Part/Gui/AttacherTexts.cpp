...
TextSet getUIStrings(Base::Type attacherType, eMapMode mmode)
{
    if (attacherType.isDerivedFrom(AttachEngine3D::getClassTypeId())) {
        ...
        switch (mmode) {
            case mmDeactivated:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D",
                                    "Attachment is disabled. Object can be moved by editing "
                                    "Placement property.",
            ...
            case mmTranslate:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D",
                                    "Origin is aligned to match Vertex. Orientation is controlled "
                                    "by Placement property.",
                                    "Attachment3D mode tooltip"));
            case mmObjectXY:
                return TwoStrings(
            ...
            case mmParallelPlane:
                return TwoStrings(qApp->translate("Attacher3D",
                                                  "XY parallel to plane",
                                                  "Attachment3D mode caption"),
                                  qApp->translate("Attacher3D",
                                                  "X' Y' plane is parallel to the plane (object's "
                                                  "XY) and passes through the vertex.",
                                                  "Attachment3D mode tooltip"));
            case mmFlatFace:
                return TwoStrings(
            ...
            case mmNormalToPath:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D",
                                    "Z' axis is aligned to be tangent to edge. Optional vertex "
                                    "link defines where.",
                                    "Attachment3D mode tooltip"));
            case mmFrenetNB:
                return TwoStrings(
            ...
            case mmConcentric:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D",
                                    "Align XY plane to osculating circle of an edge. Optional "
            ...
            case mmRevolutionSection:
                return TwoStrings(
                    qApp->translate("Attacher3D",
                                    ...
                                    "Attachment3D mode caption"),
                    qApp->translate("Attacher3D",
                                    "Align Y' axis to match axis of osculating circle of an edge. "
                                    "Optional vertex link defines where.",
                                    "Attachment3D mode tooltip"));
            ...
            case mmThreePointsNormal:
                return TwoStrings(qApp->translate("Attacher3D",
                                                  ...
                                                  "Attachment3D mode caption"),
                                  qApp->translate("Attacher3D",
                                                  "Align XZ plane to pass through 3 points; X axis "
                                                  "will pass through two first points.",
                                                  "Attachment3D mode tooltip"));
            case mmFolding:
                return TwoStrings(
            ...
            case mmInertialCS:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D",
                                    "Inertial coordinate system, constructed on principal axes of "
            ...
            case mmOZX:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align Z' and X' axes towards "
                                    "vertex/along line.",
                                    "Attachment3D mode tooltip"));
            case mmOZY:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align Z' and Y' axes towards "
                                    "vertex/along line.",
                                    "Attachment3D mode tooltip"));
            case mmOXY:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align X' and Y' axes towards "
                                    "vertex/along line.",
                                    "Attachment3D mode tooltip"));
            case mmOXZ:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align X' and Z' axes towards "
                                    "vertex/along line.",
                                    "Attachment3D mode tooltip"));
            case mmOYZ:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align Y' and Z' axes towards "
                                    "vertex/along line.",
                                    "Attachment3D mode tooltip"));
            case mmOYX:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align Y' and X' axes towards "
                                    "vertex/along line.",
                                    "Attachment3D mode tooltip"));
            default:
                break;
        ...
        switch (mmode) {
            case mmDeactivated:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher2D",
                                    "Attachment is disabled. Object can be moved by editing "
                                    "Placement property.",
                                    "AttachmentPlane mode tooltip"));
            case mmTranslate:
                return TwoStrings(qApp->translate("Attacher2D",
                                                  "Translate origin",
                                                  "AttachmentPlane mode caption"),
                                  qApp->translate("Attacher2D",
                                                  "Origin is aligned to match Vertex. Orientation "
                                                  "is controlled by Placement property.",
                                                  "AttachmentPlane mode tooltip"));
            case mmObjectXY:
                return TwoStrings(
            ...
            case mmThreePointsNormal:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher2D",
                                    ...
                                    "to plane that passes through three vertices.",
                                    "AttachmentPlane mode tooltip"));
            case mmFolding:
                return TwoStrings(
            ...
            case mmInertialCS:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher2D",
                                    "Plane constructed on second and third principal axes of "
                                    "inertia (passes through center of mass).",
                                    "AttachmentPlane mode tooltip"));
            case mmOZX:
                return TwoStrings(
                    qApp->translate("Attacher3D", "Align O-N-X", "Attachment3D mode caption"),
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align normal and horizontal "
                                    "plane axis towards vertex/along line.",
                                    "Attachment3D mode tooltip"));
            case mmOZY:
                return TwoStrings(
                    qApp->translate("Attacher3D", "Align O-N-Y", "Attachment3D mode caption"),
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align normal and vertical "
                                    "plane axis towards vertex/along line.",
                                    "Attachment3D mode tooltip"));
            case mmOXY:
                return TwoStrings(
                    qApp->translate("Attacher3D", "Align O-X-Y", "Attachment3D mode caption"),
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align horizontal and vertical "
                                    "plane axes towards vertex/along line.",
                                    "Attachment3D mode tooltip"));
            case mmOXZ:
                return TwoStrings(
                    qApp->translate("Attacher3D", "Align O-X-N", "Attachment3D mode caption"),
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align horizontal plane axis "
                                    "and normal towards vertex/along line.",
                                    "Attachment3D mode tooltip"));
            case mmOYZ:
                return TwoStrings(
                    qApp->translate("Attacher3D", "Align O-Y-N", "Attachment3D mode caption"),
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align vertical plane axis and "
                                    "normal towards vertex/along line.",
                                    "Attachment3D mode tooltip"));
            case mmOYX:
                return TwoStrings(
                    qApp->translate("Attacher3D", "Align O-Y-X", "Attachment3D mode caption"),
                    qApp->translate("Attacher3D",
                                    "Match origin with first Vertex. Align vertical and horizontal "
                                    "plane axes towards vertex/along line.",
                                    "Attachment3D mode tooltip"));
            default:
                break;
        ...
        switch (mmode) {
            ...
            case mm1AxisZ:
                return TwoStrings(
                    ...
                    qApp->translate(
                        ...
                        "AttachmentLine mode tooltip"));
            case mm1AxisCurv:
                return TwoStrings(qApp->translate("Attacher1D",
                                                  "Axis of curvature",
                                                  "AttachmentLine mode caption"),
                                  qApp->translate("Attacher1D",
                                                  "Line that is an axis of osculating circle of "
                                                  "curved edge. Optional vertex defines where.",
                                                  "AttachmentLine mode tooltip"));
            case mm1Directrix1:
                return TwoStrings(
            ...
            case mm1Normal:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher1D",
                                    "Align to N vector of Frenet-Serret coordinate system of "
                                    "curved edge. Optional vertex link defines where.",
                                    "AttachmentLine mode tooltip"));
            case mm1Binormal:
                return TwoStrings(
                    qApp->translate("Attacher1D", "Binormal", "AttachmentLine mode caption"),
                    qApp->translate("Attacher1D",
                                    "Align to B vector of Frenet-Serret coordinate system of "
                                    "curved edge. Optional vertex link defines where.",
                                    "AttachmentLine mode tooltip"));
            case mm1TangentU:
                return TwoStrings(
                    qApp->translate("Attacher1D",
                                    "Tangent to surface (U)",
                                    "AttachmentLine mode caption"),
                    qApp->translate(
                        "Attacher1D",
        ...
        switch (mmode) {
            ...
            case mm0Origin:
                return TwoStrings(
                    qApp->translate("Attacher0D",
                                    "Object's origin",
                                    "AttachmentPoint mode caption"),
                    qApp->translate("Attacher0D",
                                    "Point is put at object's placement position. Works on objects "
                                    "with placements, and ellipse/parabola/hyperbola edges.",
                                    "AttachmentPoint mode tooltip"));
            case mm0Focus1:
                return TwoStrings(
            ...
            case mm0CenterOfCurvature:
                return TwoStrings(qApp->translate("Attacher0D",
                                                  "Center of curvature",
                                                  "AttachmentPoint mode caption"),
                                  qApp->translate("Attacher0D",
                                                  "Center of osculating circle of an edge. "
                                                  "Optional vertex link defines where.",
                                                  "AttachmentPoint mode tooltip"));
...
static struct
{
    const char* txt;
    const char* comment;
} eRefTypeStrings[] = {QT_TRANSLATE_NOOP3("Attacher", "Any", "Attacher reference type"),
...
QString getShapeTypeText(eRefType type)
{
    ...
    if (type >= 0 && type < rtDummy_numberOfShapeTypes) {
        if (eRefTypeStrings[int(type)].txt) {
            return qApp->translate("Attacher",
