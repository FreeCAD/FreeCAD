...
void goSetupResultTypedSelection(ResultEntry* entry,
...
private:
    ...
    void recursiveCheck(const BRepCheck_Analyzer& shapeCheck,
                        const TopoDS_Shape& shape,
                        ResultEntry* parent);
    void checkSub(const BRepCheck_Analyzer& shapeCheck,
                  const TopoDS_Shape& shape,
    ...
    int goBOPSingleCheck(const TopoDS_Shape& shapeIn,
                         ResultEntry* theRoot,
...
#endif
    void buildShapeContent(App::DocumentObject* pObject,
                           const QString& baseName,
                           const TopoDS_Shape& shape);
    ResultModel* model;
    QTreeView* treeView;
