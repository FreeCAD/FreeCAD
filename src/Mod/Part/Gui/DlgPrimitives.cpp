...
static QString sb_Quantity(Gui::QuantitySpinBox *qs)
{
...
QString PlanePrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        .arg(objectName,
             sb_Quantity(ui->planeLength),
             sb_Quantity(ui->planeWidth),
             placement,
...
QString BoxPrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        .arg(objectName,
             sb_Quantity(ui->boxLength),
             sb_Quantity(ui->boxWidth),
             sb_Quantity(ui->boxHeight),
             placement,
...
QString CylinderPrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        .arg(objectName,
             sb_Quantity(ui->cylinderRadius),
             sb_Quantity(ui->cylinderHeight),
             sb_Quantity(ui->cylinderAngle),
             sb_Quantity(ui->cylinderXSkew),
             sb_Quantity(ui->cylinderYSkew),
             placement,
...
QString ConePrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        .arg(objectName,
             sb_Quantity(ui->coneRadius1),
             sb_Quantity(ui->coneRadius2),
             sb_Quantity(ui->coneHeight),
             sb_Quantity(ui->coneAngle),
             placement,
...
QString SpherePrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        "App.ActiveDocument.%1.Label='%7'\n")
        .arg(objectName,
             sb_Quantity(ui->sphereRadius),
             sb_Quantity(ui->sphereAngle1),
             sb_Quantity(ui->sphereAngle2),
             sb_Quantity(ui->sphereAngle3),
             placement,
...
QString EllipsoidPrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        .arg(objectName,
             sb_Quantity(ui->ellipsoidRadius1),
             sb_Quantity(ui->ellipsoidRadius2),
             sb_Quantity(ui->ellipsoidRadius3),
             sb_Quantity(ui->ellipsoidAngle1),
             sb_Quantity(ui->ellipsoidAngle2),
             sb_Quantity(ui->ellipsoidAngle3),
             placement,
...
QString TorusPrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        "App.ActiveDocument.%1.Label='%8'\n")
        .arg(objectName,
             sb_Quantity(ui->torusRadius1),
             sb_Quantity(ui->torusRadius2),
             sb_Quantity(ui->torusAngle1),
             sb_Quantity(ui->torusAngle2),
             sb_Quantity(ui->torusAngle3),
             placement,
...
QString PrismPrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        .arg(objectName,
             ...
             sb_Quantity(ui->prismCircumradius),
             sb_Quantity(ui->prismHeight),
             sb_Quantity(ui->prismXSkew),
             sb_Quantity(ui->prismYSkew),
             placement,
...
QString WedgePrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        .arg(objectName,
             sb_Quantity(ui->wedgeXmin),
             sb_Quantity(ui->wedgeYmin),
             sb_Quantity(ui->wedgeZmin),
             sb_Quantity(ui->wedgeX2min),
             sb_Quantity(ui->wedgeZ2min),
             sb_Quantity(ui->wedgeXmax),
             sb_Quantity(ui->wedgeYmax))
        .arg(sb_Quantity(ui->wedgeZmax),
             sb_Quantity(ui->wedgeX2max),
             sb_Quantity(ui->wedgeZ2max),
             placement,
...
QString WedgePrimitive::change(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        .arg(objectName,
             ...
             sb_Quantity(ui->wedgeXmax),
             sb_Quantity(ui->wedgeYmax),
             sb_Quantity(ui->wedgeZmax))
        .arg(sb_Quantity(ui->wedgeX2max),
             sb_Quantity(ui->wedgeZ2max),
             placement);
}
...
QString HelixPrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        "App.ActiveDocument.%1.Label='%8'\n")
        .arg(objectName,
             sb_Quantity(ui->helixPitch),
             sb_Quantity(ui->helixHeight),
             sb_Quantity(ui->helixRadius),
             sb_Quantity(ui->helixAngle),
...
QString SpiralPrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        "App.ActiveDocument.%1.Label='%6'\n")
        .arg(objectName,
             sb_Quantity(ui->spiralGrowth),
             QString::number(ui->spiralRotation->value()),
             sb_Quantity(ui->spiralRadius),
             placement,
...
QString CirclePrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        "App.ActiveDocument.%1.Label='%6'\n")
        .arg(objectName,
             sb_Quantity(ui->circleRadius),
             sb_Quantity(ui->circleAngle1),
             sb_Quantity(ui->circleAngle2),
             placement,
...
QString EllipsePrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        "App.ActiveDocument.%1.Label='%7'\n")
        .arg(objectName,
             sb_Quantity(ui->ellipseMajorRadius),
             sb_Quantity(ui->ellipseMinorRadius),
             sb_Quantity(ui->ellipseAngle1),
             sb_Quantity(ui->ellipseAngle2),
             placement,
...
QString PolygonPrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        .arg(objectName,
             ...
             sb_Quantity(ui->regularPolygonCircumradius),
             placement,
...
QString LinePrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        "App.ActiveDocument.%1.Label='%9'\n")
        .arg(objectName,
             sb_Quantity(ui->edgeX1),
             sb_Quantity(ui->edgeY1),
             sb_Quantity(ui->edgeZ1),
             sb_Quantity(ui->edgeX2),
             sb_Quantity(ui->edgeY2),
             sb_Quantity(ui->edgeZ2),
             placement,
...
QString VertexPrimitive::create(const QString& objectName, const QString& placement) const
{
    return QString::fromLatin1(
        ...
        "App.ActiveDocument.%1.Label='%6'\n")
        .arg(objectName,
             sb_Quantity(ui->vertexX),
             sb_Quantity(ui->vertexY),
             sb_Quantity(ui->vertexZ),
             placement,
