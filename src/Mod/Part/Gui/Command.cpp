...
std::vector<Part::TopoShape> getShapesFromSelection()
{
    ...
    for (auto it : objs) {
        Part::TopoShape shp = Part::Feature::getTopoShape(it, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
        if (!shp.isNull()){
...
bool hasShapesInSelection()
{
    ...
    for (auto it : docobjs) {
        if (!Part::Feature::getTopoShape(it, Part::Feature::GetShapeOption::ResolveLink).isNull()) {
            hasShapes = true;
            break;
        }
    }
...
void CmdPartCut::activated(int iMsg)
{
    ...
    for (const auto & it : Sel) {
        ...
        const TopoDS_Shape& shape = Part::Feature::getShape(obj, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
...
void CmdPartFuse::activated(int iMsg)
{
    ...
    if (Sel.size() == 1){
        ...
        TopoDS_Shape sh = Part::Feature::getShape(selobj.getObject(), Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
...
void CmdPartMakeSolid::activated(int iMsg)
{
    ...
    for (auto it : objs) {
        const TopoDS_Shape& shape = Part::Feature::getShape(it, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
        if (!shape.IsNull()) {
...
void CmdPartOffset::activated(int iMsg)
{
    ...
    for (auto it : docobjs) {
        if (!Part::Feature::getTopoShape(it, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform).isNull()) {
           shapes.push_back(it);
        }
    }
    if (shapes.size() != 1) {
...
void CmdPartThickness::activated(int iMsg)
{
    ...
    if (selobjs.size() == 1) {
        ...
        topoShape = Part::Feature::getTopoShape(obj, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
        if (!topoShape.isNull()) {
...
void CmdPartRuledSurface::activated(int iMsg)
{
    ...
    if (ok && selobjs.size() <= 2) {
        if (!selobjs.empty()) {
            ...
            const Part::TopoShape& shape1 = Part::Feature::getTopoShape(docobj1, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
            if (shape1.isNull()) {
                ok = false;
            }
        ...
        if (selobjs.size() == 2) {
            ...
            const Part::TopoShape& shape2 = Part::Feature::getTopoShape(docobj2, Part::Feature::GetShapeOption::ResolveLink | Part::Feature::GetShapeOption::Transform);
            if (shape2.isNull()) {
                ok = false;
            }
