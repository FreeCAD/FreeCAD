    ...
    : plane(new SoSwitch)
{
    ADD_PROPERTY_TYPE(ShowPlane,
                      ...
                      "If true, plane of sketch is additionally rendered.");
}
...
void ViewProvider2DObject::updatePlane()
{
    ...
    SbVec3f verts[4] = {
        SbVec3f(bb.MinX - 8, bb.MinY - 5, 0),
        SbVec3f(bb.MinX - 8, bb.MaxY + 5, 0),
        SbVec3f(bb.MaxX + 8, bb.MaxY + 5, 0),
        SbVec3f(bb.MaxX + 8, bb.MinY - 5, 0),
    };
