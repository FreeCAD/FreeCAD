...
typedef Gui::ViewProviderFeaturePythonT<ViewProviderPart> ViewProviderPython;
typedef Gui::ViewProviderFeaturePythonT<ViewProviderCustom> ViewProviderCustomPython;
