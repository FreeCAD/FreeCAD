...
PyObject*
ChFi2d_AnaFilletAlgoPy::PyMake(struct _typeobject*, PyObject*, PyObject*)  // Python wrapper
{
...
int ChFi2d_AnaFilletAlgoPy::PyInit(PyObject* args, PyObject* /*kwd*/)
{
    ...
    if (PyArg_ParseTuple(args, "O!O!", &TopoShapeWirePy::Type, &wire, &PlanePy::Type, &plane)) {
        ...
        Handle(Geom_Plane) hPlane =
            Handle(Geom_Plane)::DownCast(static_cast<PlanePy*>(plane)->getGeomPlanePtr()->handle());
    ...
    if (PyArg_ParseTuple(args,
        ...
        Handle(Geom_Plane) hPlane =
            Handle(Geom_Plane)::DownCast(static_cast<PlanePy*>(plane)->getGeomPlanePtr()->handle());
        getChFi2d_AnaFilletAlgoPtr()->Init(TopoDS::Edge(shape1),
                                           TopoDS::Edge(shape2),
                                           hPlane->Pln());
        return 0;
    }
