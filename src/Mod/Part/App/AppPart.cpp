...
PyMOD_INIT_FUNC(Part)
{
    ...
    Base::ServiceProvider::get().implement<App::SubObjectPlacementProvider>(new AttacherSubObjectPlacement);
    Base::ServiceProvider::get().implement<App::CenterOfMassProvider>(new PartCenterOfMass);
