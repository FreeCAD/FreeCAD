...
App::DocumentObjectExecReturn *Chamfer::execute()
{
    ...
    try {
        TopoShape baseTopoShape = Feature::getTopoShape(link, Feature::GetShapeOption::ResolveLink | Feature::GetShapeOption::Transform);
        auto baseShape = Feature::getShape(link, Feature::GetShapeOption::ResolveLink | Feature::GetShapeOption::Transform);
