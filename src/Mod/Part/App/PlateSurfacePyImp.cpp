...
{
    static const std::array<const char*, 12> kwds_Parameter {"Surface",
                                                             "Points",
                                                             "Curves",
                                                             "Degree",
                                                             "NbPtsOnCur",
    ...
    try {
        GeomPlate_BuildPlateSurface buildPlate(Degree,
                                               NbPtsOnCur,
                                               NbIter,
                                               Tol2d,
                                               Tol3d,
...
{
    static const std::array<const char*, 8> kwds_Parameter {"Tol3d",
                                                            "MaxSegments",
                                                            "MaxDegree",
                                                            "MaxDistance",
                                                            "CritOrder",
