...
std::pair<TopoDS_Face, TopoDS_Face> getAdjacentFacesFromEdge(Part::TopoShape& edge,
...
DraggerPlacementProps getDraggerPlacementFromEdgeAndFace(Part::TopoShape& edge,
                                                         Part::TopoShape& face);
