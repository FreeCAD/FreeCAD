...
public:
    ...
    ///getter callback for the SuperPlacement attribute
    static PyObject * staticCallback_getSuperPlacement (PyObject *self, void *closure);
    /// getter for the SuperPlacement attribute
    Py::Object getSuperPlacement(void) const;
    /// setter callback for the SuperPlacement attribute
    static int staticCallback_setSuperPlacement (PyObject *self, PyObject *value, void *closure);
    /// setter for the SuperPlacement attribute
    void setSuperPlacement(Py::Object arg);
