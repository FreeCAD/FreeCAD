...
PyMethodDef PartFeaturePy::Methods[] = {
    {"test",
        (PyCFunction) staticCallback_test,
        METH_VARARGS,
        "test"
    },
...
// test() callback and implementer
// PyObject*  PartFeaturePy::test(PyObject *args){};
// has to be implemented in PartFeaturePyImp.cpp
PyObject * PartFeaturePy::staticCallback_test (PyObject *self, PyObject *args)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<PartFeaturePy*>(self)->test(args);
        if (ret != 0)
            static_cast<PartFeaturePy*>(self)->startNotify();
        return ret;
    }
