                                                      ...
                                                      TopoDS_Shape& shape) const
{
    ...
    const Part::TopoShape part = Part::Feature::getTopoShape(obj, Feature::GetShapeOption::ResolveLink | Feature::GetShapeOption::Transform);
    if (part.isNull()) {
...
App::DocumentObjectExecReturn* Loft::execute()
{
    ...
    try {
        ...
        for (auto& obj : Sections.getValues()) {
            shapes.emplace_back(getTopoShape(obj, Feature::GetShapeOption::ResolveLink | Feature::GetShapeOption::Transform));
            if (shapes.back().isNull()) {
...
App::DocumentObjectExecReturn* Sweep::execute()
{
    ...
    TopoShape spine = getTopoShape(Spine.getValue(), Feature::GetShapeOption::ResolveLink | Feature::GetShapeOption::Transform);
...
{
    std::vector<TopoShape> shapes;
    auto base = getTopoShape(Faces.getValue(), Feature::GetShapeOption::ResolveLink | Feature::GetShapeOption::Transform);
    if (base.isNull()) {
...
App::DocumentObjectExecReturn* Reverse::execute()
{
    ...
    Part::TopoShape topoShape = Part::Feature::getTopoShape(source, Feature::GetShapeOption::ResolveLink | Feature::GetShapeOption::Transform);
    if (topoShape.isNull()) {
        return new App::DocumentObjectExecReturn("No part object linked.");
    }
