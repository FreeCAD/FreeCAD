...
PyObject*
ShapeFix_FixSmallFacePy::PyMake(struct _typeobject*, PyObject*, PyObject*)  // Python wrapper
{
...
PyObject* ShapeFix_FixSmallFacePy::replaceVerticesInCaseOfSpot(PyObject* args)
{
    ...
    TopoDS_Face shape =
        TopoDS::Face(static_cast<TopoShapeFacePy*>(face)->getTopoShapePtr()->getShape());
