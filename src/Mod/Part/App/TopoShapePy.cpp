...
PyMethodDef TopoShapePy::Methods[] = {
    ...
    {"generalFuse",
        (PyCFunction) staticCallback_generalFuse,
        METH_VARARGS,
    ...
    {"makeOffset2D",
        (PyCFunction) staticCallback_makeOffset2D,
        METH_VARARGS|METH_KEYWORDS,
    ...
    {"getTolerance",
        (PyCFunction) staticCallback_getTolerance,
        METH_VARARGS,
    ...
    {"overTolerance",
        (PyCFunction) staticCallback_overTolerance,
        METH_VARARGS,
    ...
    {"limitTolerance",
        (PyCFunction) staticCallback_limitTolerance,
        METH_VARARGS,
