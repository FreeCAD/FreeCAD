...
public:
    ...
    {
        initialize(
            "This is a module working with the BRepOffsetAPI package.");  // register with Python
    }
};
...
public:
    ...
    {
        initialize(
            "This is a module working with the GeomPlate framework.");  // register with Python
    }
};
...
public:
        ...
        : Py::ExtensionModule<ShapeFixModule>("ShapeFix")
    {
        ...
        add_varargs_method("fixVertexPosition",
        ...
        add_varargs_method("leastEdgeSize",
                           &ShapeFixModule::leastEdgeSize,
                           "leastEdgeSize(shape)\n"
                           "Calculate size of least edge");
        initialize(
            "This is a module working with the ShapeFix framework.");  // register with Python
    }
...
public:
    ...
    {
        initialize(
            "This is a module working with the ShapeUpgrade framework.");  // register with Python
    }
};
...
public:
        ...
        : Py::ExtensionModule<Module>("Part")
    {
        ...
        add_varargs_method("show",
                           &Module::show,
                           "show(shape,[string]) -- Add the shape to the active document or create "
                           "one if no document exists.");
        add_varargs_method("getFacets",
                           &Module::getFacets,
                           "getFacets(shape): simplified mesh generation");
        add_keyword_method("makeCompound",
                           &Module::makeCompound,
                           "makeCompound(list) -- Create a compound out of a list of shapes.");
        add_keyword_method("makeShell",
                           &Module::makeShell,
                           "makeShell(list) -- Create a shell out of a list of faces.");
        add_keyword_method("makeFace",
                           &Module::makeFace,
                           "makeFace(list_of_shapes_or_compound, maker_class_name) -- Create a "
                           "face (faces) using facemaker class.\n"
                           "maker_class_name is a string like 'Part::FaceMakerSimple'.");
        add_keyword_method("makeFilledSurface",
                           &Module::makeFilledSurface,
                           "makeFilledSurface(list of curves, tolerance) -- Create a surface out "
                           "of a list of curves.");
        add_keyword_method("makeFilledFace",
                           &Module::makeFilledFace,
                           "makeFilledFace(list) -- Create a face out of a list of edges.");
        add_keyword_method("makeSolid",
                           &Module::makeSolid,
                           "makeSolid(shape): Create a solid out of shells of shape. If shape is a "
                           "compsolid, the overall volume solid is created.");
        add_varargs_method(
            "makePlane",
            &Module::makePlane,
        ...
        add_varargs_method("makePolygon",
                           &Module::makePolygon,
        ...
        add_varargs_method("makeCylinder",
                           &Module::makeCylinder,
                           "makeCylinder(radius,height,[pnt,dir,angle]) -- Make a cylinder with a "
                           "given radius and height\n"
                           "By default pnt=Vector(0,0,0),dir=Vector(0,0,1) and angle=360");
        add_varargs_method("makeCone",
                           &Module::makeCone,
                           "makeCone(radius1,radius2,height,[pnt,dir,angle]) -- Make a cone with "
                           "given radii and height\n"
                           "By default pnt=Vector(0,0,0), dir=Vector(0,0,1) and angle=360");
        add_varargs_method(
            "makeTorus",
            &Module::makeTorus,
        ...
        add_varargs_method("makeHelix",
                           &Module::makeHelix,
                           "makeHelix(pitch,height,radius,[angle]) -- Make a helix with a given "
                           "pitch, height and radius\n"
                           "By default a cylindrical surface is used to create the helix. If the "
                           "fourth parameter is set\n"
                           "(the apex given in degree) a conical surface is used instead");
        add_varargs_method("makeLongHelix",
                           &Module::makeLongHelix,
                           "makeLongHelix(pitch,height,radius,[angle],[hand]) -- Make a "
                           "(multi-edge) helix with a given pitch, height and radius\n"
                           "By default a cylindrical surface is used to create the helix. If the "
                           "fourth parameter is set\n"
                           "(the apex given in degree) a conical surface is used instead.");
        add_varargs_method("makeThread",
                           &Module::makeThread,
                           "makeThread(pitch,depth,height,radius) -- Make a thread with a given "
                           "pitch, depth, height and radius");
        add_varargs_method(
            "makeRevolution",
        ...
        add_keyword_method("makeShellFromWires",
        ...
        add_varargs_method("makeWireString",
                           &Module::makeWireString,
                           "makeWireString(string,fontdir,fontfile,height,[track]) -- Make list of "
                           "wires in the form of a string's characters.");
        add_varargs_method(
            "makeSplitShape",
            ...
            "Part.show(r[0][0])\n"
            "Part.show(r[1][0])\n");
        add_varargs_method("exportUnits",
                           &Module::exportUnits,
                           "exportUnits([string=MM|M|INCH|FT|MI|KM|MIL|UM|CM|UIN]) -- Set units "
                           "for exporting STEP/IGES files and returns the units.");
        add_varargs_method("setStaticValue",
                           &Module::setStaticValue,
                           "setStaticValue(string,string|int|float) -- Set a name to a value The "
                           "value can be a string, int or float.");
        add_varargs_method("cast_to_shape",
                           &Module::cast_to_shape,
                           "cast_to_shape(shape) -- Cast to the actual shape type");
        add_varargs_method("getSortedClusters",
                           &Module::getSortedClusters,
                           "getSortedClusters(list of edges) -- Helper method to sort and cluster "
                           "a variety of edges");
        add_varargs_method(
            "__sortEdges__",
            &Module::sortEdges,
        ...
        add_varargs_method("sortEdges",
                           &Module::sortEdges2,
                           "sortEdges(list of edges, [tol3d]) -- list of lists of edges\n"
                           "It does basically the same as __sortEdges__ but sorts all input edges "
                           "and thus returns\n"
                           "a list of lists of edges\n"
                           "optional 3D tolerance defaults to Precision::Confusion");
        add_varargs_method("__toPythonOCC__",
                           &Module::toPythonOCC,
                           "__toPythonOCC__(shape) -- Helper method to convert an internal shape "
                           "to pythonocc shape");
        add_varargs_method("__fromPythonOCC__",
                           &Module::fromPythonOCC,
                           "__fromPythonOCC__(occ) -- Helper method to convert a pythonocc shape "
                           "to an internal shape");
        add_varargs_method("clearShapeCache",
        ...
        add_varargs_method("splitSubname",
                           &Module::splitSubname,
        ...
        add_varargs_method("joinSubname",
                           &Module::joinSubname,
...
private:
    ...
    Py::Object makeWedge(const Py::Tuple& args)
    {
        ...
        try {
            ...
            BRepPrim_Wedge mkWedge(gp_Ax2(p, d),
                                   xmin,
                                   ymin,
                                   zmin,
                                   z2min,
    ...
    Py::Object makeSphere(const Py::Tuple& args)
    {
        ...
        try {
            ...
            BRepPrimAPI_MakeSphere mkSphere(gp_Ax2(p, d),
                                            radius,
                                            Base::toRadians<double>(angle1),
                                            Base::toRadians<double>(angle2),
    ...
    Py::Object makeCylinder(const Py::Tuple& args)
    {
        ...
        try {
            ...
            BRepPrimAPI_MakeCylinder mkCyl(gp_Ax2(p, d),
                                           radius,
                                           height,
    ...
    Py::Object makeCone(const Py::Tuple& args)
    {
        ...
        try {
            ...
            BRepPrimAPI_MakeCone mkCone(gp_Ax2(p, d),
                                        radius1,
                                        radius2,
                                        height,
                                        Base::toRadians<double>(angle));
    ...
    Py::Object makeTorus(const Py::Tuple& args)
    {
        ...
        try {
            ...
            BRepPrimAPI_MakeTorus mkTorus(gp_Ax2(p, d),
                                          radius1,
                                          radius2,
                                          Base::toRadians<double>(angle1),
                                          Base::toRadians<double>(angle2),
    ...
    Py::Object makeHelix(const Py::Tuple& args)
    {
        ...
        try {
            ...
            TopoDS_Shape wire =
                helix.makeHelix(pitch, height, radius, angle, anIsLeft, anIsVertHeight);
    ...
    Py::Object makeRevolution(const Py::Tuple& args)
    {
        ...
        try {
            ...
            BRepPrimAPI_MakeRevolution mkRev(gp_Ax2(p, d),
                                             curve,
                                             vmin,
                                             vmax,
                                             Base::toRadians<double>(angle));
    ...
    Py::Object makeWireString(const Py::Tuple& args)
    {
        ...
        try {
            ...
            throw Py::Exception(PartExceptionOCCDomainError,
        ...
        throw Py::RuntimeError(
            "FreeCAD compiled without FreeType support! This method is disabled...");
#endif
    }
    ...
    Py::Object setStaticValue(const Py::Tuple& args)
    {
        ...
        throw Py::TypeError(
            "First argument must be string and must be either string, int or float");
    }
    ...
    Py::Object toPythonOCC(const Py::Tuple& args)
    {
        ...
        try {
            ...
            proxy = Base::Interpreter().createSWIGPointerObj("OCC.TopoDS",
                                                             "TopoDS_Shape *",
    ...
    Py::Object fromPythonOCC(const Py::Tuple& args)
    {
        ...
        try {
            TopoShape* shape = new TopoShape();
            Base::Interpreter().convertSWIGPointerObj("OCC.TopoDS",
                                                      "TopoDS_Shape *",
                                                      proxy,
                                                      &ptr,
                                                      0);
    ...
    Py::Object getShape(const Py::Tuple& args, const Py::Dict& kwds)
    {
        ...
        short retType = 0;
        static const std::array<const char*, 9> kwd_list {"obj",
                                                          "subname",
                                                          "mat",
                                                          "needSubElement",
                                                          "transform",
