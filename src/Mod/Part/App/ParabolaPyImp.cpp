...
int ParabolaPy::PyInit(PyObject* args, PyObject* kwds)
{
    ...
    if (Base::Wrapped_ParseTupleAndKeywords(args, kwds, "", keywords_n)) {
        Handle(Geom_Parabola) parabola =
            Handle(Geom_Parabola)::DownCast(getGeomParabolaPtr()->handle());
    ...
    if (Base::Wrapped_ParseTupleAndKeywords(args,
        ...
        Handle(Geom_Parabola) Parab1 =
            Handle(Geom_Parabola)::DownCast(pParabola->getGeomParabolaPtr()->handle());
        Handle(Geom_Parabola) Parab2 =
            Handle(Geom_Parabola)::DownCast(this->getGeomParabolaPtr()->handle());
