...
public:
     ...
     */
    void
    getCardinalSplineTangents(const std::vector<gp_Pnt2d>&, double, std::vector<gp_Vec2d>&) const;
...
private:
    void createArcs(double tolerance,
                    ...
                    double t_end,
                    gp_Pnt2d& p_end,
                    gp_Vec2d& v_end) const;
    bool calculateBiArcPoints(const gp_Pnt2d& p0,
                              gp_Vec2d v_start,
                              const gp_Pnt2d& p4,
                              gp_Vec2d v_end,
                              gp_Pnt2d& p1,
...
public:
    ...
    static Base::Vector2d
    getCircleCenter(const Base::Vector2d& p1, const Base::Vector2d& p2, const Base::Vector2d& p3);
...
std::unique_ptr<Geom2dCurve>
makeFromTrimmedCurve2d(const Handle(Geom2d_Curve) &, double f, double l);
