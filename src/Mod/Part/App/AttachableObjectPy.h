...
#ifndef PART_ATTACHABLEOBJECTPY_H
#define PART_ATTACHABLEOBJECTPY_H
...
//===========================================================================
// AttachableObjectPy - Python wrapper
//===========================================================================

/** The python export class for AttachableObject
 */
class PartExport AttachableObjectPy : public Part::PartFeaturePy
{
public:
...
public:
    AttachableObjectPy(AttachableObject *pcObject, PyTypeObject *T = &Type);
    static PyObject *PyMake(struct _typeobject *, PyObject *, PyObject *);
    virtual int PyInit(PyObject* args, PyObject*k);
    ~AttachableObjectPy();
    

    typedef AttachableObject* PointerType ;
    ...
    AttachableObject *getAttachableObjectPtr(void) const;
...
#endif  // PART_ATTACHABLEOBJECTPY_H
