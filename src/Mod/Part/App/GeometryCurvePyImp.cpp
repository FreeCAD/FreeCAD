...
PyObject* GeometryCurvePy::discretize(PyObject* args, PyObject* kwds)
{
    try {
        ...
        if (PyArg_ParseTuple(args, "O", &dist_or_num)) {
            ...
            // use Number kwds
            static const std::array<const char*, 4> kwds_numPoints {"Number",
                                                                    "First",
                                                                    "Last",
                                                                    nullptr};
            PyErr_Clear();
            if (Base::Wrapped_ParseTupleAndKeywords(args,
                ...
                // use Abscissa kwds
                static const std::array<const char*, 4> kwds_Distance {"Distance",
                                                                       "First",
                                                                       "Last",
                                                                       nullptr};
                PyErr_Clear();
        ...
        // use Deflection kwds
        static const std::array<const char*, 4> kwds_Deflection {"Deflection",
                                                                 "First",
                                                                 "Last",
                                                                 nullptr};
        PyErr_Clear();
        ...
        static const std::array<const char*, 6> kwds_TangentialDeflection {"Angular",
                                                                           "Curvature",
                                                                           "First",
                                                                           "Last",
                                                                           "Minimum",
        ...
        if (Base::Wrapped_ParseTupleAndKeywords(args,
                                                ...
                                                &last,
                                                &minimumPoints)) {
            GCPnts_TangentialDeflection discretizer(adapt,
                                                    first,
                                                    last,
                                                    angular,
                                                    curvature,
        ...
        static const std::array<const char*, 4> kwds_QuasiNumPoints {"QuasiNumber",
                                                                     "First",
                                                                     "Last",
                                                                     nullptr};
        PyErr_Clear();
        ...
        static const std::array<const char*, 4> kwds_QuasiDeflection {"QuasiDeflection",
                                                                      "First",
                                                                      "Last",
                                                                      nullptr};
        PyErr_Clear();
...
PyObject* GeometryCurvePy::intersect2d(PyObject* args)
{
    ...
    try {
        ...
        Handle(Geom_Curve) curv =
            Handle(Geom_Curve)::DownCast(static_cast<GeometryPy*>(c)->getGeometryPtr()->handle());
        Handle(Geom_Plane) plane =
            Handle(Geom_Plane)::DownCast(static_cast<GeometryPy*>(p)->getGeometryPtr()->handle());
