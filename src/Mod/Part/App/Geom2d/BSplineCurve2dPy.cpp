...
// This File is normaly build as an include in BSplineCurve2dPyImp.cpp! Its not intended to be in a project!
...
PyMethodDef BSplineCurve2dPy::Methods[] = {
    ...
    {"getCardinalSplineTangents",
        (PyCFunction) staticCallback_getCardinalSplineTangents,
        METH_VARARGS|METH_KEYWORDS,
...
//--------------------------------------------------------------------------
PyObject *BSplineCurve2dPy::_getattr(char *attr)				// __getattr__ function: note only need to handle new state
{
    try {
...
int BSplineCurve2dPy::_setattr(char *attr, PyObject *value) // __setattr__ function: note only need to handle new state
{
    try {
