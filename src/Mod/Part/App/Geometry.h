 ...
 */
PartExport void transformAndConvertToGeometry(std::vector<std::unique_ptr<Part::Geometry>>& geos,
                                   const std::vector<TopoDS_Shape>& baseShapes,
                                   const Base::Vector3d& p1,
                                   const Base::Vector3d& p2,
                                   bool height);

PartExport std::vector<TopoDS_Shape> makeTextWires(std::string& text,
                                        std::string& fontFile,
                                        double height = 1.0,
                                        double tracking = 0.0);
}
