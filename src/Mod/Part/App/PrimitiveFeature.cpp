...
void Primitive::handleChangedPropertyType(Base::XMLReader& reader,
                                          const char* TypeName,
                                          App::Property* prop)
{
...
Line::Line()
{
    ...
    ADD_PROPERTY_TYPE(X2,
                      (0.0),
                      "Vertex 2 - Finish",
                      App::Prop_None,
                      "X value of the finish vertex");
    ADD_PROPERTY_TYPE(Y2,
                      (0.0),
                      "Vertex 2 - Finish",
                      App::Prop_None,
                      "Y value of the finish vertex");
    ADD_PROPERTY_TYPE(Z2,
                      (1.0),
                      "Vertex 2 - Finish",
                      App::Prop_None,
...
Helix::Helix()
{
    ...
    Radius.setConstraints(&quantityRange);
    ADD_PROPERTY_TYPE(SegmentLength,
                      (0.0),
                      "Helix",
                      App::Prop_None,
...
App::DocumentObjectExecReturn* Helix::execute()
{
    try {
        ...
        this->Shape.setValue(
            TopoShape()
                .makeSpiralHelix(myRadius, myRadiusTop, myHeight, nbTurns, mySegLen, myLocalCS));
...
App::DocumentObjectExecReturn* Spiral::execute()
{
    try {
        ...
        this->Shape.setValue(
            TopoShape()
                .makeSpiralHelix(myRadius, myRadiusTop, 0, myNumRot, mySegLen, Standard_False));
        GProp_GProps props;
        BRepGProp::LinearProperties(Shape.getShape().getShape(), props);
        Length.setValue(props.Mass());
        return Primitive::execute();
...
App::DocumentObjectExecReturn* Ellipse::execute()
{
    ...
    BRepBuilderAPI_MakeEdge clMakeEdge(ellipse,
...
void Ellipse::handleChangedPropertyName(Base::XMLReader& reader,
                                        const char* TypeName,
                                        const char* PropName)
{
