            ...
            # check if object was already processed, to workaround an ifcopenshell bug
                ...
                if objparentid:
                    ...
                    for p in objparentid:
                        ifcParents[objid].append([p, objtype not in subtractiveTypes])
            ...
            for c in comps:
                ...
                if (id <= 0) or (parent_id <= 0):
                    ...
                    if not IFCOPENSHELL5:
                        ...
                        if parent and (parentid not in ifcObjects):
...
def getShape(obj, objid):
    ...
    if not sh.Solids:
        ...
        if sh.Faces:
            ...
            if DEBUG:
                print("    object ", objid, " doesn't contain any geometry")
    if not IFCOPENSHELL5:
        m = obj.matrix
        mat = FreeCAD.Matrix(
            m[0], m[3], m[6], m[9], m[1], m[4], m[7], m[10], m[2], m[5], m[8], m[11], 0, 0, 0, 1
    ...
    for obj in objectslist:
        ...
        if obj.isDerivedFrom("App::DocumentObjectGroup"):
            ...
            if otype == "Wall":
                ...
                extra = ["ELEMENT"]
            if ifctype not in supportedIfcTypes:
                if DEBUG:
                    print(
                        "   Type ",
                        ifctype,
