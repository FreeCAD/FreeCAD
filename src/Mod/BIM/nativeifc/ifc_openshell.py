...
class IFC_UpdateIOS:
    ...
    def show_dialog(self, mode, version=None):
        ...
        note = translate(
            "BIM",
            "The update is installed in your FreeCAD's user directory and won't affect the rest of your system.",
        )
        if mode == "update":
    ...
    def run_pip(self, args):
        ...
        try:
            ...
            text = translate(
                "BIM", "Unable to run pip. Please ensure pip is installed on your system."
            )
