...
class _Stairs(ArchComponent.Component):
    ...
    def setProperties(self, obj):
        ...
        if "Winders" not in pl:
            obj.addProperty(
                "App::PropertyEnumeration",
                "Winders",
                "Structure",
                QT_TRANSLATE_NOOP("App::Property", "The type of winders in these stairs"),
                locked=True,
            )
            obj.Winders = ["None", "All", "Corners strict", "Corners relaxed"]
        if "Structure" not in pl:
            obj.addProperty(
                "App::PropertyEnumeration",
                "Structure",
                "Structure",
        ...
        if "StructureThickness" not in pl:
            obj.addProperty(
                "App::PropertyLength",
                "StructureThickness",
                "Structure",
        ...
        if "DownSlabThickness" not in pl:
            obj.addProperty(
                "App::PropertyLength",
                "DownSlabThickness",
                "Structure",
        ...
        if "ConnectionDownStartStairs" not in pl:
            obj.addProperty(
                "App::PropertyEnumeration",
        ...
        if "ConnectionEndStairsUp" not in pl:
            obj.addProperty(
                "App::PropertyEnumeration",
