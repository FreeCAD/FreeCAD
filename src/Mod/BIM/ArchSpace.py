...
class _Space(ArchComponent.Component):
    ...
    def setProperties(self, obj):
        ...
        if "Internal" not in pl:
            ...
            obj.Internal = True
        if "AreaCalculationType" not in pl:
            obj.addProperty(
                "App::PropertyEnumeration",
                "AreaCalculationType",
                "Space",
