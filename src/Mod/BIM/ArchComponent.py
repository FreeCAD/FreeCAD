...
class SelectionTaskPanel:
    ...
    def __init__(self):
        ...
        self.baseform.setText(
            QtGui.QApplication.translate("Arch", "Please select a base object", None)
        )
...
class ComponentTaskPanel:
    ...
    def __init__(self):
        ...
        try:
            ...
            if "BIM_Classification" not in FreeCADGui.listCommands():
                FreeCADGui.activateWorkbench("BIMWorkbench")
