...
class BuildingPart(ArchIFC.IfcProduct):
    ...
    def getShapes(self, obj):
        ...
        for child in Draft.get_group_contents(obj, walls=True):
            if Draft.get_type(child) not in ["Space"]:
...
class ViewProviderBuildingPart:
    ...
    def setProperties(self, vobj):
        ...
        if "DoubleClickActivates" not in pl:
            vobj.addProperty(
                "App::PropertyBool",
        ...
        if "ChildrenLineWidth" not in pl:
            vobj.addProperty(
                "App::PropertyFloat",
                "ChildrenLineWidth",
                "Children",
        ...
        if "ChildrenLineColor" not in pl:
            vobj.addProperty(
                "App::PropertyColor",
                "ChildrenLineColor",
                "Children",
        ...
        if "ChildrenShapeColor" not in pl:
            vobj.addProperty(
        ...
        if "ChildrenTransparency" not in pl:
            vobj.addProperty(
                "App::PropertyPercent",
        ...
        if "AutogroupAutosize" not in pl:
            vobj.addProperty(
                "App::PropertyBool",
                "AutogroupAutosize",
                "AutoGroup",
    ...
    def setupContextMenu(self, vobj, menu):
        ...
        actionCreateGroup = QtGui.QAction(translate("Arch", "Create group..."), menu)
        ...
        if hasattr(self, "Object"):
            if not self.Object.Height.Value:
                FreeCAD.Console.PrintError(
                    "This level has no height value. Please define a height before using this function.\n"
                )
                return
