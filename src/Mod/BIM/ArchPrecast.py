...
class _PrecastSlab(_Precast):
    ...
    def execute(self, obj):
        ...
        if (
            ...
            or (
                holenumber > 0
                and (holespacing == 0 or holemajor == 0 or holeminor == 0)
            )
...
class _PrecastTaskPanel:
    ...
    def __init__(self):
        ...
        self.restoreValue(
            self.valueDentLength, params.get_param_arch("PrecastDentLength")
        )
        self.restoreValue(
            self.valueDentWidth, params.get_param_arch("PrecastDentWidth")
        )
        self.restoreValue(
            self.valueDentHeight, params.get_param_arch("PrecastDentHeight")
        )
        self.restoreValue(self.valueBase, params.get_param_arch("PrecastBase"))
        self.restoreValue(
            self.valueHoleMajor, params.get_param_arch("PrecastHoleMajor")
        )
        self.restoreValue(
            self.valueHoleMinor, params.get_param_arch("PrecastHoleMinor")
        )
        self.restoreValue(
            self.valueHoleSpacing, params.get_param_arch("PrecastHoleSpacing")
        )
        self.restoreValue(
            self.valueGrooveDepth, params.get_param_arch("PrecastGrooveDepth")
        )
        self.restoreValue(
            self.valueGrooveHeight, params.get_param_arch("PrecastGrooveHeight")
        )
        self.restoreValue(
            self.valueGrooveSpacing, params.get_param_arch("PrecastGrooveSpacing")
        )
        self.restoreValue(
            self.valueDownLength, params.get_param_arch("PrecastDownLength")
        )
...
class _DentsTaskPanel:
    ...
    def getValues(self):
        ...
        for i in range(self.listDents.count()):
            sv = self.listDents.item(i).text()
            lv.append(sv.split(":")[1])
        return lv
