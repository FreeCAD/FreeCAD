...
class _ArchSchedule:
    ...
    def update_properties_0v21(self, obj):
        ...
        _wrn(
            ...
            + obj.Label
            + ", "
            + translate("Arch", "removed property 'Result', and added property 'AutoUpdate'")
        )
        if sp is not None:
    ...
    def update_properties_1v1(self, obj):
        ...
        if obj.getTypeIdOfProperty("Description") == "App::PropertyStringList":
            ...
            _wrn(
                ...
                + obj.Label
                + ", "
                + translate("Arch", "renamed property 'Description' to 'Operation'")
            )
        for prop in (
            "Operation",
            "Value",
    ...
    def setProperties(self, obj):
        ...
        if "Value" not in obj.PropertiesList:
            obj.addProperty(
                "App::PropertyStringList",
                "Value",
                "Schedule",
        ...
        if "Unit" not in obj.PropertiesList:
            obj.addProperty(
                "App::PropertyStringList",
                "Unit",
                "Schedule",
        ...
        if "Filter" not in obj.PropertiesList:
            obj.addProperty(
                "App::PropertyStringList",
                "Filter",
                "Schedule",
        ...
        if "CreateSpreadsheet" not in obj.PropertiesList:
            obj.addProperty(
                "App::PropertyBool",
                "CreateSpreadsheet",
                "Schedule",
        ...
        if "DetailedResults" not in obj.PropertiesList:
            obj.addProperty(
                "App::PropertyBool",
                "DetailedResults",
                "Schedule",
            ...
            for f in filters.split(";"):
                ...
                if inv:
                    ...
                    if prop not in props:
                        ...
                        csprop = o.PropertiesList[props.index(prop)]
                        if fval not in getattr(o, csprop).upper():
                            ok = False
            if ok:
                nobjs.append(o)
        return nobjs
                    ...
                    if hasattr(elval, "is_a") and elval.is_a("IfcRelationship"):
                        for att in dir(elval):
                            if att.startswith("Relating"):
                                ...
                                if elval not in getattr(elval, att):
...
class ArchScheduleTaskPanel:
    ...
    def export(self):
        ...
        # tests
        if "Up-to-date" not in self.obj.State:
