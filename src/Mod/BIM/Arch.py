...
def makeRebar(
    ...
    >>> rebar_sketch.addGeometry(
    ...     Part.LineSegment(FreeCAD.Vector(25, 25, 0), FreeCAD.Vector(1975, 25, 0)), False
    ... )
    ...
    >>> rebar_obj = Arch.makeRebar(
    ...     baseobj=beam, sketch=rebar_sketch, diameter=12, amount=4, offset=25
    ... )
