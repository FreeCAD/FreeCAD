    ...
    def execute(self, obj):
        ...
        for row in rowsizes:
            ...
            for column in columnsizes:
                ...
                if facenumber not in obj.HiddenFaces:
                    spanning = False
