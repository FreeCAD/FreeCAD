...
class _Window(ArchComponent.Component):
    ...
    def setProperties(self, obj, mode=None):
        ...
        if "AutoNormalReversed" not in lp:
            obj.addProperty(
                "App::PropertyBool",
                "AutoNormalReversed",
                "Window",
    ...
    def onChanged(self, obj, prop):
        ...
        if prop == "Sill":
            ...
            if (
                getattr(self, "baseSill", None) is None
                and getattr(self, "basePos", None) is None
                and getattr(self, "atthOff", None) is None
