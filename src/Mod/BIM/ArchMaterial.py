...
class _ArchMaterial:
    ...
    def setProperties(self, obj):
        ...
        if "StandardCode" not in obj.PropertiesList:
            obj.addProperty(
                "App::PropertyString",
                "StandardCode",
                "Material",
        ...
        if "ProductURL" not in obj.PropertiesList:
            obj.addProperty(
                "App::PropertyString",
                "ProductURL",
                "Material",
        ...
        if "Transparency" not in obj.PropertiesList:
            obj.addProperty(
                "App::PropertyPercent",
                "Transparency",
                "Material",
        ...
        if "SectionColor" not in obj.PropertiesList:
            obj.addProperty(
                "App::PropertyColor",
                "SectionColor",
                "Material",
