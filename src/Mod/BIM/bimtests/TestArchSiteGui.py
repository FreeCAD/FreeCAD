...
class TestArchSiteGui(TestArchBaseGui.TestArchBaseGui):
    ...
    def test_new_site_creation(self):
        ...
        self.printTestMessage('Checking new Site creation...')
        site = Arch.makeSite()
    ...
    def test_new_site_save_and_reopen(self):
        """Test: save document and reopen; view properties must be present after reopen."""
        ...
        try:
            ...
            try:
                ...
                # Ensure the view properties exist on the reopened object's ViewObject
                vobj = found.ViewObject
                props = vobj.PropertiesList
                for p in ['ShowSunPosition', 'SunDateMonth', 'SunDateDay', 'SunTimeHour', 'SolarDiagramScale']:
                    self.assertIn(p, props, f"Property '{p}' missing after reopen")
            finally:
