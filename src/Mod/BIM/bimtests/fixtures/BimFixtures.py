...
def create_test_model(document, **overrides):
    ...
    exterior_wall = Arch.makeWall(exterior_wire, name=LABELS['exterior_wall'], height=ground_floor_height)
    ...
    interior_wall = Arch.makeWall(interior_wire, name=LABELS['interior_wall'], height=interior_wall_height)
