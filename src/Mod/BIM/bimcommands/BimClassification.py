...
class BIM_Classification:
    ...
    def updateByMaterial(self):
        ...
        groups["Undefined"] = [o for o in self.objectslist.keys() if o not in claimed]
        ...
        if not self.isEditing:
                    ...
                    if item.toolTip(0):
                        ...
                        if obj:
                            if hasattr(obj, "StandardCode"):
                                ...
                                if "Classification" not in obj.PropertiesList:
                                    obj.addProperty(
            ...
            if ("StandardCode" in pl) or ("IfcClass" in pl):
                ...
                if "StandardCode" in pl:
                    ...
                    if "Classification" not in self.isEditing.PropertiesList:
