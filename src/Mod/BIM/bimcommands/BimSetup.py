...
class BIM_Setup:
    ...
    def getIfcOpenShellStatus(self, refresh=False):
        ...
        return {
            "Single-process import": ifc_backend.get_status(capability=ifc_backend.IMPORT),
            "Multicore import": ifc_backend.get_status(capability=ifc_backend.MULTICORE_IMPORT),
            "NativeIFC export": ifc_backend.get_status(capability=ifc_backend.EXPORT),
        }
