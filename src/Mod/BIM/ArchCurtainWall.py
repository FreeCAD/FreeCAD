...
class CurtainWall(ArchComponent.Component):
    ...
    def setProperties(self, obj):
        ...
        if "VerticalMullionNumber" not in pl:
            obj.addProperty(
                "App::PropertyInteger",
        ...
        if "VerticalMullionAlignment" not in pl:
            obj.addProperty(
                "App::PropertyBool",
        ...
        if "VerticalMullionHeight" not in pl:
            obj.addProperty(
                "App::PropertyLength",
        ...
        if "VerticalMullionWidth" not in pl:
            obj.addProperty(
                "App::PropertyLength",
        ...
        if "VerticalMullionProfile" not in pl:
            obj.addProperty(
                "App::PropertyLink",
        ...
        if "HorizontalMullionNumber" not in pl:
            obj.addProperty(
                "App::PropertyInteger",
        ...
        if "HorizontalMullionAlignment" not in pl:
            obj.addProperty(
                "App::PropertyBool",
        ...
        if "HorizontalSections" not in pl:
            obj.addProperty(
                "App::PropertyInteger",
                "HorizontalSections",
                "CurtainWall",
        ...
        if "HorizontalMullionHeight" not in pl:
            obj.addProperty(
                "App::PropertyLength",
        ...
        if "HorizontalMullionWidth" not in pl:
            obj.addProperty(
                "App::PropertyLength",
        ...
        if "HorizontalMullionProfile" not in pl:
            obj.addProperty(
                "App::PropertyLink",
        ...
        if "DiagonalMullionNumber" not in pl:
            obj.addProperty(
                "App::PropertyInteger",
        ...
        if "DiagonalMullionSize" not in pl:
            obj.addProperty(
                "App::PropertyLength",
                "DiagonalMullionSize",
                "CurtainWall",
        ...
        if "DiagonalMullionProfile" not in pl:
            obj.addProperty(
                "App::PropertyLink",
        ...
        if "SwapHorizontalVertical" not in pl:
            obj.addProperty(
                "App::PropertyBool",
        ...
        if "VerticalDirection" not in pl:
            obj.addProperty(
                "App::PropertyVector",
                "VerticalDirection",
                "CurtainWall",
        ...
        if "OverrideEdges" not in pl:  # PropertyStringList
            obj.addProperty(
