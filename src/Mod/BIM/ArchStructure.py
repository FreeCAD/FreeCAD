...
class _Structure(ArchComponent.Component):
    ...
    def onDocumentRestored(self, obj):
        ...
        if (
            ...
            and obj.Length == 0  # We should be dealing with columns, their obj.Length is normally 0.
            ...
            _log("v26.3, " + obj.Name + ", updated 'Normal' property based on 'Nodes' to prevent flipping")
