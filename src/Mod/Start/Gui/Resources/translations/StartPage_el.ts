...
Χρησιμοποιώντας ";;" για να διαχωρίσετε διαδρομές, μπορείτε να προσθέσετε αρκετούς φακέλους εδώ</translation>
    ...
    <message>
      ...
      <translation>Χρήση διαβάθμισης για νέο εικονίδιο αρχείου</translation>
    </message>
    <message>
      ...
      <translation>Αν επιλεχθεί, το εικονίδιο 'Νέο Αρχείο' εμφανίζει ένα εικονίδιο διαβάθμισης αντί για το κανονικό εικονίδιο</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Επιλέξτε τον πάγκο εργασίας στον οποίο θα μεταβείτε μετά την έναρξη του προγράμματος</translation>
    </message>
    <message>
