    ...
    QList<TourStop> buildStops() const
    {
        ...
        QList<TourStop> candidates {
            ...
            {findDock(
             ...
             tr("Tree"),
             tr("Read the tree"),
             tr("The tree shows what is currently open in a project: documents, bodies, and the "
            ...
            {findDock(
             ...
             tr("Double-clicking a feature partway down the tree -- instead of the last one -- "
                "edits "
            ...
            {workbenchSelector(),
             ...
             tr("Sketcher Workbench"),
             tr("<img src=\":/icons/SketcherWorkbench.svg\" width=\"16\" height=\"16\"> Sketcher "
            ...
            {nullptr,
             ...
             tr("Read the colors"),
             tr("Sketch geometry changes color to tell you its status. White (or black, depending "
                "on "
            ...
            {nullptr,
             ...
             tr("Select a Plane"),
             tr("Pick a plane"),
             tr("A sketch needs a flat plane to sit on. The tour attaches this one to the "
            ...
            {nullptr,
             ...
             tr("External geometry copies the outline of selected edges into the active sketch as "
                "a "
            ...
            {workbenchSelector(),
             ...
             tr("Part Design Workbench"),
             tr("<img src=\":/icons/PartDesign_Body.svg\" width=\"16\" height=\"16\"> Part "
            ...
            {partDesignToolBar(),
             ...
             tr("Additive and subtractive features belong to the Part Design workbench -- "
                "highlighted "
            ...
            {workbenchSelector(),
             ...
             tr("Part Workbench"),
             tr("Part Workbench"),
             tr("<img src=\":/icons/Part_3D_object.svg\" width=\"16\" height=\"16\"> Part: works "
            ...
            {findDock(
             ...
             tr("Layout"),
             tr("Make it yours"),
             tr("Toolbars, dock panels, and tabs can all be rearranged. Drag a panel by its title "
                "bar "
            ...
            {firstToolBar(),
             ...
             tr("Recompute"),
             tr("Stay up to date"),
             tr("FreeCAD doesn't always update automatically. After certain edits, the document "
                "needs "
            ...
            {findDock({QStringLiteral("Report view"), QStringLiteral("Std_ReportView")}),
             ...
             tr("Warnings and errors often show up only in the Report view, a panel that's hidden "
                "by "
