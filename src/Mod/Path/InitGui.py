...
class PathWorkbench (Workbench):
    ...
    def Initialize(self):
        ...
        from PathScripts import PathDressupTrochoidal
        ...
        dressupcmdlist = ["Path_DressupAxisMap", "Path_DressupDogbone", "Path_DressupDragKnife", "Path_DressupLeadInOut", "Path_DressupRampEntry", "Path_DressupTag", "Path_DressupTrochoidal"]
        extracmdlist = []
        #modcmdmore = ["Path_Hop",]
