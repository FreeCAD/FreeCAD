...
Note that this option is disabled if a stock object from an existing solid is used in the job - they cannot be stored in a template.</source>
      <translation>Если включено, создание заготовки включено в шаблон. Если шаблон не включает определение заготовки, будет использоваться алгоритм создания заготовки по умолчанию (создание из ограничивающей рамки базового объекта).

Этот вариант наиболее полезен, если заготовка представляет собой коробку или цилиндр, или если станок имеет стандартное размещение для обработки.

Обратите внимание, что эта опция отключена, если в задании используется объект заготовки из существующего твердого тела — их нельзя сохранить в шаблоне.</translation>
    </message>
    <message>
...
For stock from the Base object's bounding box it means the extra material in all directions. A stock object created from such a template will get its basic size from the new job's Base object and apply the stored extra settings.</source>
      <translation>Если этот параметр включен, в шаблон включаются текущие настройки размера стандартного объекта.

Для коробчатых и цилиндрических заготовок это означает фактический размер создаваемой заготовки.

Для материала из ограничивающей рамки базового объекта это означает лишний материал во всех направлениях. Стандартный объект, созданный на основе такого шаблона, получит свой базовый размер из Базового объекта нового задания и применит сохраненные дополнительные настройки.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Название свойства. Может содержать только буквы, цифры и символы подчеркивания. Имена в смешанном регистре будут отображаться с пробелами «Смешанный регистр»</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Расширение MinX ограничительной рамки</translation>
    </message>
    <message>
      <location filename="../panels/DressupPathBoundary.ui" line="120"/>
      <source>Extension of bounding box's MaxX</source>
      <translation>Расширение MaxX ограничительной рамки</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Расширение MinY ограничительной рамки</translation>
    </message>
    <message>
      <location filename="../panels/DressupPathBoundary.ui" line="141"/>
      <source>Extension of bounding box's MaxY</source>
      <translation>Расширение MaxY ограничительной рамки</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Расширение MinZ ограничительной рамки</translation>
    </message>
    <message>
      <location filename="../panels/DressupPathBoundary.ui" line="162"/>
      <source>Extension of bounding box's MaxZ</source>
      <translation>Расширение ограничивающих рамок MaxX</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Если флажок установлен, путь ограничивается телом. В противном случае объем твердого тела описывает «запретную» зону</translation>
    </message>
    <message>
      <location filename="../panels/DressupPathBoundary.ui" line="55"/>
      <source>Extend Model's Bounding Box</source>
      <translation>Расширить ограничивающую рамку (габариты) модели</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Выберите один или несколько объектов в 3D-виде и нажмите «Добавить», чтобы добавить их в качестве базовых элементов для этой операции. Выбранные функции могут быть удалены полностью.</translation>
    </message>
    <message>
...
Последний можно использовать для облицовки всей площади заготовки, чтобы обеспечить одинаковую высоту для следующих операций</translation>
    ...
    <message>
      ...
      <translation>Избегайте обрезки последних N граней в списке выбранных граней базовой геометрии.</translation>
    </message>
    <message>
...
См. политику сохранения файлов ниже, чтобы узнать, как справляться с конфликтами имен.</translation>
    ...
    <message>
      ...
      <translation>Мод/Путь</translation>
    </message>
    <message>
...
Если несколько инструментов или форм инструментов с одинаковыми именами существуют в разных каталогах, может потребоваться использование абсолютных путей. </translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Выберите стиль размещения костей:&lt;/p&gt;&lt;p&gt;&lt;span style=" font-weight:600; font-style:italic;"&gt;Dogbone&lt;/span&gt; ... пройдите кратчайший путь к углам,&lt;/p&gt;&lt;p&gt;&lt;span style=" font-weight:600; font-style:italic;"&gt;Т-кость&lt;/span&gt; . . продлите определенное направление, пока уголок не покрыт&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Определяет длину разреза кости, которая будет вставлена в профиль.&lt;/p&gt;&lt;p&gt;&lt;span style=" font-weight:600; font-style:italic ;"&gt;adaptive&lt;/span&gt; ... длина адаптирована для покрытия угла в зависимости от угла его краев, принимая во внимание текущий радиус инструмента (по умолчанию)&lt;/p&gt;&lt;p&gt;&lt;span style=" font -weight:600; font-style:italic;"&gt;fixed&lt;/span&gt; ... то же самое, что и адаптивный для прямых углов. Для Т-образных костей это радиус инструмента (R), а для собачьих костей это R * (2/√2 - 1).&lt;/p&gt;&lt;p&gt;&lt;span style=" font-weight:600; font-style: italic;"&gt;custom&lt;/span&gt; ... позволяет указать пользовательскую (фиксированную) длину ниже&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Введите длину каждой кости, если для параметра &lt;span style=" font-weight:600;"&gt;Разрез&lt;/span&gt; задано значение &lt;span style=" font-weight:600;"&gt;настраиваемый&lt;/span&gt;, в противном случае игнорируется.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
      ...
      <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Список мест расположения костей (со всеми костями в этом месте), которые являются частью этого наряда. Список определяется углами в профиле и выбранной &lt;span style=" font-weight:600;"&gt;Side&lt;/span&gt; для костей. &lt;/p&gt;&lt;p&gt;Вы можете &lt;span style=" font-weight:600;"&gt;снять флажки&lt;/span&gt; с костей, которые не хотите украшать.&lt;/p&gt;&lt;p&gt;Если кость &lt;span style=" font-weight:600;"&gt;выделена серым цветом&lt;/span&gt;, это означает, что она уже украшена предыдущим нарядом. Или, другими словами, если вы снова наденете этот наряд из собачьей кости, вы сможете выбрать только те кости, которые здесь не отмечены.&lt;/p&gt;&lt;p&gt;Если этот список пуст, это, вероятно, означает, что вы пытаетесь создать кости на изнаночной стороне профиля.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Высота держателя тега. Обратите внимание, что результирующий тег может быть меньше, если ширина и угол тега имеют треугольную форму.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Список текущих тегов. Отредактируйте координаты двойным щелчком или кнопкой Edit. Метки автоматически отключаются, если они перекрываются с предыдущей меткой или не лежат на проводе основания.</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создать Camotics-файл</translation>
    </message>
  </context>
  <context>
...
Ordering by operation will do each operation in all coordinate systems before moving to the next operation. This is especially useful in conjunction with the 'split output' even with only a single work coordinate system since it will put each operation into a separate file.</source>
      <translation>Упорядочивание по Fixture приведет к тому, что все операции будут выполняться в первой системе координат перед переключением на вторую. Тогда все операции будут выполняться там в том же порядке.

Это полезно, если оператор может безопасно загрузить работу в одну систему координат, в то время как машина выполняет работу в другой.

Заказ по инструменту сведет к минимуму количество смен инструмента. Будет произведена смена инструмента, затем все операции во всех системах координат перед сменой инструмента.

Упорядочивание по операции будет выполнять каждую операцию во всех системах координат перед переходом к следующей операции. Это особенно полезно в сочетании с «раздельным выводом» даже с одной рабочей системой координат, поскольку каждая операция будет помещена в отдельный файл.</translation>
    </message>
    <message>
...
For example:
    ...
    'Imperial Decimal'</source>
      <translation>Текущая выбранная схема объекта:
      '{}'
  Не использует «минуты» для значений скорости.
 
Для станков с ЧПУ скорость подачи должна быть выражена в
единица/минута. Чтобы обеспечить правильный G-код:
Выберите поминутную схему в настройках.
Например:
     «Метрика, мелкие детали и ЧПУ»
     «Обычай США»
     «Имперская десятичная дробь»</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Проект "Камотика" (*.camotics)</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Длина перемычки, если для разреза установлено значение «Пользовательский»</translation>
    </message>
    <message>
      ...
      <translation>Углы, которые не дополнены \подрезкой\</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Рассчитать переход к пути</translation>
    </message>
    <message>
      <location filename="../../../Path/Dressup/Gui/LeadInOut.py" line="73"/>
      <source>Calculate roll-off from path</source>
      <translation>Рассчитать откат от пути</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Стиль движения по Пути обработки</translation>
    </message>
    <message>
      <location filename="../../../Path/Dressup/Gui/LeadInOut.py" line="104"/>
      <source>The Style of motion out of the Path</source>
      <translation>Стиль движения вне Пути обработки</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Области, очищенные в результате этой операции, по одной области на высоту, сохраняются как составная деталь. Используется внутри для остаточной обработки.</translation>
    </message>
    <message>
      ...
      <translation>Флаг, указывающий, что остальные области обработки никогда не вычислялись и должны быть пересчитаны перед использованием.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Максимальное расстояние до усечения соединения под углом</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>Positive extends the beginning of the path, negative shortens.</source>
      <translation>Положительные расширяют начало траектории, отрицательные сокращают.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Для дуг/круговых ребер сместите радиус пути обработки.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Установите TPI резьбы (оборот на дюйм) - используется для дюймовой резьбы</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Пути обработки в массив</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Траектория обработки для копирования</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создает перемычки границы пути обработки из выбранного пути</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создать технологическую перемычку на выбранном пути</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Изменяет путь для добавления угловых действий dragknife</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создать перемычку из выбранного пути обработки</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создает путь обработки к заданию</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Имитация с помощью Camotic</translation>
    </message>
  </context>
  <context>
 ...
 Значения будут преобразованы в нужные единицы во время постобработки.</translation>
    ...
    <message>
      ...
      <translation>Инспектировать команды пути</translation>
    </message>
    <message>
      <location filename="../../../Path/Main/Gui/Inspect.py" line="272"/>
      <source>Inspects the contents of a Path object</source>
      <translation>Проверяет содержимое объекта Пути</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Экспортирует рабочие траектории в качестве шаблона, который будет использоваться для других заданий</translation>
    </message>
  </context>
  <context>
    <name>Path_Job:</name>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Проверьте задание пути на распространенные ошибки</translation>
    </message>
    <message>
      <location filename="../../../Path/Main/Gui/Sanity.py" line="215"/>
      <source>Setup Report for FreeCAD Job</source>
      <translation>Отчет о настройке для задания FreeCAD</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Последовательность заданий обработки</translation>
    </message>
    <message>
      <location filename="../../../Path/Main/Gui/Sanity.py" line="227"/>
      <source>Job Description</source>
      <translation>Описание задания обработки</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Дата последнего сохранения</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Минимальная высота Z</translation>
    </message>
    <message>
      <location filename="../../../Path/Main/Gui/Sanity.py" line="240"/>
      <source>Maximum Z Height</source>
      <translation>Максимум Z высота</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>ВСЕГО ЗАДАНИЙ ОБРАБОТКИ</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Контроллер инструментов «{}» не используется</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Предыдущая операция %s необходима для остаточной обработки, но у нее нет сохраненных метаданных остаточной обработки. Повторные вычисления для создания этих метаданных...</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создает путь Спираль из особенностей базового объекта</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Пользовательские точки идентичны.</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создает операцию фрезерования резьбы траектории из элементов базового объекта</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>Создает траекторию гравировки средней линии</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Края не поддерживаются</translation>
    </message>
    <message>
...
Прерываем команду</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Массивы путей с разными контроллерами инструментов обрабатываются в соответствии с контроллером инструмента первого пути.</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>Создать массив из выбранных путей</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Gui/Array.py" line="476"/>
      <source>Arrays can be created only from Path operations.</source>
      <translation>Массивы могут быть созданы только из операций Пути.</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создает связанную копию другой траектории</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создает траекторию удаления заусенцев вдоль краев или плоскости, ребра</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>Создать гравирующий путь вокруг чертежа формы</translation>
    </message>
  </context>
  <context>
    <name>Path_Hop</name>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создает 3D-карман пути из грани или граней</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создает непараметрическую копию другой траектории</translation>
    </message>
    <message>
