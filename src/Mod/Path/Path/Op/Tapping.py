...
class ObjectTapping(PathCircularHoleBase.ObjectOp):
    ...
    def propertyEnumerations(self, dataType="data"):
        ...
        enums = {
            "ReturnLevel": [
                (translate("Path_Tapping", "G98"), "G98"),
                (translate("Path_Tapping", "G99"), "G99"),
            ],  # How high to retract after a tapping move
            "ExtraOffset": [
                (translate("Path_Tapping", "None"), "None"),
                (translate("Path_Tapping", "Drill Tip"), "Drill Tip"),
                (translate("Path_Tapping", "2x Drill Tip"), "2x Drill Tip"),
