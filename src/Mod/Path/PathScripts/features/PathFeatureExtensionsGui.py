...
class TaskPanelExtensionPage(PathOpGui.TaskPanelPage):
    ...
    def getFields(self, obj):
        ...
        self.blockUpdateData = False # pylint: disable=attribute-defined-outside-init
        if hasattr(obj, 'AllAccessExtension'):
            obj.AllAccessExtension.Value = self.form.allAccessExtension.value()
    ...
    def setFields(self, obj):
        ...
        if hasattr(obj, 'AllAccessExtension'):
            self.form.allAccessExtension.setValue(obj.AllAccessExtension.Value)
    ...
    def getSignalsForUpdate(self, obj):
        ...
        signals.append(self.form.allAccessExtension.valueChanged)
        return signals
