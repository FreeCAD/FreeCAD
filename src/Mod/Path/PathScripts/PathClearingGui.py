...
import PathScripts.PathClearing as PathClearing
...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def initPage(self, obj):
        ...
        self.cutPatternAngle = PathGui.QuantitySpinBox(self.form.cutPatternAngle, obj, 'CutPatternAngle')
        self.stepOverPercent = PathGui.QuantitySpinBox(self.form.stepOverPercent, obj, 'StepOver')
    ...
    def getFields(self, obj):
        ...
        if obj.HandleMultipleFeatures != str(self.form.handleMultipleFeatures.currentText()):
            obj.HandleMultipleFeatures = str(self.form.handleMultipleFeatures.currentText())
    ...
    def registerSignalHandlers(self, obj):
        ...
        self.form.visualizeButton.clicked.connect(self.previewTargetShape)
...
Command = PathOpGui.SetupOperation('Clearing',
        PathClearing.Create,
        TaskPanelOpPage,
        'Path_Face',
        QtCore.QT_TRANSLATE_NOOP("Path_Clearing", "Clearing"),
        QtCore.QT_TRANSLATE_NOOP("Path_Clearing", "Creates a Path Clearing operation from edges, wires, faces or solids."),
