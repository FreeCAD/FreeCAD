...
class ObjectProfile(PathAreaOp.ObjectOp):
    ...
    def areaOpProperties(self):
        ...
        return [
            ...
            ("App::PropertyInteger", "ProfileCount", "Profile",
                QtCore.QT_TRANSLATE_NOOP("App::Property", "Number of passes")),
            ("App::PropertyDistance", "MultipleOffsetExtra", "Profile",
                QtCore.QT_TRANSLATE_NOOP("App::Property", "Offset for multiple passes")),
