...
"""
    ...
    def test100(self):
        ...
        """
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A40 B50 C60",
            "G0 X10.000 Y20.000 Z30.000 A40.000 B50.000 C60.000 ",
            "--no-header --no-show-editor"
        )
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A40 B50 C60",
            "G0 X0.3937 Y0.7874 Z1.1811 A40.0000 B50.0000 C60.0000 ",
    ...
    def test110(self):
        ...
        """
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A89 B89 C89",
            "G0 X10.000 Y20.000 Z30.000 A89.000 B89.000 C89.000 ",
            "--no-header --no-show-editor"
        )
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A89 B89 C89",
            "G0 X0.3937 Y0.7874 Z1.1811 A89.0000 B89.0000 C89.0000 ",
            "--no-header --inches --no-show-editor"
        )
    ...
    def test120(self):
        ...
        """
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A90 B90 C90",
            "G0 X10.000 Y20.000 Z30.000 A90.000 B90.000 C90.000 ",
            "--no-header --no-show-editor"
        )
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A90 B90 C90",
            "G0 X0.3937 Y0.7874 Z1.1811 A90.0000 B90.0000 C90.0000 ",
            "--no-header --inches --no-show-editor"
        )
    ...
    def test130(self):
        ...
        """
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A91 B91 C91",
            "G0 X10.000 Y20.000 Z30.000 A91.000 B91.000 C91.000 ",
            "--no-header --no-show-editor"
        )
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A91 B91 C91",
            "G0 X0.3937 Y0.7874 Z1.1811 A91.0000 B91.0000 C91.0000 ",
            "--no-header --inches --no-show-editor"
        )
    ...
    def test140(self):
        ...
        """
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A100 B110 C120",
            "G0 X10.000 Y20.000 Z30.000 A100.000 B110.000 C120.000 ",
            "--no-header --no-show-editor"
        )
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A100 B110 C120",
            "G0 X0.3937 Y0.7874 Z1.1811 A100.0000 B110.0000 C120.0000 ",
            "--no-header --inches --no-show-editor"
        )
    ...
    def test150(self):
        ...
        """
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A240 B250 C260",
            "G0 X10.000 Y20.000 Z30.000 A240.000 B250.000 C260.000 ",
            "--no-header --no-show-editor"
        )
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A240 B250 C260",
            "G0 X0.3937 Y0.7874 Z1.1811 A240.0000 B250.0000 C260.0000 ",
            "--no-header --inches --no-show-editor"
        )
    ...
    def test160(self):
        ...
        """
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A440 B450 C460",
            "G0 X10.000 Y20.000 Z30.000 A440.000 B450.000 C460.000 ",
            "--no-header --no-show-editor"
        )
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A440 B450 C460",
            "G0 X0.3937 Y0.7874 Z1.1811 A440.0000 B450.0000 C460.0000 ",
            "--no-header --inches --no-show-editor"
        )
    ...
    def test170(self):
        ...
        """
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A-40 B-50 C-60",
            "G0 X10.000 Y20.000 Z30.000 A-40.000 B-50.000 C-60.000 ",
            "--no-header --no-show-editor"
        )
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A-40 B-50 C-60",
            "G0 X0.3937 Y0.7874 Z1.1811 A-40.0000 B-50.0000 C-60.0000 ",
            "--no-header --inches --no-show-editor"
        )
    ...
    def test180(self):
        ...
        """
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A-100 B-110 C-120",
            "G0 X10.000 Y20.000 Z30.000 A-100.000 B-110.000 C-120.000 ",
            "--no-header --no-show-editor"
        )
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A-100 B-110 C-120",
            "G0 X0.3937 Y0.7874 Z1.1811 A-100.0000 B-110.0000 C-120.0000 ",
            "--no-header --inches --no-show-editor"
        )
    ...
    def test190(self):
        ...
        """
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A-240 B-250 C-260",
            "G0 X10.000 Y20.000 Z30.000 A-240.000 B-250.000 C-260.000 ",
            "--no-header --no-show-editor"
        )
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A-240 B-250 C-260",
            "G0 X0.3937 Y0.7874 Z1.1811 A-240.0000 B-250.0000 C-260.0000 ",
            "--no-header --inches --no-show-editor"
        )
    ...
    def test200(self):
        ...
        """
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A-440 B-450 C-460",
            "G0 X10.000 Y20.000 Z30.000 A-440.000 B-450.000 C-460.000 ",
            "--no-header --no-show-editor"
        )
        self.compare_sixth_line(
            "G0 X10 Y20 Z30 A-440 B-450 C-460",
            "G0 X0.3937 Y0.7874 Z1.1811 A-440.0000 B-450.0000 C-460.0000 ",
            "--no-header --inches --no-show-editor"
        )
