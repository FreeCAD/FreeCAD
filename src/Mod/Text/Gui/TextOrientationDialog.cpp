...
#include "ui_TextOrientationDialog.h"


using namespace TextGui;

TextOrientationDialog::TextOrientationDialog()
    : QDialog(Gui::getMainWindow())
    , ui(new Ui_TextOrientationDialog)
{
    DirType = 0;
    ui->setupUi(this);
    onPreview();

    connect(ui->Reverse_checkBox, &QCheckBox::clicked, this, &TextOrientationDialog::onPreview);
    connect(ui->XY_radioButton, &QRadioButton::clicked, this, &TextOrientationDialog::onPreview);
    connect(ui->XZ_radioButton, &QRadioButton::clicked, this, &TextOrientationDialog::onPreview);
    connect(ui->YZ_radioButton, &QRadioButton::clicked, this, &TextOrientationDialog::onPreview);
}

TextOrientationDialog::~TextOrientationDialog()
{}

void TextOrientationDialog::accept()
{
...
void TextOrientationDialog::onPreview()
{
    std::string icon;
    bool reverse = ui->Reverse_checkBox->isChecked();
    if (ui->XY_radioButton->isChecked()) {
...
#include "moc_TextOrientationDialog.cpp"
