...
PyMOD_INIT_FUNC(CollaborationGui)
{
    PyObject* mod = CollaborationGui::initModule();
    Base::Console().log("Loading CollaborationGui module... done\n");

    CollaborationGui::ViewProviderTopic::init();
