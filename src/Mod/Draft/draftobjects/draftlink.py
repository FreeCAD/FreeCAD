...
# *                                                                         *
# ***************************************************************************
"""This module provides the object code for Draft DraftLink.
"""
## @package draftlink
# \ingroup DRAFT
# \brief This module provides the object code for Draft DraftLink.
...
class DraftLink(DraftObject):
    """
    This class seems to add the support for App::Link in Draft Arrays.
    It is in fact inherited by all Draft Arrays Objects.
