...
class Point(DraftObject):
    ...
    def __init__(self, obj, x=0, y=0, z=0):
        ...
        obj.addLockedProperty("App::PropertyDistance", "X", "Draft", _tip)

        _tip = QT_TRANSLATE_NOOP("App::Property", "Y Location")
        obj.addLockedProperty("App::PropertyDistance", "Y", "Draft", _tip)

        _tip = QT_TRANSLATE_NOOP("App::Property", "Z Location")
        obj.addLockedProperty("App::PropertyDistance", "Z", "Draft", _tip)
