...
class Draft_WorkingPlaneProxy:
    ...
    def GetResources(self):
        ...
        return {"Pixmap": "Draft_PlaneProxy",
                ...
                "ToolTip": QT_TRANSLATE_NOOP("Draft_WorkingPlaneProxy", "Creates a proxy object from the current working plane and allows to (re)store the camera position and visibility of objects")}
