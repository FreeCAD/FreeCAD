...
def rotate(objectslist, angle, center=App.Vector(0,0,0), 
    ...
    or an object). TODO: modify this description.
    ...
    axis : Base.Vector
        Rotation axis. If axis is omitted, the rotation will be around
        the vertical Z axis. 

    copy : bool (default = False)
        If copy is True, the given objects are not rotated, but copies
        are created instead.

    Returns
    -------
    list
        The modified objects (or their copies).
    """
    import Part
