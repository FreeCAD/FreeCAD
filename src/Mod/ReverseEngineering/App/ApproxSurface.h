...
public:
     ...
     * The arrays @a vKnots and @a vMults have to be the same
     ...
     *
     * @param iIndex  Index
     * @param iMaxDer max. discharge
     * @param fParam  Parameter value.
     * @return Derivative list of function values
     *
     * The list must be sufficient for iMaxDer+1 elements.
     */
...
public:
     ...
     * @param vMults Knot vector of shape (multiplicity)
     * @param iSize Length of the knot vector
     * The arrays @a vKnots and @a vMults have to be the same and the 
     ...
     * The integration area extends over the entire definition area.
...
protected:
    ...
    /**
     * Calculates the zeros of the Legendre-Polynomials and the corresponding weights
     */
    ...
    /**
     * Calculates the number of zeros/weights of the Legendre-Polynomials to be used as a function
     * of the degree
     */
...
protected:
     ...
     * For this purpose, the compensation plane for the point cloud is calculated.
     * The points are calculated with respect to the base consisting of the
     * eigenvectors of the covariance matrix and projected onto the compensation plane.
