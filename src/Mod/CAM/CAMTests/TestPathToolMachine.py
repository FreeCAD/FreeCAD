...
class TestMill(unittest.TestCase):
    ...
    def test_get_attribute_configs(self):
        ...
        self.assertEqual(attrs["max_feed"].label, "Maximum feed")
...
class TestLathe(unittest.TestCase):
    ...
    def test_get_attribute_configs(self):
        ...
        self.assertEqual(attrs["max_power"].label, "Maximum power")
        ...
        self.assertEqual(attrs["min_rpm"].label, "Minimum RPM")
        ...
        self.assertEqual(attrs["max_rpm"].label, "Maximum RPM")
        ...
        self.assertEqual(attrs["max_torque"].label, "Maximum torque")
