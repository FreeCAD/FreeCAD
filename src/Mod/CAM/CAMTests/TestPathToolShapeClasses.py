...
from Path.Tool.Shape import (
    ...
    ToolBitShapeTap, ToolBitShapeThreadMill, ToolBitShapeBullnose,
    ToolBitShapeVBit,
)
...
class TestPathToolShapeBase(PathTestUtils.PathTestBase):
    ...
    def test_base_get_set_parameter(self):
        ...
        with self.assertRaisesRegex(
            KeyError, "Shape 'dummy' has no parameter 'InvalidParam'"
        ):
    ...
    def test_base_validate_success(
        ...
        with patch('FreeCAD.openDocument') as mock_open_doc, \
             patch('FreeCAD.closeDocument') as mock_close_doc:
            ...
            mock_open_doc.assert_called_once_with(
    ...
    def test_base_validate_file_not_found(self, mock_exists):
        ...
        self.assertIn(
            "File not found", FreeCAD.Console.PrintError.call_args[0][0]
        )
    ...
    def test_base_validate_no_object(self, mock_find_obj, mock_exists):
        ...
        with patch('FreeCAD.openDocument') as mock_open_doc, \
            ...
            mock_close_doc.assert_called_once_with(
                mock_doc.Name
            )  # Closed in finally
    ...
    def test_base_validate_missing_params(
        ...
        with patch('FreeCAD.openDocument') as mock_open_doc, \
            ...
            self.assertIn(
                "MissingParam", FreeCAD.Console.PrintWarning.call_args[0][0]
            )
            mock_close_doc.assert_called_once_with(mock_doc.Name)
...
class TestPathToolShapeClasses(PathTestUtils.PathTestBase):
    ...
    def test_toolbitshapedovetail_defaults(self):
        ...
        self.assertEqual(unit(params["CuttingEdgeAngle"]), "°")
        self.assertEqual(
            shape.get_parameter_label("CuttingEdgeAngle"),
            "Cutting angle")
    ...
    def test_toolbitshapeprobe_defaults(self):
        ...
        self.assertEqual(
            ...
            "Ball diameter")
        self.assertEqual(
            shape.get_parameter_label("ShaftDiameter"),
            "Shaft diameter")
    ...
    def test_toolbitshapebullnose_defaults(self):
        ...
        self.assertEqual(
            shape.get_parameter_label("FlatRadius"),
            "Torus radius")
