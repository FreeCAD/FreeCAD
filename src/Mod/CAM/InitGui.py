...
class CAMWorkbench(Workbench):
    ...
    def ContextMenu(self, recipient):
        ...
        onlyJob = (
            len(selection) == 1
            and selection[0].Name.startswith("Job")
        ...
        startPoint = hasattr(selection[0], "StartPoint")
        ...
        if startPoint and len(selection) == 1:
        ...
        if any((onlyJob, onlyOps, onlyShapes, onlyTool, startPoint)):
