...
<TS version="2.1" language="ru" sourcelanguage="en">
  ...
  <context>
    ...
    <message>
      ...
      <translation>Единицы документа</translation>
    </message>
    <message>
      ...
      <translation>Для безопасных скоростей подачи G-кода требуется скорость в минуту (мм/мин, дюйм/мин). Схемы, отмеченные красным, выражают скорость в секунду и могут давать небезопасные результаты.</translation>
    </message>
    <message>
      ...
      <translation>Схема единиц для этого документа. Записи с зеленой заливкой выражают скорость в минуту (рекомендуется). Записи с красной заливкой выражают скорость в секунду и небезопасны для скоростей подачи G-кода.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Описание отображается во всплывающей подсказке при выборе шаблона во время создания задания</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Необязательно. Например, &quot;Метрические настройки по умолчанию для 3-осевого станка с рабочей зоной 600x900&quot;</translation>
    </message>
    <message>
...
Для заготовки из ограничивающей рамки базового объекта это означает дополнительный материал во всех направлениях. Заготовочный объект, созданный из такого шаблона, получит свой базовый размер из базового объекта нового задания и применит сохраненные дополнительные настройки.</translation>
    ...
    <message>
      ...
      <translation>знач1,знач2,знач3,…</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Таблица инструментов библиотеки</translation>
    </message>
    <message>
...
Reset deletes all current items from the list and fills the list with all circular holes eligible for the operation from the model. You can again refine the list afterwards by enabling/disabling, removing and adding features.</source>
      <translation>Таблица функций отверстий и определенный радиус соответствующего отверстия.

Добавьте функции для обработки, выбрав их и нажав &apos;Добавить&apos;. Если функция случайно добавлена в список, ее можно удалить через &apos;Удалить&apos;, и она больше не будет обрабатываться.

Сброс удаляет все текущие элементы из списка и заполняет список всеми круговыми отверстиями, подходящими для операции из модели. После этого вы можете снова уточнить список, включив/отключив, удалив и добавив функции.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>Blind</source>
      <translation>Глухое</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Удалить все элементы списка и автоматически заполнить список всеми подходящими функциями из базового объекта задания.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Начальная высота операции. Самая высокая точка по оси Z, которую необходимо обработать.</translation>
    </message>
    <message>
      ...
      <translation>Перенести значение Z выбранной функции как начальную высоту для операции</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Высота финального прохода операции. Может использоваться для получения более чистой поверхности.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Высота операции, соответствующая самому низкому значению по оси Z, которое необходимо обработать.</translation>
    </message>
    <message>
      ...
      <translation>Перенести значение Z выбранной функции как конечную высоту для операции</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Стратегия предотвращения столкновений</translation>
    </message>
    <message>
...
Tool Shape: safest - checks clearance using the cross section of the tool shape
      ...
      <translation>Как выполняется обнаружение столкновений при перемещении инструмента между функциями.

Высота подъема: Без обнаружения столкновений, использует высоту подъема для быстрых перемещений между областями
Высота зазора: Без обнаружения столкновений, использует высоту зазора для быстрых перемещений между областями
Прямая видимость: самый быстрый - проверяет центральную линию пути.
Диаметр инструмента: сбалансированный - проверяет зазор, используя диаметр инструмента.
Форма инструмента: самый безопасный - проверяет зазор, используя поперечное сечение формы инструмента</translation>
    </message>
    <message>
      <location filename="../panels/PageHeightsEdit.ui" line="314"/>
      <source>Collision Clearance</source>
      <translation>Зазор при столкновении</translation>
    </message>
    <message>
      ...
      <translation>Минимальное расстояние зазора между инструментом и любым твердым телом во время перемещений связывания. Применяется ко всем режимам связывания.</translation>
    </message>
    <message>
...
Большие значения (кроме справа) будут вычисляться быстрее; меньшие значения (далее слева) позволят получить более точные пути инструментов.</translation>
    ...
    <message>
      ...
      <translation>Поперечный шаг (процент)</translation>
    </message>
    <message>
      ...
      <translation>Расстояние бокового смещения режущего инструмента между последовательными проходами, в процентах от диаметра инструмента.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Поперечный шаг (расстояние)</translation>
    </message>
    <message>
      ...
      <translation>Расстояние бокового смещения режущего инструмента между последовательными проходами.</translation>
    </message>
    <message>
      ...
      <translation>Переключить коэффициент удержания инструмента внизу между 0 и диаметром инструмента</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>&lt;b&gt;Параметры спирали&lt;/b&gt;</translation>
    </message>
    <message>
      ...
      <translation>Макс. шаг</translation>
    </message>
    <message>
      ...
      <translation>Максимально допустимое снижение за один оборот спирали. Установите ноль, чтобы отключить ограничение по шагу.</translation>
    </message>
    <message>
      ...
      <translation>Макс. угол наклона</translation>
    </message>
    <message>
      ...
      <translation>Максимально допустимый угол входа по спирали. Установите ноль, чтобы отключить ограничение по углу наклона.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Максимальный (и номинальный) диаметр входа по спирали, в процентах от диаметра инструмента.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Минимально допустимый диаметр входа, в процентах от диаметра инструмента.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Стратегия создания отверстий: Сверление, Нарезание резьбы и т.д.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>⚠ УСТАРЕЛО: Операция нарезания резьбы устарела и будет удалена в будущем выпуске. Пожалуйста, используйте операцию Сверления со стратегией &apos;Нарезание резьбы&apos; вместо нее. Существующие операции нарезания резьбы продолжат работать, но вы не можете создавать новые.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Сторона профиля, на которой создавать путь</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Максимально допустимый угол входа по наклону. Установите ноль, чтобы отключить ограничение по углу наклона.</translation>
    </message>
    <message>
      ...
      <translation>Расстояние бокового смещения* режущего инструмента между последовательными проходами (*процент от диаметра инструмента).</translation>
    </message>
    <message>
      <location filename="../panels/PageOpHelixEdit.ui" line="164"/>
      <source>Radial stock to leave (outer)</source>
      <translation>Радиальный припуск (наружный)</translation>
    </message>
    <message>
      ...
      <translation>Сколько припуска оставить на внешней стенке для этой операции</translation>
    </message>
    <message>
...
Последний можно использовать для облицовки всей площади заготовки, чтобы обеспечить одинаковую высоту для следующих операций.</translation>
    ...
    <message>
      ...
      <translation>Режим охлаждения, используемый для этой операции</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Если выбрано, операция использует контур выбранной базовой геометрии и игнорирует все отверстия</translation>
    </message>
    <message>
      <location filename="../panels/PageOpPocketFullEdit.ui" line="234"/>
      <source>Ignore holes</source>
      <translation>Игнорировать отверстия</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Радиальный припуск</translation>
    </message>
    <message>
      ...
      <translation>Сколько припуска оставить на стенках для этой операции</translation>
    </message>
    <message>
      ...
      <translation>Порог подъема</translation>
    </message>
    <message>
      ...
      <translation>Расстояние, которое будет пытаться избегать ненужных подъемов</translation>
    </message>
    <message>
      ...
      <translation>Переключить порог подъема между 0 и диаметром инструмента</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Установить выбранную точку как начальную</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Установить схему резания для операции</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Двунаправленная</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Выберите алгоритм для использования: &apos;OCL Dropcutter*&apos;, &apos;OCL Adaptive*&apos; или &apos;Экспериментальный&apos; (не на основе OCL).</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Мин. интервал выборки</translation>
    </message>
    <message>
      ...
      <translation>Установите минимальное разрешение выборки. Меньшие значения быстро увеличивают время обработки.</translation>
    </message>
    <message>
...
!#101 = 2</translation>
    ...
    <message>
      ...
      <translation>Введите имя файла, содержащего G-код</translation>
    </message>
    <message>
      ...
      <translation>Попутное фрезерование: вращение в положительном направлении. Встречное фрезерование: вращение в отрицательном направлении. Влияет на знак A в режущих перемещениях; выберите в соответствии с тем, как фреза входит в материал на вашем станке.</translation>
    </message>
    <message>
      <location filename="../panels/PageOpRotarySurfaceEdit.ui" line="43"/>
      <source>Cut Pattern</source>
      <translation>Схема резания</translation>
    </message>
    <message>
      ...
      <translation>Спираль: непрерывное винтовое движение — самое быстрое, лучшее качество поверхности. Параллельная: осевые зигзагообразные проходы с угловым шагом. Кольца: кольца на полный оборот с осевым шагом. Все три создают непрерывное 4-осевое движение XYZA.</translation>
    </message>
    <message>
      <location filename="../panels/PageOpRotarySurfaceEdit.ui" line="57"/>
      <source>Feed Mode</source>
      <translation>Режим подачи</translation>
    </message>
    <message>
      ...
      <translation>Как интерпретируется HorizFeed контроллера инструмента. Только осевая: вывод F=HorizFeed на каждом режущем перемещении; собственная математика подачи контроллера определяет, как вращается ось — значения F в G-коде постоянны. Скорость поверхности: масштабирование F на перемещение, чтобы точка контакта фрезы сохраняла HorizFeed (мм/мин) вдоль поверхности — F = HorizFeed × 360 / (2π·r). F изменяется в зависимости от радиуса и ограничивается Max Feed.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Осевая начальная позиция вдоль оси вращения (мм). Определяет нижнюю границу обрабатываемой области.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Осевая конечная позиция вдоль оси вращения (мм). Должна быть больше, чем Start X.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Угловая начальная позиция (градусы, развернутая). Откуда начинается вращение; позволяет обрабатывать неполный оборот.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Угловая конечная позиция (градусы, развернутая). 360 охватывает полный оборот; предупреждает при выполнении, если превышает пределы оси вращения станка.</translation>
    </message>
    <message>
      <location filename="../panels/PageOpRotarySurfaceEdit.ui" line="127"/>
      <source>Step Over</source>
      <translation>Поперечный шаг</translation>
    </message>
    <message>
      ...
      <translation>Осевое продвижение за полный оборот (мм). Спираль: шаг. Кольца: расстояние между кольцами. Параллельная: также управляет угловым шагом, производным как StepOver / max_radius.</translation>
    </message>
    <message>
      <location filename="../panels/PageOpRotarySurfaceEdit.ui" line="141"/>
      <source>Angular Resolution</source>
      <translation>Угловое разрешение</translation>
    </message>
    <message>
      ...
      <translation>Плотность угловой выборки вдоль направления резания (градусы). Меньше = более гладкая поверхность, но больше G-кода; обычно 5–15°.</translation>
    </message>
    <message>
      ...
      <translation>Сколько припуска оставить на стенках для этой операции. Используйте небольшое положительное значение для чистового припуска; 0 режет непосредственно по поверхности.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Верхний предел эффективной скорости вращения, выдаваемой в режущих перемещениях (мм/мин). Предотвращает требование вращаться сколь угодно быстро по мере приближения реза к центральной линии. 0 = не установлено; возвращается к max(HorizRapid, VertRapid, 1000). Когда Feed Mode = Surface Speed, подача поверхности масштабируется вниз, чтобы вращение оставалось в пределах этого предела; события ограничения суммируются в журнале в конце пути.</translation>
    </message>
    <message>
      <location filename="../panels/PageOpRotarySurfaceEdit.ui" line="183"/>
      <source>Restrict to Selected Faces</source>
      <translation>Ограничить выбранными гранями</translation>
    </message>
    <message>
      ...
      <translation>Если установлено, ограничивает траекторию инструмента спроецированной (осевой, угловой) областью граней, выбранных на детали. Если снято, траектория инструмента покрывает полное окно Start X…Stop X / Start Angle…Stop Angle.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Схема обработки</translation>
    </message>
    <message>
      ...
      <translation>Схема обработки грани: Зигзаг, Двунаправленная, Направленная или Спираль</translation>
    </message>
    <message>
      <location filename="../panels/PageOpMillFacingEdit.ui" line="56"/>
      <source>Climb or Conventional milling direction</source>
      <translation>Направление попутного или встречного фрезерования</translation>
    </message>
    <message>
      <location filename="../panels/PageOpMillFacingEdit.ui" line="70"/>
      <source>Rotation angle for angled facing operations</source>
      <translation>Угол поворота для операций торцевания под углом</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Инвертировать направление резания для выбранной схемы</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Сколько припуска оставить на дне для этой операции</translation>
    </message>
  </context>
  <context>
...
См. политику сохранения файлов ниже, чтобы узнать, как решать конфликты имен.</translation>
    ...
    <message>
      ...
      <translation>Используется при вычислении дуг. Меньшее значение повышает точность, но замедляет вычисления</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Скрыть начальное быстрое перемещение в визуализации пути, установив начальный индекс на первое перемещение с подачей</translation>
    </message>
    <message>
      <location filename="../../DlgSettingsPathColor.ui" line="407"/>
      <source>Hide first rapid move</source>
      <translation>Скрыть первое быстрое перемещение</translation>
    </message>
    <message>
      ...
      <translation>Открывать редактор G-кода для просмотра и редактирования перед записью выходного файла</translation>
    </message>
    <message>
      <location filename="../../DlgSettingsPathColor.ui" line="423"/>
      <source>Show editor before writing G-code</source>
      <translation>Показывать редактор перед записью G-кода</translation>
    </message>
    <message>
      <location filename="../../DlgSettingsPathColor.ui" line="436"/>
      <source>Maximum lines of G-code to use highlighter</source>
      <translation>Максимальное количество строк G-кода для использования подсветки</translation>
    </message>
    <message>
...
Set to zero to disable G-code highlighter.</source>
      <translation>Ограничивает количество строк G-кода, для которых разрешена подсветка.
Уменьшите значение, если возникают проблемы с производительностью в окнах Inspect или экспорта G-кода.
Установите ноль, чтобы отключить подсветку G-кода.</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Инвертировать направление оси вращения</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Выберите желаемый стиль обработки углов (bone dressup):&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600; font-style:italic;&quot;&gt;Dogbone&lt;/span&gt; … выбирает самый короткий путь для охвата угла,&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600; font-style:italic;&quot;&gt;T-bone&lt;/span&gt; … удлиняет в определенном направлении, пока угол не будет охвачен&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Определяет длину врезания для обработки угла.&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600; font-style:italic;&quot;&gt;адаптивная&lt;/span&gt; … длина адаптируется для охвата угла на основе угла его ребер, с учетом текущего радиуса инструмента (по умолчанию)&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600; font-style:italic;&quot;&gt;фиксированная&lt;/span&gt; … такая же, как адаптивная для прямых углов. Для T-bone это радиус инструмента (R), а для dogbone это R * (2/√2 - 1).&lt;/p&gt;&lt;p&gt;&lt;span style=&quot; font-weight:600; font-style:italic;&quot;&gt;пользовательская&lt;/span&gt; … позволяет указать пользовательскую (фиксированную) длину ниже&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Удалить все метки из списка</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Удалить выбранную метку из списка</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Редактировать положение выбранной метки</translation>
    </message>
    <message>
      <location filename="../panels/HoldingTagsEdit.ui" line="131"/>
      <source>Replace all tags by tags from another DressupTag</source>
      <translation>Заменить все метки метками из другой настройки удержания</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Включить/отключить все метки</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Минимальное количество меток на короткий участок</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Максимальное количество меток на длинный участок</translation>
    </message>
    <message>
      ...
      <translation>Создать указанное количество меток для каждого нижнего участка</translation>
    </message>
    <message>
      <location filename="../panels/HoldingTagsEdit.ui" line="361"/>
      <source>Replace Existing Tags</source>
      <translation>Заменить существующие метки</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Установить состояние по умолчанию в соответствии с видимостью операций</translation>
    </message>
    <message>
      <location filename="../panels/TaskCAMSimulator.ui" line="130"/>
      <source>Follow operations visibility</source>
      <translation>Следовать видимости операций</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>* Примечание: Объемная симуляция, неточности неизбежны</translation>
    </message>
    <message>
...
Если для параметра &lt;span style="font-style:italic;&gt;order by&lt;/span&gt; установлено значение &lt;span style="font-style:italic;&gt;order by&lt;/span&gt; font-style:italic;&quot;&gt;operation&lt;/span&gt; и &lt;span style="font-style:italic;&quot;&gt;split output&lt;/span&gt; верно, каждая операция будет записана в отдельный файл.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    ...
    <message>
      ...
      <translation>Устанавливает метод создания заготовки: куб (явные размеры), цилиндр, расширение габаритного контейнера модели (по умолчанию) или существующее твердое тело из документа.</translation>
    </message>
    <message>
      ...
      <translation>Повторно создает заготовку из текущих настроек. Полезно после изменения габаритного контейнера модели или параметров заготовки.</translation>
    </message>
    <message>
      <location filename="../panels/PathEdit.ui" line="292"/>
      <source>Assign Material</source>
      <translation>Назначить материал</translation>
    </message>
    <message>
      ...
      <translation>В настоящее время назначенный материал заготовки. Нажмите кнопку материала, чтобы изменить.</translation>
    </message>
    <message>
...
По умолчанию: 3 мм</translation>
    ...
    <message>
      ...
      <translation>Конфигурация станка для этого задания, из доступных станков в пути ресурсов. Новые станки можно добавить с помощью кнопки Новый станок.</translation>
    </message>
    <message>
      <location filename="../panels/PathEdit.ui" line="1424"/>
      <source>New Machine</source>
      <translation>Новый станок</translation>
    </message>
    <message>
      ...
      <translation>Открывает редактор станков для создания нового станка. Новый станок будет доступен для выбора после сохранения.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Настройки операций по умолчанию</translation>
    </message>
  </context>
  <context>
    <name>Workbench</name>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Не удается восстановить порядок граней.</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>Стратегия предотвращения столкновений по умолчанию для новых операций.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Применить границу к доработке.</translation>
    </message>
    <message>
      ...
      <translation>Применить смещение к форме заготовки.</translation>
    </message>
    <message>
...
Custom: length from Custom property</source>
      <translation>Алгоритм определения длины врезания для обработки углов

Адаптивный: длина зависит от формы
Фиксированный: длина равна радиусу инструмента
Пользовательский: длина из пользовательского свойства</translation>
    </message>
    <message>
...
Also non zero value limit max &apos;adaptive&apos; length</source>
      <translation>Длина обработки, если врезание установлено на &apos;пользовательский&apos;
Также ненулевое значение ограничивает максимальную &apos;адаптивную&apos; длину</translation>
    </message>
    <message>
...
Может быть полезно для многопрофильных операций, например, для создания карманов с узором ZigZagOffset.</translation>
    ...
    <message>
      ...
      <translation>Разделить B-сплайн на дуги и игнорировать оси дуг, не являющиеся вертикальными (экспериментально).</translation>
    </message>
    <message>
...
Only for styles: Arc, Line, Perpendicular and Tangent</source>
      <translation>Удлиняет расстояние входа
Только для стилей: Дуга, Линия, Перпендикуляр и Касательная</translation>
    </message>
    <message>
...
Only for styles: Arc, Line, Perpendicular and Tangent</source>
      <translation>Удлиняет расстояние выхода
Только для стилей: Дуга, Линия, Перпендикуляр и Касательная</translation>
    </message>
    <message>
...
Ramp Method 3: Ramp down along the path until traveled half of the Z distance, change direction and ramp backwards to the original plunge end point.</source>
      <translation>Выберите метод наклонного входа.

Метод 0: Путь по спирали.
Метод 1: Спуск по наклону под углом rampangle вдоль пути и движение назад к исходной конечной точке врезания.
Метод 2: Перемещение на начальной глубине вдоль пути и спуск по наклону назад под углом rampangle вдоль пути к исходной конечной точке врезания.
Метод 3: Спуск по наклону вдоль пути до прохождения половины расстояния по Z, изменение направления и спуск по наклону назад к исходной конечной точке врезания.</translation>
    </message>
    <message>
...
Above this depth ramps are not generated, but motion commands are passed through as is.</source>
      <translation>Глубина, на которой включена обработка наклонного входа.
Выше этой глубины наклонные входы не создаются, а команды движения передаются как есть.</translation>
    </message>
    <message>
      ...
      <translation>Вычислять угол наклона от вертикальной плоскости</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Станок для задания</translation>
    </message>
    <message>
      ...
      <translation>Словарь JSON свойств постпроцессора, которые переопределяют настройки станка по умолчанию для этого задания</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Направление круговых проходов, по часовой стрелке (CW) или против часовой стрелки (CCW)</translation>
    </message>
    <message>
...
For External profile - profile radius</source>
      <translation>Установите, сколько припуска оставить на внутренней стенке для операции.
Радиус внутреннего профиля по умолчанию равен радиусу инструмента и не может быть меньше (-ToolRadius)
Для внешнего профиля - радиус профиля</translation>
    </message>
    <message>
      ...
      <translation>Установите, сколько припуска оставить на внешней стенке для операции.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Создать чистовую полную окружность для спирали</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Отводить от стенки при подъеме, если есть свободное пространство</translation>
    </message>
    <message>
      ...
      <translation>Переопределить подачу на дугах для получения постоянной скорости резания инструмента</translation>
    </message>
    <message>
...
This value can not be less than tool diameter</source>
      <translation>Заменить диаметры профилей для получения одинакового размера отверстий
Это значение не может быть меньше диаметра инструмента</translation>
    </message>
    <message>
...
Set -1 to calculate optimal angle automatically</source>
      <translation>Определяет положение начальной и конечной точек
Угол 0 означает, что начальная и конечная точки расположены вдоль оси X
Установите -1 для автоматического вычисления оптимального угла</translation>
    </message>
    <message>
...
Set to zero to disable limitation by pitch</source>
      <translation>Максимально допустимое снижение за один оборот спирали
Установите ноль, чтобы отключить ограничение по шагу</translation>
    </message>
    <message>
...
Set to zero to disable limitation by ramp angle</source>
      <translation>Максимально допустимый угол входа по наклону
Установите ноль, чтобы отключить ограничение по углу наклона</translation>
    </message>
    <message>
      ...
      <translation>Позволяет обрабатывать коническую спираль снизу вверх</translation>
    </message>
    <message>
...
Большие значения (кроме справа) будут вычисляться быстрее; меньшие значения (далее слева) позволят получить более точные пути инструментов.</translation>
    ...
    <message>
      ...
      <translation>Установите, сколько припуска оставить на дне для операции. Это свойство используется только в том случае, если включен ModelAwareExperiment.</translation>
    </message>
    <message>
...
Set to zero to disable limitation by ramp angle</source>
      <translation>Максимально допустимый угол входа по спирали (градусы)
Установите ноль, чтобы отключить ограничение по углу наклона</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Минимально допустимый диаметр входа по спирали, в процентах от диаметра инструмента</translation>
    </message>
    <message>
      ...
      <translation>Максимально допустимое снижение за один оборот спирали. Установите 0, чтобы отключить ограничение по шагу.</translation>
    </message>
    <message>
...
Tool Shape: safest - checks clearance using the cross section of the tool shape</source>
      <translation>Метод обнаружения столкновений для создания оптимального пути между областями

Высота зазора: без обнаружения столкновений, использует высоту зазора для быстрых перемещений между областями
Высота подъема: без обнаружения столкновений, использует безопасную высоту для быстрых перемещений между областями
Прямая видимость: самый быстрый - проверяет центральную линию пути
Диаметр инструмента: сбалансированный - проверяет зазор, используя диаметр инструмента
Форма инструмента: самый безопасный - проверяет зазор, используя поперечное сечение формы инструмента</translation>
    </message>
    <message>
      ...
      <translation>Расстояние для обнаружения столкновений</translation>
    </message>
    <message>
      ...
      <translation>Разрешить постпроцессору добавлять команды удаления блоков</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Ориентация инструмента для этой операции. По умолчанию (0, 0, 1) для стандартного фрезерования с осью Z вверх.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Ручная или автоматическая сортировка отверстий</translation>
    </message>
    <message>
      ...
      <translation>Начальная точка для автоматической сортировки (используются x,y, z игнорируется)</translation>
    </message>
    <message>
      ...
      <translation>Включить использование конечной точки для автоматической сортировки</translation>
    </message>
    <message>
      ...
      <translation>Конечная точка для автоматической сортировки (используются x,y, z игнорируется)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Применить подъем G99: поднимать только до StartDepth между отверстиями в этой операции</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Инвертировать направление фрезерования</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Аппроксимировать сложные кривые дугами и линиями</translation>
    </message>
    <message>
...
Automatic - Sorting wires by the nearest neighbour method, further improved with 2-opt</source>
      <translation>Порядок обработки контуров

Вручную - Использовать порядок из выбора без сортировки
Автоматически - Сортировать контуры методом ближайшего соседа, дополнительно улучшенным 2-opt</translation>
    </message>
    <message>
      ...
      <translation>Начальная точка для сортировки</translation>
    </message>
    <message>
      ...
      <translation>Конечная точка для сортировки</translation>
    </message>
    <message>
      ...
      <translation>Использовать конечную точку для сортировки</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Угол для схем сетки, линии и зигзага</translation>
    </message>
    <message>
      ...
      <source>Set distance which will attempts to avoid unnecessary retractions.</source>
      <translation>Установить расстояние, которое будет пытаться избежать ненужных подъемов.</translation>
    </message>
    <message>
      ...
      <translation>Принудительно использовать максимальный поперечный шаг, даже если не вся область обработана. Без этого флага поперечный шаг может быть уменьшен (для больших шагов, &gt;50%) для обеспечения полного покрытия области.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Ограничить область зондирования формой. Точка должна быть внутри формы на конечной глубине</translation>
    </message>
    <message>
...
Shoud be used only with Individually HandleMultipleFeaturesand disabled UseStartPoint</source>
      <translation>Переопределить начальную точку
Следует использовать только с индивидуальной обработкой множественных функций и отключенным UseStartPoint</translation>
    </message>
    <message>
...
Manual: uses order of shapes selection</source>
      <translation>Порядок обработки фигур
Автоматически: использует алгоритм ближайшего соседа для сортировки фигур
Вручную: использует порядок выбора фигур</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Использовать случайное смещение</translation>
    </message>
    <message>
...
Should be identical for all base operations</source>
      <translation>Контроллер инструмента, который будет использоваться для расчета траектории
Должен быть одинаковым для всех базовых операций</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Gui/Array.py" line="86"/>
      <source>The number of copies in Linear1D and Polar pattern</source>
      <translation>Количество копий в линейном и полярном массиве</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Начинать с самого дальнего повторения</translation>
    </message>
    <message>
...
- shape contains edges: create only one repeat (useful for imported nesting shapes)</source>
      <translation>Определяет смещения и угол поворота для повторений из выбранных фигур

Если выбраны фигуры без подэлементов:
- фигура содержит только вершины: создать повторение для каждой вершины
- фигура содержит ребра: создать только одно повторение (полезно для импортированных фигур для раскладки)</translation>
    </message>
    <message>
      ...
      <translation>Определяет базовые смещения и угол поворота из выбранной фигуры</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Максимальный угол поворота для случайного разброса</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Единицы измерения для режущего инструмента</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Скорость подачи для наклонных перемещений</translation>
    </message>
    <message>
      ...
      <translation>Скорость подачи, используемая, когда инструмент не врезан в материал, но также не поднят</translation>
    </message>
    <message>
      ...
      <translation>Скорость подачи для входа</translation>
    </message>
    <message>
      ...
      <translation>Скорость подачи для выхода</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <source>Make &apos;False&apos; to prevent operation from generating code</source>
      <translation>Установите &apos;False&apos;, чтобы предотвратить генерацию кода операцией</translation>
    </message>
    <message>
...
to align to the arc encountered.</source>
      <translation>Плоскость рисования дуг, соответствующая G17, G18 и G19.

Если не &apos;None&apos;, выходные контуры будут преобразованы для выравнивания по выбранной плоскости,
и будет вставлен соответствующий G-код.

&apos;Auto&apos; означает, что плоскость определяется первой встреченной плоскостью дуги.
Если найденная плоскость не соответствует ни одной плоскости G-кода, используется плоскость XY.

&apos;Variable&apos; означает, что плоскость дуги может быть изменена во время операции
для выравнивания по встреченной дуге.</translation>
    </message>
    <message>
...
so that more correction points can be inserted.</source>
      <translation>Разбивать длинные кривые на сегменты этой длины.
Один из вариантов использования - для автовыравнивания печатных плат,
чтобы можно было вставить больше корректирующих точек.</translation>
    </message>
    <message>
...
when you &apos;Explode&apos; the shape for wire operations</source>
      <translation>Отклонение для дискретизации некруговых кривых.

Оно также используется для дискретизации круговых контуров,
когда вы &apos;Разбиваете&apos; фигуру для операций с контурами</translation>
    </message>
    <message>
...
Set zero to disable wire breaking.</source>
      <translation>Минимальное расстояние для сгенерированных новых контуров.
Контуры могут быть разбиты, если алгоритм сочтет это целесообразным.

Установите ноль, чтобы отключить разбиение контуров.</translation>
    </message>
    <message>
...
&apos;Reversed&apos; means the other way round.</source>
      <translation>Принудительная ориентация контуров.

&apos;Normal&apos; означает против часовой стрелки для внешних контуров при взгляде против
направления положительной оси и по часовой стрелке для внутренних контуров.

&apos;Reversed&apos; означает наоборот.</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Gui/PathShape.py" line="201"/>
      <source>Enforce open path direction</source>
      <translation>Принудительное направление открытого пути</translation>
    </message>
    <message>
...
Only if &apos;HandleMultipleFeatures&apos; is &apos;Individually&apos;.</source>
      <translation>Инвертировать направление на каждом спуске.
Только если &apos;HandleMultipleFeatures&apos; установлено на &apos;Individually&apos;.</translation>
    </message>
    <message>
...
You may want to set this to the tool diameter to keep the tool down.</source>
      <translation>Если конечные точки двух контуров разделены в пределах этого порога,
они считаются соединенными.
Возможно, вы захотите установить это значение равным диаметру инструмента, чтобы инструмент оставался внизу.</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Gui/PathShape.py" line="228"/>
      <source>Add move to Clearanc Height Out in the end</source>
      <translation>Добавить перемещение на высоту зазора в конце</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Gui/PathShape.py" line="234"/>
      <source>Tool retraction axis</source>
      <translation>Ось подъема инструмента</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Gui/PathShape.py" line="242"/>
      <source>Choose how to process multiple Base Geometry features</source>
      <translation>Выберите способ обработки нескольких функций базовой геометрии</translation>
    </message>
    <message>
...
The path in lower layer is only selected if the moving distance is within the value given in &apos;threshold&apos;.</source>
      <translation>Режим сортировки контуров для оптимизации пути перемещения.

&apos;2D5&apos; разбивает фигуры на контуры и группирует фигуры по их плоскости.
Позиция &apos;start&apos; выбирает первую плоскость для старта.
Затем алгоритм сортирует внутри плоскости и переходит к следующей ближайшей плоскости.

&apos;3D&apos; не предполагает планарности. Сортировка выполняется в трехмерном пространстве.

&apos;Greedy&apos; подобен &apos;2D5&apos;, но пытается минимизировать перемещение, ища ближайший путь ниже текущего слоя фрезерования.
Путь в нижнем слое выбирается только в том случае, если расстояние перемещения находится в пределах значения, заданного в &apos;threshold&apos;.</translation>
    </message>
    <message>
...
The sampling is dong using OCC GCPnts_UniformAbscissa.</source>
      <translation>Управляет выборкой вершин на контуре для поиска ближайшей точки.
Выборка выполняется с использованием OCC GCPnts_UniformAbscissa.</translation>
    </message>
    <message>
      ...
      <translation>При сортировке рассматриваются k ближайших вершин выборки</translation>
    </message>
    <message>
      ...
      <translation>Если true, каждый G-код движения будет содержать полные координаты и скорость подачи</translation>
    </message>
    <message>
...
and prevents path optimization on some controllers</source>
      <translation>Выдавать преамбулы G90.1 G17 G18 G19

Обратите внимание, что выдача преамбул между перемещениями нарушает некоторые настройки
и препятствует оптимизации пути на некоторых контроллерах</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Gui/PathShape.py" line="317"/>
      <source>Start depth with step depth.</source>
      <translation>Начальная глубина с глубиной шага.</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Gui/PathShape.py" line="323"/>
      <source>Incremental Step Down of Tool.</source>
      <translation>Приращение глубины инструмента.</translation>
    </message>
    <message>
...
Абсолютная координата подъема инструмента вдоль оси подъема</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Gui/PathShape.py" line="341"/>
      <source>Clearance height in the end</source>
      <translation>Высота зазора в конце</translation>
    </message>
    <message>
...
this gives the pause of the next move</source>
      <translation>Высота возобновления

При возврате после последнего подъема,
это задает паузу перед следующим перемещением</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Установите, сколько припуска оставить на дне для операции.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Осевое продвижение за полный оборот оси вращения (шаг спирали).</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/RotarySurface.py" line="164"/>
      <source>Angular spacing between sampled toolpath points (degrees).</source>
      <translation>Угловой шаг между точками выборки траектории (градусы).</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Ограничение эффективной подачи (мм/мин); используется для обработки сингулярности на центральной линии при приближении r к нулю. 0 означает возврат к быстрой скорости контроллера инструмента.</translation>
    </message>
    <message>
      ...
      <translation>Если true и Base заполнен, ограничить траекторию инструмента спроецированными (осевыми, угловыми) границами выбранных граней.</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/RotarySurface.py" line="225"/>
      <source>Tessellation linear deflection. Smaller = finer mesh.</source>
      <translation>Линейное отклонение тесселяции. Меньше = более мелкая сетка.</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/RotarySurface.py" line="234"/>
      <source>Tessellation angular deflection. Smaller = finer mesh.</source>
      <translation>Угловое отклонение тесселяции. Меньше = более мелкая сетка.</translation>
    </message>
    <message>
      ...
      <translation>Замкнуть открытую область, образованную ребрами или вертикальными гранями, прямой линией.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Список предустановок подач и скоростей в формате JSON</translation>
    </message>
    <message>
      ...
      <translation>Подсказка, для какой категории операций предназначен этот контроллер инструмента</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Длина заготовки не может быть нулевой или отрицательной. Использована длина %s мм</translation>
    </message>
    <message>
      <location filename="../../../Path/Main/Stock.py" line="233"/>
      <source>Stock width can not be zero or negative. Used width %s mm</source>
      <translation>Ширина заготовки не может быть нулевой или отрицательной. Использована ширина %s мм</translation>
    </message>
    <message>
      <location filename="../../../Path/Main/Stock.py" line="243"/>
      <source>Stock height can not be zero or negative. Used height %s mm</source>
      <translation>Высота заготовки не может быть нулевой или отрицательной. Использована высота %s мм</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Пределы минимального интервала выборки от 0.0001 до 25.4 миллиметров.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Траектория инструмента превысила пределы габаритного контейнера заготовки. Рассмотрите возможность использования обработки границ.</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Waterline.py" line="1408"/>
      <source>Step Down above model. Skipping height : </source>
      <translation>Спуск над моделью. Пропуск высоты:</translation>
    </message>
  </context>
  <context>
    <name>PathOp</name>
    ...
    <message>
      ...
      <translation>Установить рабочую плоскость по грани</translation>
    </message>
    <message>
...
Прерываем команду</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Не удается разобрать выражение из строки %s: %s</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Проверьте строки: %s</translation>
    </message>
    <message>
...
Without sub selection:
    Select all edges, faces (ALT) or vertexes (CTRL) of the model.</source>
      <translation>Завершает выбор ребер или граней, образующих замкнутый контур.
Работает в описанной последовательности, но может быть принудительно активировано клавишей-модификатором.

Выбор грани:
    Вертикальная грань: поиск граней, образующих контур стен
        или вертикальных граней с одинаковой высотой центра (SHIFT).
    Горизонтальная грань: поиск внутренних ребер грани (CTRL),
        внешних ребер грани (CTRL + ALT)
        или горизонтальных граней на одной высоте (SHIFT).
    В противном случае выбрать все ребра грани (ALT).

Выбор ребра:
    Одно ребро: поиск ребер контура в горизонтальной плоскости.
    Два ребра: поиск ребер контура в контурах фигуры или касательных ребер (CTRL).
    В противном случае поиск горизонтальных контуров, содержащих выбранные ребра (ALT).

Без выбора подэлементов:
    Выбрать все ребра, грани (ALT) или вершины (CTRL) модели.</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>Не удается получить параметры из базовой операции и пути</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Выберите один объект траектории инструмента</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Выбранный объект не является операцией или настройкой</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Доступны обновления инструментов</translation>
    </message>
    <message>
      ...
      <translation>&apos;{}&apos; содержит инструменты, отличающиеся от библиотечных (новые предустановки, измененные размеры - например, переточка - или и то, и другое). Обновление заменяет весь инструмент на текущую версию из библиотеки и пересчитывает документ - разверните строку для просмотра перед применением.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Обновить инструменты из библиотеки</translation>
    </message>
    <message>
      <location filename="../../../Path/Tool/Gui/UpdateDocumentToolsDlg.py" line="347"/>
      <source>This job has no tool updates available.</source>
      <translation>Для этого задания нет доступных обновлений инструментов.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Скорость, выраженная в минуту (рекомендуется для G-кода)</translation>
    </message>
    <message>
      ...
      <translation>Скорость, выраженная в секунду. Небезопасно для скоростей подачи G-кода.</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>&lt;b&gt;Примечание&lt;/b&gt;: Это диалоговое окно показывает команды пути в базовых единицах FreeCAD (мм/с).&lt;br&gt;Значения будут преобразованы в нужные единицы во время постобработки.</translation>
    </message>
    <message>
...
G-code under the cursor defines tool shape placement</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>В задании не найдено операций</translation>
    </message>
    <message>
      <location filename="../../../Path/Main/Sanity/Sanity.py" line="663"/>
      <source>No model/base geometry found in job</source>
      <translation>В задании не найдено модели/базовой геометрии</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Проверяет CAM-задание на наличие распространенных проблем без создания полного отчета</translation>
    </message>
    <message>
      <location filename="../../../Path/Main/Gui/SanityCmd.py" line="136"/>
      <source>Quick Validate: No issues found.
</source>
      <translation>Быстрая проверка: Проблем не найдено.</translation>
    </message>
    <message>
      <location filename="../../../Path/Main/Gui/SanityCmd.py" line="139"/>
      <source>=== Quick Validation Results ===
</source>
      <translation>=== Результаты быстрой проверки ===</translation>
    </message>
    <message>
      <location filename="../../../Path/Main/Gui/SanityCmd.py" line="151"/>
      <source>=== {len(all_squawks)} issue(s) found, {len(critical_squawks)} critical ===
</source>
      <translation>=== Найдено {len(all_squawks)} проблем, {len(critical_squawks)} критических ===</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Этот контроллер инструмента используется в 1 другой операции.</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Подачи и скорости</translation>
    </message>
    <message>
...
Это не удалит инструменты, содержащиеся в ней.</translation>
    ...
    <message>
      ...
      <translation>Расширение файла по умолчанию для выходных файлов (без точки). Распространенные расширения: nc, gcode, tap, ngc, sbp и т.д.</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/Processor.py" line="331"/>
      <source>Tool Radius Compensation (G41/G42)</source>
      <translation>Компенсация радиуса инструмента (G41/G42)</translation>
    </message>
    <message>
      ...
      <translation>Включите, если этот постпроцессор поддерживает команды компенсации радиуса инструмента G41/G42. При включении постпроцессор может выводить коды компенсации фрезы.</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/Processor.py" line="342"/>
      <source>Supported G-code Commands</source>
      <translation>Поддерживаемые команды G-кода</translation>
    </message>
    <message>
      ...
      <translation>Список команд G-кода, поддерживаемых этим постпроцессором (по одной на строку). Команды, отсутствующие в этом списке, будут отфильтрованы или вызовут предупреждения.</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/Processor.py" line="353"/>
      <source>Drill Cycles to Translate</source>
      <translation>Циклы сверления для преобразования</translation>
    </message>
    <message>
      ...
      <translation>Список команд циклов сверления для преобразования в перемещения G0/G1 (по одной на строку). Стандартные циклы сверления: {&apos;, &apos;.join(Constants.GCODE_MOVE_DRILL)}. Оставьте пустым, если постпроцессор поддерживает циклы сверления изначально.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Команды G-кода, вставляемые в начале программы после заголовка.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Команды G-кода, вставляемые в конце программы.</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/Processor.py" line="381"/>
      <source>Safety Block</source>
      <translation>Блок безопасности</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Сохранить без изменений</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Постпроцессор Mach3_Mach4</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/scripts/opensbp_post.py" line="165"/>
      <source>Automatic Tool Changer</source>
      <translation>Автоматическая смена инструмента</translation>
    </message>
    <message>
      ...
      <translation>Включите, если станок имеет автоматическую смену инструмента. Если отключено, смена инструмента будет приостанавливаться для ручного вмешательства.</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/scripts/opensbp_post.py" line="176"/>
      <source>Automatic Spindle Control</source>
      <translation>Автоматическое управление шпинделем</translation>
    </message>
    <message>
      ...
      <translation>Включите, если станок имеет автоматическое управление скоростью шпинделя. Если отключено, команды шпинделя будут требовать ручной настройки.</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/scripts/opensbp_post.py" line="188"/>
      <source>Suppressed (tolerated) G-code Commands</source>
      <translation>Подавляемые (допустимые) команды G-кода</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Задержка прожига в миллисекундах после зажигания горелки (M3) перед началом движения</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/scripts/generic_plasma_post.py" line="103"/>
      <source>Cooling Delay</source>
      <translation>Задержка охлаждения</translation>
    </message>
    <message>
      ...
      <translation>Задержка охлаждения в миллисекундах после гашения горелки (M5) перед движением</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/scripts/generic_plasma_post.py" line="115"/>
      <source>Marking Delay</source>
      <translation>Задержка маркировки</translation>
    </message>
    <message>
      ...
      <translation>Задержка маркировки в миллисекундах после зажигания горелки (M3) при нанесении метки</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/scripts/generic_plasma_post.py" line="127"/>
      <source>Torch Z-Axis Control</source>
      <translation>Управление осью Z горелки</translation>
    </message>
    <message>
      ...
      <translation>Горелка зажигается (M3) при движении по Z- и гаснет (M5) при движении по Z+. Если отключено, любые команды M3/M5 выводятся как есть.</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/scripts/generic_plasma_post.py" line="138"/>
      <source>Force Rapid Feeds</source>
      <translation>Принудительные быстрые подачи</translation>
    </message>
    <message>
      ...
      <translation>Принудительно использовать быстрые подачи для всех команд с указанной подачей. Полезно для прогонов для проверки траекторий без резания.</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/scripts/generic_plasma_post.py" line="150"/>
      <source>Mark Entry Points Only</source>
      <translation>Только маркировка точек входа</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Режим сглаживания пути: EXACT_PATH (G61) останавливается в каждой точке, EXACT_STOP (G61.1) останавливается в концах пути, BLEND (G64) допускает плавное движение</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/scripts/linuxcnc_post.py" line="106"/>
      <source>Blend Tolerance</source>
      <translation>Допуск сглаживания</translation>
    </message>
    <message>
      ...
      <translation>Допуск для режима BLEND (значение P): 0 = без допуска (G64), &gt;0 = с допуском (G64 P-), в текущих единицах</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/scripts/linuxcnc_post.py" line="122"/>
      <source>LinuxCNC post processor</source>
      <translation>Постпроцессор LinuxCNC</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Стратегия нарезания резьбы требует инструмент с шагом резьбы</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Drilling.py" line="494"/>
      <source>Tapping strategy requires a Tap tool with non-zero Pitch</source>
      <translation>Стратегия нарезания резьбы требует инструмент с ненулевым шагом резьбы</translation>
    </message>
    <message>
      ...
      <translation>Стратегия нарезания резьбы требует контроллер инструмента с ненулевой скоростью шпинделя</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Установить начальную точку: %s, %s</translation>
    </message>
  </context>
  <context>
    <name>CAM_Slot</name>
    ...
    <message>
      ...
      <translation>Должна быть выбрана только одна или две фигуры.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Фигуры должны быть параллельны, чтобы создать паз между ними.</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Slot.py" line="911"/>
      <source>Points not defined.</source>
      <translation>Точки не определены.</translation>
    </message>
    <message>
      ...
      <translation>Выбрана только одна вершина. Добавьте другую функцию в базовую геометрию.</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Slot.py" line="957"/>
      <source>A single selected face must have four edges.</source>
      <translation>Одна выбранная грань должна иметь четыре ребра.</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Slot.py" line="1122"/>
      <source>Can not create slot from this circle</source>
      <translation>Невозможно создать паз из этой окружности</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Slot.py" line="1126"/>
      <source>Can not create slot from not horizontal circle</source>
      <translation>Невозможно создать паз из негоризонтальной окружности</translation>
    </message>
    <message>
      ...
      <translation>Невозможно создать паз из этого ребра</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/Slot.py" line="1154"/>
      <source>Can not create slot from too small circle</source>
      <translation>Невозможно создать паз из слишком маленькой окружности</translation>
    </message>
    <message>
...
Allowed selection only from one model:
  ...
  - one or two vertical faces.</source>
      <translation>Создать один горизонтальный паз между двумя точками.

Точки можно задать через выбранную геометрию или пользовательские точки.
Разрешен выбор только из одной модели:
  - две вершины,
  - одно или два ребра,
  - одна горизонтальная или вертикальная грань,
  - одна или две вертикальные грани.</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Выберите файл, содержащий G-код</translation>
    </message>
    <message>
...
Several operations can be used with identical tool controller and coolant mode</source>
      <translation>Создает непараметрическую копию другой траектории инструмента
Несколько операций могут использовать одинаковый контроллер инструмента и режим охлаждения</translation>
    </message>
  </context>
  <context>
    <name>CAM_Stop</name>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Постобработка - Задание: {}</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Свойства постпроцессора</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/Gui/DlgPostProcess.py" line="548"/>
      <source>(no fixtures defined)</source>
      <translation>(приспособления не определены)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>{} критических проблем — проверьте перед обработкой.</translation>
    </message>
    <message>
      <location filename="../../../Path/Post/Gui/DlgPostProcess.py" line="718"/>
      <source>{} advisory notice(s) found.</source>
      <translation>Найдено {} предупреждений.</translation>
    </message>
    <message>
...
{}</source>
      <translation>{} ошибок при сохранении:
{}</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Мастер подач и скоростей</translation>
    </message>
    <message>
...
Tool number for {}:</translation>
    ...
    <message>
      ...
      <translation>Сначала создайте задание.</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Расположение ресурсов</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Примечание: Выберите каталог, который будет содержать папку Tools с подпапками Bit/, Shape/ и Library/, а также папку Machines/.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Станки</translation>
    </message>
    <message>
      ...
      <translation>Предупреждение: Определение станка является экспериментальной функцией. Изменения, сделанные здесь, не повлияют ни на какую функциональность CAM</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Проверять наличие обновлений инструментов из библиотеки при открытии документа</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Удалить станок</translation>
    </message>
    <message>
      ...
      <translation>Вы уверены, что хотите удалить этот файл станка?</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Режущий диаметр</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Постобработать операции</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Постобработка - Задание: (неизвестно)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Конфигурация станка (.fcm) для использования в постобработке</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Отметьте приспособления для включения в вывод G-кода</translation>
    </message>
    <message>
      <location filename="../panels/DlgPostProcess.ui" line="100"/>
      <source>Job Details</source>
      <translation>Детали задания</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Имя автора, записываемое в комментарий заголовка G-кода</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Произвольный комментарий, записываемый в заголовок G-кода</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Отметьте операции для включения в вывод G-кода. Снимите флажок, чтобы пропустить.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Показать план работы (структура элементов для постобработки)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>(Выберите станок на вкладке Обзор, чтобы увидеть параметры вывода станка)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Папка, где будут сохраняться файлы G-кода</translation>
    </message>
    <message>
      <location filename="../panels/DlgPostProcess.ui" line="383"/>
      <source>(resolved when output is generated)</source>
      <translation>(определяется при генерации вывода)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Шаблон имени файла. Подстановки: %j=имя задания, %d=документ, %T=инструмент, %W=приспособление, %O=операция</translation>
    </message>
    <message>
      <location filename="../panels/DlgPostProcess.ui" line="417"/>
      <source>e.g. %j.nc</source>
      <translation>например, %j.nc</translation>
    </message>
    <message>
      <location filename="../panels/DlgPostProcess.ui" line="433"/>
      <source>Regenerate output filenames using this template</source>
      <translation>Повторно сгенерировать имена выходных файлов, используя этот шаблон</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Нажмите &quot;Сгенерировать вывод&quot;, чтобы просмотреть G-код перед сохранением.</translation>
    </message>
    <message>
      ...
      <translation>Сгенерированные выходные файлы. Выберите файл для просмотра или редактирования его содержимого.</translation>
    </message>
    <message>
      ...
      <translation>Содержимое G-кода для выбранного файла. Вы можете редактировать перед сохранением.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>В задании обнаружены проблемы проверки. Элементы с предупреждениями и предостережениями следует устранить перед обработкой.</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Редактировать предустановку</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Общий (любой материал)</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Соотношение вертикальной подачи:</translation>
    </message>
    <message>
      <location filename="../panels/FeedsSpeedsPresetEdit.ui" line="136"/>
      <source>Direct feed and speed</source>
      <translation>Прямая подача и скорость</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Отсутствует диаметр инструмента и/или количество зубьев — скорость поверхности и нагрузка на зуб не будут автоматически синхронизироваться с прямой подачей/скоростью.</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>Включать имя станка</translation>
    </message>
    <message>
      ...
      <translation>Выводить дублирующиеся значения осей</translation>
    </message>
    <message>
      <location filename="../../../Machine/ui/editor/machine_editor.py" line="94"/>
      <source>Adaptive Output</source>
      <translation>Адаптивный вывод</translation>
    </message>
    <message>
      ...
      <translation>Точность осей</translation>
    </message>
    <message>
      ...
      <translation>Точность подачи</translation>
    </message>
    <message>
      <location filename="../../../Machine/ui/editor/machine_editor.py" line="97"/>
      <source>Toolhead Decimals</source>
      <translation>Десятичные знаки для инструментальной головки</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Включать метки операций</translation>
    </message>
    <message>
      <location filename="../../../Machine/ui/editor/machine_editor.py" line="149"/>
      <source>Output bCNC Comments</source>
      <translation>Выводить комментарии bCNC</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Базовая система координат</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Кватернион ориентации</translation>
    </message>
    <message>
      ...
      <translation>Поддерживается TCP</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Родительская ось</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Предпочтение решения</translation>
    </message>
    <message>
      ...
      <translation>Разрешить переворот</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Редактор станков</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Инструментальные головки</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Удалить инструментальную головку</translation>
    </message>
    <message>
      <location filename="../../../Machine/ui/editor/machine_editor.py" line="783"/>
      <source>Remove toolhead? This action cannot be undone.</source>
      <translation>Удалить инструментальную головку? Это действие невозможно отменить.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Не удалось загрузить шаблон</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Загрузить настройки из существующего шаблона станка</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Добавить инструментальную головку</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Мин. предел</translation>
    </message>
    <message>
      ...
      <translation>Макс. предел</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Выберите файл постпроцессора для этого станка</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Станок с именем &apos;{}&apos; уже существует. Пожалуйста, выберите другое имя.</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Торцевание</translation>
    </message>
    <message>
      ...
      <translation>Создать операцию торцевания для обработки верхней поверхности заготовки</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>Непрерывная 4-осевая обработка поверхности детали, установленной на одной оси вращения.</translation>
    </message>
  </context>
  <context>
    <name>PathHelix</name>
    <message>
      ...
      <translation>Пропущено отверстие в позиции %s</translation>
    </message>
  </context>
  <context>
...
You can enable feature Close Open Path</source>
      <translation>Команда Pocket Shape не может обработать открытый контур.
Вы можете включить опцию &quot;Замкнуть открытый путь&quot;</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/PocketShape.py" line="346"/>
      <source>Processing vertical faces was failed</source>
      <translation>Обработка вертикальных граней не удалась</translation>
    </message>
    <message>
      <location filename="../../../Path/Op/PocketShape.py" line="354"/>
      <source>Processing vertical faces was failed.
You can enable feature Close Open Path</source>
      <translation>Обработка вертикальных граней не удалась.
Вы можете включить опцию &quot;Замкнуть открытый путь&quot;</translation>
    </message>
  </context>
  <context>
...
Supported tool types: flat, bull-nose, V-bit.</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>: Будут обработаны только шаги ниже верхней грани модели.</translation>
    </message>
  </context>
  <context>
    <name>PathShape</name>
    <message>
      ...
      <translation>Контроллер инструмента не выбран для операции %s</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>Создает путь из выбранных фигур с контроллером инструмента</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>Предложить подачи и скорости</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>(нет — общее разрешение)</translation>
    </message>
    <message>
      <location filename="../../../Path/Tool/Gui/FeedsSpeedsDialog.py" line="357"/>
      <source>Material:</source>
    ...
    <message>
      ...
      <translation>Авто (использовать резолвер)</translation>
    </message>
    <message>
      <location filename="../../../Path/Tool/Gui/FeedsSpeedsDialog.py" line="530"/>
      <source>No suggestion available</source>
      <translation>Нет доступных предложений</translation>
    </message>
    <message>
      ...
      <translation>Нет подходящей предустановки для этого инструмента. Откройте инструмент из библиотеки, чтобы добавить предустановки.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>например, &apos;Алюминий агрессивный&apos;</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Дайте предустановке имя.</translation>
    </message>
    <message>
      <location filename="../../../Path/Tool/toolbit/ui/presets_tab.py" line="457"/>
      <source>Duplicate preset</source>
      <translation>Дублировать предустановку</translation>
    </message>
    <message>
      ...
      <translation>Этот инструмент уже имеет предустановку с именем &apos;%s&apos; для этого материала и типа операции.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>(любой материал)</translation>
    </message>
  </context>
  <context>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Создает зеркальное отражение выбранного пути</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Уменьшить скорость симуляции</translation>
    </message>
    <message>
      <location filename="../../../PathSimulator/AppGL/GuiDisplay.ui" line="81"/>
      <source>Increase simulation speed</source>
      <translation>Увеличить скорость симуляции</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Переключить вид симуляция/модель</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Показать/скрыть траекторию инструмента</translation>
    </message>
    <message>
      <location filename="../../../PathSimulator/AppGL/GuiDisplay.ui" line="170"/>
      <source>Toggle ambient occlusion</source>
      <translation>Переключить ambient occlusion</translation>
    </message>
    <message>
