...
FreeCAD не знає, де знаходиться певна система координат у системі координат верстата, тому додавання додаткових систем координат до вашої роботи не призведе до візуальних змін у вашій роботі. Однак, це змінить вивід G-коду. Точний спосіб впливу на виведення контролюється параметром &apos;order by&apos;.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    ...
    <message>
      ...
      <translation>Якщо використовується кілька систем координат, встановлення цього значення на TRUE призведе до того, що G-код буде записано в кілька вихідних файлів, що контролюються властивістю 'порядок за'. Наприклад, якщо порядок за Fixture, перший вихідний файл буде для першого обладнання, а окремий файл — для другого.</translation>
    </message>
    <message>
