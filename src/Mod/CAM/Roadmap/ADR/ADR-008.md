...
## Decision
1) All offsets (heights and depths) are relative to the job origin.
2) All offsets will use The term 'Height'. 
...
4) The following offsets are to be used.
...
The feed offset is the height from which entry moves will begin. A rapid move vertically from retract height to feed height will be assumed safe. 
