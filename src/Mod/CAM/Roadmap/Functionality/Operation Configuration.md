...
| Entry Start Point   | Allow user to specify entry point        | Start point selection is poorly implemented.  It's not allowed at all in adaptive.<br>When used in other pocket ops (millface) only a single point is allowed.  If the pocket algorithm needs to retract and re-enter, it will use whichever point is needed.  <br><br>Pocket entry point should be studied to evaluate the current state-of-the-art.  Either remove it and let the op set start point automatically or reimplement it consistently. |
| Clearing Strategies | zigzag, offset, adaptive                 | COMPLETE.                                                                                                                                                                                                                                                                                                                                                                                                                                            |
