...
# generated by Post/PostList.py, apply_early_tool_prep() if processor._machine.processing.early_tool_prep
# NB, this is not a Path.Command.Name, it always has it's parameter value with it, e.g. T6
GCODE_BARE_T = ["T"]
...
# Bare parameters that are allowed (with their value!)
GCODE_NON_CONFORMING_BARE = [GCODE_BARE_T]
...
PARAMETER_ORDER = "XYZABCUVWFSIJKTQRPDHL"
