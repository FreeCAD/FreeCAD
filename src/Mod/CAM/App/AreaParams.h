...
#define AREA_PARAMS_CAREA \
    ((double, \
      ...
      App::PropertyPrecision)) \
        AREA_PARAMS_FIT_ARCS((bool, clipper_simple, Simplify, false, "Simplify polygons after operation. See http://www.angusj.com/clipper2/Docs/Units/Clipper/Functions/SimplifyPaths.htm"))((double, clipper_clean_distance, CleanDistance, 0.0, "Clean polygon smaller than this distance. See http://www.angusj.com/clipper2/Docs/Units/Clipper/Functions/SimplifyPaths.htm", App::PropertyLength))((double, accuracy, Accuracy, 0.01, "Arc fitting accuracy", App::PropertyPrecision))((short, min_arc_points, MinArcPoints, 4, "Minimum segments for arc discretization"))((short, max_arc_points, MaxArcPoints, 100, "Maximum segments for arc discretization (ignored currently)"))( \
            (double, \
             clipper_scale, \
             ClipperScale, \
             1e7, \
