...
def tsp_solver_tunnels(tunnels, allowFlipping=False, routeStartPoint=None, routeEndPoint=None):
    ...
    specifiy where ROUGHLY the route should start and end
        ...
        tunnels.append(
            {
                ...
                "endX": wire.OrderedEdges[-1].lastVertex().X,   # point.x tunnel end
                "endY": wire.OrderedEdges[-1].lastVertex().Y,   # point.y tunnel end
