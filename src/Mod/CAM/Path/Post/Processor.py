...
class PostProcessor:
    ...
    def get_common_property_schema(cls) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "default": "",
                "help": translate("CAM",
                    "G-code commands inserted at the start of the program after the header.")
            },
            {
                "name": "postamble",
                "type": "text",
                ...
                "default": "",
                "help": translate("CAM",
                    "G-code commands inserted at the end of the program.")
            },
            {
                "name": "safetyblock",
                "type": "text",
            ...
            },
            {
                ...
                "default": "",
                "help": translate("CAM",
                    "G-code commands inserted before each operation.")
            },
            {
                "name": "post_operation",
                "type": "text",
                ...
                "default": "",
                "help": translate("CAM",
                    "G-code commands inserted after each operation.")
            },
            {
                ...
                "default": "",
                "help": translate("CAM",
                    "G-code commands inserted before tool changes.")
            },
            {
                ...
                "default": "",
                "help": translate("CAM",
                    "G-code commands inserted after tool changes.")
            }
        ]
    ...
    def _expand_split_arcs(self, postables):
        ...
        """
        if not (self._machine and hasattr(self._machine, 'processing') and self._machine.processing.split_arcs):
            return
    ...
    def _expand_translate_rapids(self, postables):
        ...
        """
        if not (self._machine and hasattr(self._machine, 'processing') and self._machine.processing.translate_rapid_moves):
            return
    ...
    def _expand_xy_before_z(self, postables):
        ...
        """
        if not (self._machine and hasattr(self._machine, 'processing') and self._machine.processing.xy_before_z_after_tool_change):
            return
    ...
    def export2(self) -> Union[None, GCodeSections]:
        ...
        if all_job_sections and self._machine and self._machine.postprocessor_properties.get('safetyblock'):
            safety_lines = [line for line in self._machine.postprocessor_properties['safetyblock'].split('\n') if line.strip()]
            if safety_lines:
                # Build with \n separators
