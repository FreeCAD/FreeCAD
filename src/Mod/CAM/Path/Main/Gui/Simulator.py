...
class PathSimulation:
    ...
    def SimulateMill(self):
        ...
        if self.isVoxel:
            ...
            self.cutMaterialIn.ViewObject.ShapeAppearance[0].DiffuseColor = (1.0, 0.85, 0.45, 0.0)
        else:
            self.cutMaterial = FreeCAD.ActiveDocument.addObject(
        ...
        self.cutMaterial.ViewObject.ShapeAppearance[0].DiffuseColor = (0.5, 0.25, 0.25, 0.0)
