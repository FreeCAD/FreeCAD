...
class CommandJobCreate:
    ...
    def Activated(self):
        ...
        if dialog.exec_() == 1:
            ...
            if models:
                self.Execute(models, dialog.getTemplate(), dialog.getMachine())
                FreeCAD.ActiveDocument.recompute()

    @classmethod
    def Execute(cls, base, template, machine=""):
        ...
        FreeCADGui.doCommand(
            "Path.Main.Gui.Job.Create(%s, %s, %s)" % ([o.Name for o in base], template, machine)
        )
