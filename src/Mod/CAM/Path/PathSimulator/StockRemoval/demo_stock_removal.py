...
import time
from StockRemoval5Axis import StockRemoval5Axis, ToolGeometry, ToolType
...
def main():
    ...
    system = StockRemoval5Axis(
        stock_bounds=(-50, 50, -50, 50, 0, 50), resolution=1.0, use_cuda=False
    )
    ...
    tool = ToolGeometry(tool_type=ToolType.ENDMILL, diameter=6.0, length=60.0, flute_length=30.0)
