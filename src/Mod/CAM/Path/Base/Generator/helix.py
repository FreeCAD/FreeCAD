...
def generate(
    ...
    if not isinstance(step_down, (float, int)):
        raise TypeError("Invalid type for step_down")

    if step_down < 0 or Path.Geom.isRoughly(step_down, 0):
        raise ValueError("step_down <= 0")
