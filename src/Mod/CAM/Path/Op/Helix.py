    ...
    def opCheckParameters(self, obj):
        if hasattr(obj, "ToolController") and obj.ToolController:
            ...
            if obj.ProfileSide == "Internal":
                ...
                # So RadialStockToLeaveInner can not be less than -95% of the tool radius
                if obj.RadialStockToLeaveInner.Value < -tooldiameter / 2:
                    obj.RadialStockToLeaveInner = -tooldiameter / 2
