...
class ObjectHelix(PathCircularHoleBase.ObjectOp):
    ...
    def opSetEditorModes(self, obj):
        ...
        SpiralMillMode = 0 if getattr(obj, "SingleHelix", None) else 2
    ...
    def opCheckParameters(self, obj):
        if hasattr(obj, "ToolController") and obj.ToolController:
            ...
            if obj.ProfileSide == "Internal":
                ...
                if obj.OffsetInner.Value < -tooldiameter / 2:
                    obj.OffsetInner = -tooldiameter / 2
    ...
    def circularHoleExecute(self, obj, holes):
        ...
        for index, hole in enumerate(holes):
            ...
            # Split depth by step down with StepMaxHeight
