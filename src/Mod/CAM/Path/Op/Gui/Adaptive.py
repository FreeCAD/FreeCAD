...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def initPage(self, obj):
        ...
        self.form.XYStockToLeave.setProperty("unit", obj.XYStockToLeave.getUserPreferred()[2])
    ...
    def getSignalsForUpdate(self, obj):
        ...
        signals.append(self.form.XYStockToLeave.valueChanged)
    ...
    def setFields(self, obj):
        ...
        if hasattr(obj, "XYStockToLeave"):
            self.form.XYStockToLeave.setProperty("rawValue", obj.XYStockToLeave.Value)
    ...
    def getFields(self, obj):
        ...
        if hasattr(obj, "XYStockToLeave"):
            PathGuiUtil.updateInputField(obj, "XYStockToLeave", self.form.XYStockToLeave)
