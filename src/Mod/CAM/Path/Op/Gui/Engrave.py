...
class TaskPanelBaseGeometryPage(PathOpGui.TaskPanelBaseGeometryPage):
    ...
    def selectionSupportedAsBaseGeometry(self, sel, ignoreErrors):
        ...
        if not sel.HasSubObjects and sel.Object.isDerivedFrom("Part::Part2DObject"):
            return True
        if sel.Object.isDerivedFrom("Part::Feature") and sel.Object.Shape.Volume == 0:
            return True
    ...
    def addBaseGeometry(self, selection):
        ...
        for sel in selection:
            ...
            if base in shapes:
                ...
                continue
            if base.isDerivedFrom("Part::Part2DObject") or (
                base.isDerivedFrom("Part::Feature") and sel.Object.Shape.Volume == 0
            ):
