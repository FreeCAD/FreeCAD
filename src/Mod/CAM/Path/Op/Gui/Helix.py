...
class TaskPanelOpPage(PathCircularHoleBaseGui.TaskPanelOpPage):
    ...
    def getToolTipList(self):
        ...
        tuples.append(("spiralMill", "SpiralMill"))
        tuples.append(("singleHelix", "SingleHelix"))
        tuples.append(("startBottom", "StartConeFromBottom"))
        tuples.append(("retractFromWall", "RetractFromWall"))
        tuples.append(("overrideArcFeed", "OverrideArcFeedRate"))
        return tuples
