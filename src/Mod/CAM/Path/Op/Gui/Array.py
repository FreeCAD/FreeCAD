...
class PathArray:
    ...
    def getPointsArray(self, pathGroup):
        ...
        # get offsets and angle from shape
        if self.pointsOrigin:
            ...
            if not originSubNames:
                ...
                if originSub.ShapeType == "Edge":
                    ...
                    originAngle = self.getFaceAngle(originSub)
    ...
    def getFaceAngle(self, face):
        centerPoint = farPoint = face.CenterOfGravity
        maxDist = 0
        ...
        return self.getPointsAngle(centerPoint, farPoint)
