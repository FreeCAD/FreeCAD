...
class ObjectArray:
    ...
    def onDocumentRestored(self, obj):
        ...
        if not hasattr(obj, "UseJitter"):
            ...
            obj.setGroupOfProperty("JitterMagnitude", "Jitter")
            obj.setGroupOfProperty("JitterPercent", "Jitter")
            obj.setGroupOfProperty("JitterSeed", "Jitter")
