...
class DocumentAsset(DetachedDocumentObject, Asset, ABC):
    ...
    def from_bytes(
        ...
        with DocFromBytes(data) as temp_doc:
            ...
            loaded_props = get_object_properties(props_obj, group=cls._property_object_group)
            ...
            if missing_props:
                ...
                for prop in missing_props:
                    ...
                    loaded_props[prop] = get_unset_value_for(prop_type)
    ...
    def to_bytes(self, serializer: Type[AssetSerializer]) -> bytes:
        ...
        if self._data is None:
            raise ValueError("Cannot serialize DocumentAsset with no data.")
        ...
        with DocFromBytes(self._data) as tmp_doc:
            ...
            update_object_properties(props, properties)
            tmp_doc.recompute()
