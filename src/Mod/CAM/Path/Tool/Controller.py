...
class ToolController:
    ...
    def templateAttrs(self, obj):
        ...
        attrs = {
            ToolControllerTemplate.Version: 1,
            ToolControllerTemplate.Name: obj.Name,
            ToolControllerTemplate.Label: obj.Label,
            ToolControllerTemplate.ToolNumber: obj.ToolNumber,
