...
void MillSim::Shape::RotateProfile(float* profPoints,
                                   int nPoints,
                                   float distance,
                                   int nSlices,
                                   bool isHalfTurn)
...
void MillSim::Shape::CalculateExtrudeBufferSizes(int nProfilePoints,
                                                 bool capStart,
                                                 bool capEnd,
                                                 int* numVerts,
                                                 int* numIndices,
...
void MillSim::Shape::ExtrudeProfileRadial(float* profPoints,
                                          int nPoints,
                                          float radius,
                                          float angleRad,
                                          float deltaHeight,
...
void MillSim::Shape::ExtrudeProfileLinear(float* profPoints,
                                          int nPoints,
                                          float fromX,
                                          float toX,
                                          float fromZ,
