...
поле оставлено пустым, FreeCAD автоматически выполнит поиск файлов справки в
...
FreeCADwiki: https://wiki.freecad.org</translation>
    </message>
    <message>
...
из вики FreeCAD, размещенной в учетной записи FreeCAD на GitHub. Это можно стилизовать с помощью пользовательской таблицы стилей ниже, что может дать лучший вид, чем вариант вики. Для достижения оптимальных результатов необходимо установить модуль Python &apos;Markdown&apos; или &apos;Pandoc&apos;.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Документация откроется в новой вкладке непосредственно в интерфейсе FreeCAD. Для этого требуется компонент PySide QtWebengineWidgets.</translation>
    </message>
    <message>
...
Это применимо только в том случае, если Markdown выбран выше.</translation>
    ...
    <message>
      ...
      <translation>Во вкладке FreeCAD</translation>
    </message>
    <message>
