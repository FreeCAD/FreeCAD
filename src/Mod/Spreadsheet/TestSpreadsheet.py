...
class SpreadsheetCases(unittest.TestCase):
    ...
    def testPrecedence(self):
        ...
        sheet = self.doc.addObject('Spreadsheet::Sheet','Spreadsheet')
        # the numbers set to the cells will get the number of decimals specified by the user in teh preferences
        ...
        self.assertEqual(sheet.getContents("A1"), "=1" + decimalsString +" < 2" + decimalsString +" ? 3" + decimalsString +" : 4" + decimalsString)
        self.assertEqual(sheet.getContents("A2"), "=1" + decimalsString +" + 2" + decimalsString +" < 3" + decimalsString +" + 4" + decimalsString +" ? 5" + decimalsString +" + 6" + decimalsString +" : 7" + decimalsString +" + 8" + decimalsString)
        self.assertEqual(sheet.getContents("A3"), "=1" + decimalsString +" + 2" + decimalsString +" * 1" + decimalsString +" < 3" + decimalsString +" + 4" + decimalsString +" ? 5" + decimalsString +" * 2" + decimalsString +" + 6" + decimalsString +" * 3" + decimalsString +" + 2" + decimalsString +" ^ 4" + decimalsString +" : 7" + decimalsString +" * 2" + decimalsString +" + 8" + decimalsString +" * 3" + decimalsString +" + 2" + decimalsString +" ^ 3" + decimalsString)
        ...
        self.assertEqual(sheet.getContents('A2'), '=1' + decimalsString +' + 2' + decimalsString +' < 3' + decimalsString +' + 4' + decimalsString +' ? 5' + decimalsString +' + 6' + decimalsString +' : 7' + decimalsString +' + 8' + decimalsString)
        self.assertEqual(sheet.getContents('A3'), '=1' + decimalsString +' + 2' + decimalsString +' * 1' + decimalsString +' < 3' + decimalsString +' + 4' + decimalsString +' ? 5' + decimalsString +' * 2' + decimalsString +' + 6' + decimalsString +' * 3' + decimalsString +' + 2' + decimalsString +' ^ 4' + decimalsString +' : 7' + decimalsString +' * 2' + decimalsString +' + 8' + decimalsString +' * 3' + decimalsString +' + 2' + decimalsString +' ^ 3' + decimalsString)
        self.assertEqual(sheet.getContents('A4'), '123' + decimalsString)
        self.assertEqual(sheet.getContents('A5'), '=123' + decimalsString +' + 321' + decimalsString)
        self.assertEqual(sheet.getContents('A6'), '=123' + decimalsString +' * 2' + decimalsString +' + 321' + decimalsString)
        self.assertEqual(sheet.getContents('A7'), '=123' + decimalsString +' * 2' + decimalsString +' + 333' + decimalsString +' / 3' + decimalsString)
        self.assertEqual(sheet.getContents('A8'), '=123' + decimalsString +' * (2' + decimalsString +' + 321' + decimalsString +')')
        self.assertEqual(sheet.getContents('A9'), '=3' + decimalsString +' ^ 4' + decimalsString)
        self.assertEqual(sheet.getContents('A10'), '=3' + decimalsString +' ^ 4' + decimalsString +' * 2' + decimalsString)
        self.assertEqual(sheet.getContents('A11'), '=3' + decimalsString +' ^ (4' + decimalsString +' * 2' + decimalsString +')')
        self.assertEqual(sheet.getContents('A12'), '=3' + decimalsString +' ^ 4' + decimalsString +' + 4' + decimalsString)
        self.assertEqual(sheet.getContents('A13'), '=1' + decimalsString +' + 4' + decimalsString +' / 2' + decimalsString +' + 5' + decimalsString)
        self.assertEqual(sheet.getContents('A14'), '=(3' + decimalsString +' + 6' + decimalsString +') / (1' + decimalsString +' + 2' + decimalsString +')')
        self.assertEqual(sheet.getContents('A15'), '=1' + decimalsString +' * 2' + decimalsString +' / 3' + decimalsString +' * 4' + decimalsString)
        self.assertEqual(sheet.getContents('A16'), '=1' + decimalsString +' * 2' + decimalsString +' / (3' + decimalsString +' * 4' + decimalsString +')')
        self.assertEqual(sheet.getContents('A17'), '=3' + decimalsString +' ^ 4' + decimalsString +' ^ 2' + decimalsString)
        self.assertEqual(sheet.getContents('A18'), '=3' + decimalsString +' ^ (4' + decimalsString +' ^ 2' + decimalsString +')')
        self.assertEqual(sheet.getContents('A19'), '=3' + decimalsString +' ^ 4' + decimalsString +' ^ 2' + decimalsString)
        self.assertEqual(sheet.getContents('A20'), '=3' + decimalsString +' + 4' + decimalsString +' + 2' + decimalsString)
        self.assertEqual(sheet.getContents('A21'), '=3' + decimalsString +' + 4' + decimalsString +' + 2' + decimalsString)
        self.assertEqual(sheet.getContents('A22'), '=3' + decimalsString +' + 4' + decimalsString +' + 2' + decimalsString)
        self.assertEqual(sheet.getContents('A23'), '=3' + decimalsString +' - 4' + decimalsString +' - 2' + decimalsString)
        self.assertEqual(sheet.getContents('A24'), '=3' + decimalsString +' - (4' + decimalsString +' - 2' + decimalsString +')')
        self.assertEqual(sheet.getContents('A25'), '=3' + decimalsString +' - 4' + decimalsString +' - 2' + decimalsString)
        self.assertEqual(sheet.getContents('A26'), '=3' + decimalsString +' * 4' + decimalsString +' * 2' + decimalsString)
        self.assertEqual(sheet.getContents('A27'), '=3' + decimalsString +' * 4' + decimalsString +' * 2' + decimalsString)
        self.assertEqual(sheet.getContents('A28'), '=3' + decimalsString +' * 4' + decimalsString +' * 2' + decimalsString)
        self.assertEqual(sheet.getContents('A29'), '=3' + decimalsString +' / 4' + decimalsString +' / 2' + decimalsString)
        self.assertEqual(sheet.getContents('A30'), '=3' + decimalsString +' / (4' + decimalsString +' / 2' + decimalsString +')')
        self.assertEqual(sheet.getContents('A31'), '=3' + decimalsString +' / 4' + decimalsString +' / 2' + decimalsString)
        self.assertEqual(sheet.getContents('A32'), '=pi * 3' + decimalsString)
        self.assertEqual(sheet.getContents('A33'), '=A32 / 3' + decimalsString)
        self.assertEqual(sheet.getContents('A34'), '=1' + decimalsString +' < 2' + decimalsString +' ? <<A>> : <<B>>')
        self.assertEqual(sheet.getContents('A35'), '=min(A32:A33)')
        self.assertEqual(sheet.getContents('A36'), '=(1' + decimalsString +' < 2' + decimalsString +' ? 0' + decimalsString +' : 1' + decimalsString +') * 3' + decimalsString +'')
        self.assertEqual(sheet.getContents('A37'), '=8' + decimalsString +' / (2' + decimalsString +' ^ 2' + decimalsString +' * 2' + decimalsString +')')
        self.assertEqual(sheet.getContents('A38'), '=2' + decimalsString +' ^ 2' + decimalsString +' * 2' + decimalsString +' / 8' + decimalsString)
        self.assertEqual(sheet.getContents('A39'), '=2' + decimalsString +' ^ (2' + decimalsString +' * 2' + decimalsString +') / 8' + decimalsString)
        self.assertEqual(sheet.getContents('A40'), '=8' + decimalsString +' / 2' + decimalsString +' ^ (2' + decimalsString +' * 2' + decimalsString +')')
        self.assertEqual(sheet.getContents('A41'), '=-1' + decimalsString)
        self.assertEqual(sheet.getContents('A42'), '=-1' + decimalsString)
        self.assertEqual(sheet.getContents('A43'), '=-(1' + decimalsString +' + 1' + decimalsString +')')
        self.assertEqual(sheet.getContents('A44'), '=-(1' + decimalsString +' - 1' + decimalsString +')')
        self.assertEqual(sheet.getContents('A45'), '=-(-1' + decimalsString +' + 1' + decimalsString +')')
        self.assertEqual(sheet.getContents('A46'), '=-(-1' + decimalsString +' + -1' + decimalsString +')')
        self.assertEqual(sheet.getContents('A47'), '=+1' + decimalsString)
        self.assertEqual(sheet.getContents('A48'), '=+1' + decimalsString)
        self.assertEqual(sheet.getContents('A49'), '=+(1' + decimalsString +' + 1' + decimalsString +')')
        self.assertEqual(sheet.getContents('A50'), '=+(1' + decimalsString +' - 1' + decimalsString +')')
        self.assertEqual(sheet.getContents('A51'), '=+(-1' + decimalsString +' + 1' + decimalsString +')')
        self.assertEqual(sheet.getContents('A52'), '=+(-1' + decimalsString +' + -1' + decimalsString +')')
    ...
    def testIssue3363(self):
        ...
        # the set values have as many decimals as defined by the user
        # thus get them first then append the number of zeroes to the set numbers
        decimals = FreeCAD.ParamGet("User parameter:BaseApp/Preferences/Units").GetInt("Decimals",2)
        decimalsString = '.'
        for x in range(decimals):
          decimalsString = decimalsString + '0'
        self.assertEqual(sheet.getContents('B1'), '=A1 == 1' + decimalsString +' ? 11' + decimalsString + ' : (A1 == 2' + decimalsString + ' ? 12' + decimalsString + ' : 13' + decimalsString + ')')
        self.assertEqual(sheet.getContents('C1'), '=A1 == 1' + decimalsString +' ? (A1 == 2' + decimalsString +' ? 12' + decimalsString +' : 13' + decimalsString +') : 11' + decimalsString)
