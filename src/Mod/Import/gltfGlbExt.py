...
def traverse_objects_once(objects):
    ...
    while stack:
        ...
        elif hasattr(obj, 'ShapeMaterial') and obj.ShapeMaterial and hasattr(obj.ShapeMaterial, 'Name'):
...
def process_glb_file(filename, gltf_data):
    ...
    binary_start = 20 + original_json_length  # 12 (GLB header) + 8 (JSON chunk header) + JSON length
