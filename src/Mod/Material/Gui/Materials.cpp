...
/* TRANSLATOR MatGui::Material */

Material::Material(QWidget* parent)
  : QDialog(parent), ui(new Ui_Materials)
{
    ui->setupUi(this);
    // connect(ui->swapButton, &QPushButton::clicked,
    //         this, &Material::onSwapButtonClicked);
    // connect(ui->firstShape, &QTreeWidget::currentItemChanged,
    //         this, &Material::currentItemChanged);
    ...
    //     (&Material::slotCreatedObject, this, bp::_1));
    // this->connectModObject = App::GetApplication().signalChangedObject.connect(boost::bind
    //     (&Material::slotChangedObject, this, bp::_1, bp::_2));
    // findShapes();
}
...
// void Material::changeEvent(QEvent *e)
// {
...
// void Material::slotCreatedObject(const App::DocumentObject& obj)
// {
...
// void Material::slotChangedObject(const App::DocumentObject& obj,
...
// bool Material::hasSolids(const App::DocumentObject* obj) const
// {
...
// bool Material::indexOfCurrentItem(QTreeWidgetItem* item, int& top_ind, int& child_ind) const
// {
...
// void Material::currentItemChanged(QTreeWidgetItem* current, QTreeWidgetItem * previous)
// {
//     Q_UNUSED(current);
//     Q_UNUSED(previous);
...
// void Material::onSwapButtonClicked()
// {
...
// void TaskMaterial::clicked(int id)
// {
