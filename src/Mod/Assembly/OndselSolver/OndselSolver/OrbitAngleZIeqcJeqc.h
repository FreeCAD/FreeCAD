...
{
    // pthezpXJ pthezpEJ ppthezpXIpXJ ppthezpXIpEJ ppthezpEIpXJ ppthezpEIpEJ ppthezpXJpXJ
    // ppthezpXJpEJ ppthezpEJpEJ
public:
    OrbitAngleZIeqcJeqc();
    ...
    FMatDsptr ppthezpXIpXJ, ppthezpXIpEJ, ppthezpEIpXJ, ppthezpEIpEJ, ppthezpXJpXJ, ppthezpXJpEJ,
        ppthezpEJpEJ;
};
}  // namespace MbD
