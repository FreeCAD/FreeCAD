...
Constraint::Constraint(const std::string& str)
    : Item(str)
{}
...
{
    //"Preserve lam calculated from AccIC for possible use by DynIntegrator if system is not
    //kinematic."
    auto lamOld = lam;
    this->prePosIC();
    lam = lamOld;
...
void Constraint::fillEssenConstraints(
...
void Constraint::fillDispConstraints(
    std::shared_ptr<Constraint> sptr,
...
void Constraint::fillPerpenConstraints(
    std::shared_ptr<Constraint> sptr,
...
void Constraint::fillRedundantConstraints(
    std::shared_ptr<Constraint> sptr,
...
void Constraint::fillConstraints(
    std::shared_ptr<Constraint> sptr,
