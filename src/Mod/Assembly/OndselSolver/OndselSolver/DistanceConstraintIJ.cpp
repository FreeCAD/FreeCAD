...
MbD::DistanceConstraintIJ::DistanceConstraintIJ(EndFrmsptr frmi, EndFrmsptr frmj)
    : ConstraintIJ(frmi, frmj)
{}

std::shared_ptr<DistanceConstraintIJ> MbD::DistanceConstraintIJ::With(EndFrmsptr frmi,
                                                                      EndFrmsptr frmj)
{
