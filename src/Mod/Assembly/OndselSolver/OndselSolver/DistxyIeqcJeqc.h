...
{
    // pdistxypXJ pdistxypEJ ppdistxypXIpXJ ppdistxypXIpEJ ppdistxypEIpXJ ppdistxypEIpEJ
    // ppdistxypXJpXJ ppdistxypXJpEJ ppdistxypEJpEJ
public:
    DistxyIeqcJeqc();
    ...
    FMatDsptr ppdistxypXIpXJ, ppdistxypXIpEJ, ppdistxypEIpXJ, ppdistxypEIpEJ, ppdistxypXJpXJ,
        ppdistxypXJpEJ, ppdistxypEJpEJ;
};
}  // namespace MbD
