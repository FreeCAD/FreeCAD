...
inline void EulerAnglesDDot<T>::calc()
{
    ...
    aAddot = term->plusFullMatrix(term1)
                 ->plusFullMatrix(term2)
                 ->plusFullMatrix(term3)
                 ->plusFullMatrix(term4)
                 ->plusFullMatrix(term5)
                 ->plusFullMatrix(term6)
                 ->plusFullMatrix(term7)
                 ->plusFullMatrix(term8);
}
template<typename T>
