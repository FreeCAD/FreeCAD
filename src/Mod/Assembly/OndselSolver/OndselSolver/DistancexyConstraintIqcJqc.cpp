...
MbD::DistancexyConstraintIqcJqc::DistancexyConstraintIqcJqc(EndFrmsptr frmi, EndFrmsptr frmj)
    : DistancexyConstraintIqcJc(frmi, frmj)
{}
...
void MbD::DistancexyConstraintIqcJqc::calc_pGpXJ()
{
    pGpXJ = (xIeJeIe->pvaluepXJ()
                 ->times(xIeJeIe->value())
                 ->plusFullRow(yIeJeIe->pvaluepXJ()->times(yIeJeIe->value())));
    pGpXJ->magnifySelf(2.0);
}

void MbD::DistancexyConstraintIqcJqc::calc_pGpEJ()
{
    pGpEJ = (xIeJeIe->pvaluepEJ()
                 ->times(xIeJeIe->value())
                 ->plusFullRow(yIeJeIe->pvaluepEJ()->times(yIeJeIe->value())));
...
void MbD::DistancexyConstraintIqcJqc::calc_ppGpXIpXJ()
{
    ...
    ppGpXIpXJ = ppGpXIpXJ->plusFullMatrix(
...
void MbD::DistancexyConstraintIqcJqc::calc_ppGpEIpXJ()
{
    ...
    ppGpEIpXJ = ppGpEIpXJ->plusFullMatrix(
...
void MbD::DistancexyConstraintIqcJqc::calc_ppGpXJpXJ()
{
    ...
    ppGpXJpXJ = ppGpXJpXJ->plusFullMatrix(
...
void MbD::DistancexyConstraintIqcJqc::calc_ppGpXIpEJ()
{
    ...
    ppGpXIpEJ = ppGpXIpEJ->plusFullMatrix(
...
void MbD::DistancexyConstraintIqcJqc::calc_ppGpEIpEJ()
{
    ...
    ppGpEIpEJ = ppGpEIpEJ->plusFullMatrix(
...
void MbD::DistancexyConstraintIqcJqc::calc_ppGpXJpEJ()
{
    ...
    ppGpXJpEJ = ppGpXJpEJ->plusFullMatrix(
...
void MbD::DistancexyConstraintIqcJqc::calc_ppGpEJpEJ()
{
    ...
    ppGpEJpEJ = ppGpEJpEJ->plusFullMatrix(
