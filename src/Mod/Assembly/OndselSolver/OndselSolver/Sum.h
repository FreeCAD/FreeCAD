...
public:
    ...
    {}
    Sum(Symsptr term, Symsptr term1)
        : FunctionWithManyArgs(term, term1)
    {}
    Sum(Symsptr term, Symsptr term1, Symsptr term2)
        : FunctionWithManyArgs(term, term1, term2)
    {}
    Sum(std::shared_ptr<std::vector<Symsptr>> _terms)
        : FunctionWithManyArgs(_terms)
    {}
