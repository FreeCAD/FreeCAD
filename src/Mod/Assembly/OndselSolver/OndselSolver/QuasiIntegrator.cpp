    ...
    try {
        try {
            try {
                ...
                ss << "MbD: Check to see if a massless or a very low mass part is under "
                      "constrained."
                   << std::endl;
                ...
                ss << "MbD: Check to see if a curve-curve is about to have multiple contact points."
                   << std::endl;
                auto str = ss.str();
                this->logString(str);
            ...
            std::stringstream ss;
            ss << "MbD: Step size is prevented from going below the user specified minimum."
               << std::endl;
            ss << "MbD: Check to see if the system is in a locked position." << std::endl;
            ss << "MbD: Check to see if a curve-curve is about to have multiple contact points."
               << std::endl;
...
void QuasiIntegrator::throwDiscontinuityError(
