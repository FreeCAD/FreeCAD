...
{
    // system xold x dx dxNorm dxNorms dxTol y yNorm yNormOld yNorms yNormTol pypx iterNo iterMax
    // nDivergence nBackTracking twoAlp lam
public:
    ...
    double dxNorm = 0.0, yNorm = 0.0, yNormOld = 0.0, yNormTol = 0.0, dxTol = 0.0, twoAlp = 0.0,
           lam = 0.0;
