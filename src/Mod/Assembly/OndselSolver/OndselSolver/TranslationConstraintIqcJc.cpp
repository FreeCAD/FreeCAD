...
TranslationConstraintIqcJc::TranslationConstraintIqcJc(EndFrmsptr frmi,
                                                       EndFrmsptr frmj,
                                                       size_t axisi)
...
void TranslationConstraintIqcJc::calcPostDynCorrectorIteration()
{
    ...
    ppGpEIpEI = riIeqJeIeq->ppvaluepEIpEI()
                    ...
                    ->plusFullMatrix((riIeqJeIeq->ppvaluepEIpEK()->transpose()->plusFullMatrix(
                        riIeqJeIeq->ppvaluepEKpEK())));
}
