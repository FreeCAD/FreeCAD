...
MbD::DistxyIeqcJeqc::DistxyIeqcJeqc(EndFrmsptr frmi, EndFrmsptr frmj)
    : DistxyIeqcJec(frmi, frmj)
{}
...
void MbD::DistxyIeqcJeqc::calc_ppdistxypEJpEJ()
{
    ...
    for (size_t i = 0; i < 4; i++) {
        ...
        for (size_t j = i; j < 4; j++) {
            ...
            if (i < j) {
                ppdistxypEJpEJ->atijput(j, i, ppdistxypEJpEJij);
            }
        }
    }
}
...
void MbD::DistxyIeqcJeqc::calc_ppdistxypXJpXJ()
{
    ...
    for (size_t i = 0; i < 3; i++) {
        ...
        for (size_t j = i; j < 3; j++) {
            ...
            if (i < j) {
                ppdistxypXJpXJ->atijput(j, i, ppdistxypXJpXJij);
            }
        }
    }
}
