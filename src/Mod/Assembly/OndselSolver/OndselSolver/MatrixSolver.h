...
{
    // m n matrixA answerX rightHandSideB rowOrder colOrder rowScalings pivotValues
    // singularPivotTolerance millisecondsToRun
public:
    MatrixSolver()
    {}
    ...
    virtual FColDsptr
    solvewithsaveOriginal(FMatDsptr fullMat, FColDsptr fullCol, bool saveOriginal);
    virtual FColDsptr
    ...
    virtual FColDsptr
    basicSolvewithsaveOriginal(FMatDsptr fullMat, FColDsptr fullCol, bool saveOriginal) = 0;
    virtual FColDsptr
    basicSolvewithsaveOriginal(SpMatDsptr spMat, FColDsptr fullCol, bool saveOriginal) = 0;

    virtual void
    preSolvewithsaveOriginal(FMatDsptr fullMat, FColDsptr fullCol, bool saveOriginal) = 0;
    virtual void
    preSolvewithsaveOriginal(SpMatDsptr spMat, FColDsptr fullCol, bool saveOriginal) = 0;
