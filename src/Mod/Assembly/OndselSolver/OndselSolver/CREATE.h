...
// This header file causes weird problems in Visual Studio when included in subclasses of
// std::vector or std::map. Why?
...
public:
    ...
    With(std::shared_ptr<EndFramec> frmi, std::shared_ptr<EndFramec> frmj, size_t axis)
    {
        auto inst = std::make_shared<T>(frmi, frmj, axis);
        inst->initialize();
        return inst;
    }
    static std::shared_ptr<T> With(std::shared_ptr<EndFramec> frmi,
                                   std::shared_ptr<EndFramec> frmj,
                                   std::shared_ptr<EndFramec> frmk,
                                   size_t axisk)
    {
    ...
    static std::shared_ptr<Constraint>
    ConstraintWith(std::shared_ptr<EndFramec> frmi, std::shared_ptr<EndFramec> frmj, size_t axis)
    {
    ...
    static std::shared_ptr<Constraint> ConstraintWith(std::shared_ptr<EndFramec> frmi,
                                                      std::shared_ptr<EndFramec> frmj,
                                                      size_t axisi,
                                                      size_t axisj)
    {
