...
{
    // system parts jointsMotions forcesTorques sensors variables icTypeSolver
    // setsOfRedundantConstraints errorTolPosKine errorTolAccKine iterMaxPosKine iterMaxAccKine
    // basicIntegrator tstartPasts tstart hmin hmax tend toutFirst hout direction corAbsTol
    // corRelTol intAbsTol intRelTol iterMaxDyn orderMax translationLimit rotationLimit
public:
    ...
    void
    partsJointsMotionsLimitsForcesTorquesDo(const std::function<void(std::shared_ptr<Item>)>& f);
