...
{
    // ToDo: Needed members admSystem namedItems mbdTime parts jointsMotions forcesTorques sensors
    // variables hasChanged mbdSystemSolver
public:
    System();
    ...
    void runDragStep(std::shared_ptr<System> self,
