...
MbD::DistancexyConstraintIqcJc::DistancexyConstraintIqcJc(EndFrmsptr frmi, EndFrmsptr frmj)
    : DistancexyConstraintIJ(frmi, frmj)
{}
...
{
    pGpEI = (xIeJeIe->pvaluepEI()
                 ->times(xIeJeIe->value())
                 ->plusFullRow(yIeJeIe->pvaluepEI()->times(yIeJeIe->value())));
...
void MbD::DistancexyConstraintIqcJc::calc_pGpXI()
{
    pGpXI = (xIeJeIe->pvaluepXI()
                 ->times(xIeJeIe->value())
                 ->plusFullRow(yIeJeIe->pvaluepXI()->times(yIeJeIe->value())));
...
void MbD::DistancexyConstraintIqcJc::calc_ppGpEIpEI()
{
    ...
    ppGpEIpEI = ppGpEIpEI->plusFullMatrix(
...
void MbD::DistancexyConstraintIqcJc::calc_ppGpXIpEI()
{
    ...
    ppGpXIpEI = ppGpXIpEI->plusFullMatrix(
...
void MbD::DistancexyConstraintIqcJc::calc_ppGpXIpXI()
{
    ...
    ppGpXIpXI = ppGpXIpXI->plusFullMatrix(
