...
MbD::DistxyIeqcJec::DistxyIeqcJec(EndFrmsptr frmi, EndFrmsptr frmj)
    : DistxyIecJec(frmi, frmj)
{}
...
void MbD::DistxyIeqcJec::calc_ppdistxypEIpEI()
{
    ...
    for (size_t i = 0; i < 4; i++) {
        ...
        for (size_t j = i; j < 4; j++) {
            ...
            if (i < j) {
                ppdistxypEIpEI->atijput(j, i, ppdistxypEIpEIij);
            }
        }
    }
}
...
void MbD::DistxyIeqcJec::calc_ppdistxypXIpXI()
{
    ...
    for (size_t i = 0; i < 3; i++) {
        ...
        for (size_t j = i; j < 3; j++) {
            ...
            if (i < j) {
                ppdistxypXIpXI->atijput(j, i, ppdistxypXIpXIij);
            }
        }
    }
}
