...
ConstVelConstraintIJ::ConstVelConstraintIJ(EndFrmsptr frmi, EndFrmsptr frmj)
    : ConstraintIJ(frmi, frmj)
{}

std::shared_ptr<ConstVelConstraintIJ> MbD::ConstVelConstraintIJ::With(EndFrmsptr frmi,
                                                                      EndFrmsptr frmj)
{
