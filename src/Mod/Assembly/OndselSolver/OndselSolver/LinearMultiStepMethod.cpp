...
FColDsptr
MbD::LinearMultiStepMethod::derivativeatpresentpast(size_t n,
                                                    double t,
                                                    FColDsptr y,
...
FColDsptr MbD::LinearMultiStepMethod::derivativepresentpast(size_t,
                                                            FColDsptr,
...
FColDsptr MbD::LinearMultiStepMethod::derivativepresentpastpresentDerivativepastDerivative(
    size_t,
    FColDsptr,
    std::shared_ptr<std::vector<FColDsptr>>,
    FColDsptr,
