...
MbD::ScrewConstraintIqcJqc::ScrewConstraintIqcJqc(EndFrmsptr frmi, EndFrmsptr frmj)
    : ScrewConstraintIqcJc(frmi, frmj)
{
...
{
    pGpEJ =
        zIeJeIe->pvaluepEJ()->times(2.0 * M_PI)->minusFullRow(thezIeJe->pvaluepEJ()->times(pitch));
}
...
{
    ppGpEIpEJ = zIeJeIe->ppvaluepEIpEJ()
                    ->times(2.0 * M_PI)
...
{
    ppGpEJpEJ = zIeJeIe->ppvaluepEJpEJ()
                    ->times(2.0 * M_PI)
