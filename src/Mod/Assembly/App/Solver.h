...
public:
    ...
    void setMarkerI(MarkerRef marker);
    void setMarkerJ(MarkerRef marker);
    MarkerRef getMarkerI() const;
    MarkerRef getMarkerJ() const;
...
public:
    ...
    void setPitchRadius(double pitchRadius);
    double getPitchRadius() const;
...
public:
    ...
    void setRadiusI(double radius);
    void setRadiusJ(double radius);
    double getRadiusI() const;
    double getRadiusJ() const;
...
public:
    ...
    void setLimitExpression(std::string expr);
    ...
    void setToleranceExpression(std::string tol);
    std::string getToleranceExpression() const;

    void setType(LimitType type);
...
public:
    ...
    void setRotationFormula(std::string formula);
    std::string getRotationFormula() const;
...
public:
    ...
    void setTranslationFormula(std::string formula);
    std::string getTranslationFormula() const;
...
public:
    ...
    void setLinearFormula(std::string formula);
    std::string getLinearFormula() const;

    void setAngularFormula(std::string formula);
    std::string getAngularFormula() const;
...
public:
    ...
    void setTimeStepOutput(double timeStepOutput);
    double getTimeStepOutput() const;
...
public:
    ...
    void setMomentOfInertias(double ixx, double iyy, double izz);
    void getMomentOfInertias(double& ixx, double& iyy, double& izz) const;
