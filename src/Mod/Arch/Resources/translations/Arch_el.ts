...
Leave blank to use all objects from the document</translation>
    ...
    <message>
      ...
      <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Ένα προαιρετικό ερωτηματικό (;) διαχωρισμένη λίστα ιδιοτήτων:φίλτρα αξίας. Προεπιλογή ! σε ένα όνομα ιδιότητας για την αντιστροφή του αποτελέσματος του φίλτρου (εξαίρεση αντικειμένων που ταιριάζουν με το φίλτρο). Αντικείμενα των οποίων η ιδιότητα περιέχει την τιμή θα ταιριάζουν. Παραδείγματα έγκυρων φίλτρων (όλα είναι ευαίσθητα):&lt;/p&gt;&lt;p&gt;&lt;span style=" font-weight:600;"&gt;Όνομα:Τοίχος&lt;/span&gt; - Θα εξετάσει μόνο αντικείμενα με &amp;quot;τοίχο&amp;quot; στο όνομά τους (εσωτερικό όνομα)&lt;/p&gt;&lt;p&gt;&lt;span style=" font-weight:600;"&gt;! ame:Wall&lt;/span&gt; - Θα εξετάσει μόνο τα αντικείμενα που DON'T έχουν &amp;quot;τοίχο&amp;quot; στο όνομά τους (εσωτερικό όνομα)&lt;/p&gt;&lt;p&gt;&lt;span style=" font-weight:600;"&gt;Περιγραφή:Κερδίστε&lt;/span&gt; - Θα εξετάσει μόνο τα αντικείμενα με &amp;quot;νίκη&amp;quot; στην περιγραφή τους&lt;/p&gt;&lt;p&gt;&lt;span style=" font-weight:600;"&gt;! abel:Win&lt;/span&gt; - Θα εξετάσει μόνο τα αντικείμενα που ΔΕΝ έχουν &amp;quot;κερδίσει&amp;quot; στην ετικέτα τους&lt;/p&gt;&lt;p&gt;&lt;span style=" font-weight:600;"&gt;IfcType:Wall&lt;/span&gt; - Θα εξετάσει μόνο τα αντικείμενα που τύπου Ifc είναι &amp;quot;Wall&amp;quot;&lt;/p&gt;&lt;p&gt;&lt;span style=" font-weight:600;"&gt;! ag:Wall&lt;/span&gt; - Θα εξετάσει μόνο τα αντικείμενα που ετικέτα δεν είναι &amp;quot;Τοίχος&amp;quot;&lt;/p&gt;&lt;p&gt;Αν αφήσετε αυτό το πεδίο κενό, δεν εφαρμόζεται φιλτράρισμα&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
...
Building creation aborted.</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Δημιουργήστε πολλά αντικείμενα Δομή Αψίδας από μια επιλεγμένη βάση, χρησιμοποιώντας κάθε επιλεγμένη άκρη ως διαδρομή εξώθησης</translation>
    </message>
  </context>
  <context>
