...
You can change that in the preferences.</source>
      <translation>次のオブジェクト以外であれば、あなたは何でも配置できます: サイト、ビルディング、フロア。
フロア・オブジェクトには、サイト、ビルディングあるいはフロア・オブジェクトを配置することができません。
よって、サイト、ビルディング、フロアを選択範囲から除外してください。
これはプレファレンス設定より変更できます。</translation>
    </message>
    <message>
...
You can change that in the preferences.</source>
      <translation>ビルディングオブジェクト内には、サイトオブジェクトとビルディングオブジェクト以外であれば配置できます。
ビルディングオブジェクトでは、サイトオブジェクトとビルディングオブジェクトを受け入れることができません。
...
この動作はユーザー設定から変更できます。</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>通常のワークプレーンを持つ線でオブジェクトを切断</translation>
    </message>
  </context>
  <context>
