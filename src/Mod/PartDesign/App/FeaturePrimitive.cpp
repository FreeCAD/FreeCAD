...
const App::PropertyQuantityConstraint::Constraints quantityRange = {2 * Precision::Confusion(),
                                                                    FLT_MAX,
                                                                    0.1};
...
Cylinder::Cylinder()
{
    ...
    ADD_PROPERTY_TYPE(Angle,
                      ...
                      "Cylinder",
                      App::Prop_None,
                      "The closing angle of the cylinder ");
...
App::DocumentObjectExecReturn* Cone::execute()
{
    ...
    try {
        if (std::abs(Radius1.getValue() - Radius2.getValue()) < Precision::Confusion()) {
            // Build a cylinder
            BRepPrimAPI_MakeCylinder mkCylr(Radius1.getValue(), Height.getValue(), 2.0 * M_PI);
...
Prism::Prism()
{
    ADD_PROPERTY_TYPE(Polygon,
                      (6.0),
                      "Prism",
                      App::Prop_None,
                      "Number of sides in the polygon, of the prism");
    ADD_PROPERTY_TYPE(Circumradius,
                      (2.0),
                      "Prism",
                      App::Prop_None,
