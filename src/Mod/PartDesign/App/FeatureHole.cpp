...
const Hole::ThreadDescription Hole::threadDescription[][171] =
{
    ...
    // Asme B1.20.1
    // {name, thread diameter, thread pitch, minor-diameter}
    {
        { "1/16",   7.938,      0.941,  6.919   },
        { "1/8",    10.287,     0.941,  9.268   },
        { "1/4",    13.716,     1.411,  12.189  },
        { "3/8",    17.145,     1.411,  15.618  },
        { "1/2",    21.336,     1.814,  19.372  },
        { "3/4",    26.670,     1.814,  24.706  },
        { "1",      33.401,     2.209,  31.010  },
        { "1 1/4",  42.164,     2.209,  39.773  },
        { "1 1/2",  48.260,     2.209,  45.869  },
        { "2",      60.325,     2.209,  57.934  },
        { "2 1/2",  73.025,     3.175,  69.588  },
        { "3",      88.900,     3.175,  85.463  },
        { "3 1/2",  101.600,    3.175,  98.163  },
        { "4",      114.300,    3.175,  110.863 },
        { "5",      141.300,    3.175,  137.863 },
        { "6",      168.275,    3.175,  164.838 },
        { "8",      219.075,    3.175,  215.638 },
        { "10",     273.050,    3.175,  263.613 },
        { "12",     323.850,    3.175,  320.413 },
    },
    /* BSP */
    // Parallel - ISO 228-1
    // Tapered  - ISO 7-1
    // {name, major-diameter, thread-pitch, minor-diameter}
    {
        { "1/16",   7.723,      0.907,   6.561   },
        { "1/8",    9.728,      0.907,   8.566   },
        { "1/4",    13.157,     1.337,   11.445  },
        { "3/8",    16.662,     1.337,   14.950  },
        { "1/2",    20.955,     1.814,   18.631  },
        { "5/8",    22.911,     1.814,   20.587  },
        { "3/4",    26.441,     1.814,   24.117  },
        { "7/8",    30.201,     1.814,   27.877  },
        { "1",      33.249,     2.309,   30.291  },
        { "1 1/8",  37.897,     2.309,   34.939  },
        { "1 1/4",  41.910,     2.309,   38.952  },
        { "1 1/2",  47.803,     2.309,   44.845  },
        { "1 3/4",  53.743,     2.309,   50.788  },
        { "2",      59.614,     2.309,   56.656  },
        { "2 1/4",  65.710,     2.309,   62.752  },
        { "2 1/2",  75.184,     2.309,   72.226  },
        { "2 3/4",  81.534,     2.309,   78.576  },
        { "3",      87.884,     2.309,   84.926  },
        { "3 1/2",  100.330,    2.309,   97.372  },
        { "4",      113.030,    2.309,   110.072 },
        { "4 1/2",  125.730,    2.309,   122.772 },
        { "5",      138.430,    2.309,   135.472 },
        { "5 1/2",  151.130,    2.309,   148.172 },
        { "6",      163.830,    2.309,   160.872 },
    }
};
...
std::optional<double> Hole::determineDiameter() const
{
    ...
    if (Threaded.getValue()) {
        ...
        std::string threadTypeStr = ThreadType.getValueAsString();
        if (
            threadTypeStr == "ISOMetricProfile"
            || threadTypeStr == "UNC"
            || threadTypeStr == "UNF"
            || threadTypeStr == "UNEF"
            || threadTypeStr == "NPT"
