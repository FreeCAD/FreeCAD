...
public:
    ...
    double getFitDiameter(int fit, double diameter) const;
    double getFitDiameterISO(int fit, double diameter) const;
    double getFitDiameterUN(int fit, double diameter, std::string threadSize) const;
