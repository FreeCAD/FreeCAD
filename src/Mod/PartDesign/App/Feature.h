...
public:
    ...
    Part::TopoShape getTopoShapeInLocalCoordinates(
        const App::DocumentObject* object,
        Part::ShapeOptions options = Part::ShapeOption::ResolveLink,
        const char* subname = nullptr
    ) const;

    /// Returns an object's placement in this feature's Body coordinate system.
    Base::Placement getObjectPlacementInLocalCoordinates(const App::DocumentObject* object) const;
...
protected:
    ...
    gp_Pln makePlnFromPlaneInLocalCoordinates(const App::DocumentObject* obj) const;
    ...
    TopoShape makeTopoShapeFromPlaneInLocalCoordinates(const App::DocumentObject* obj) const;
};
