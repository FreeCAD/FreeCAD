...
class MySpring:
   def __init__(self, obj):
      ...
      obj.addLockedProperty("App::PropertyLength", "Pitch", "MySpring", "Pitch of the helix").Pitch = 5.0
      obj.addLockedProperty("App::PropertyLength", "Diameter", "MySpring", "Diameter of the helix").Diameter = 6.0
      obj.addLockedProperty("App::PropertyLength", "Height", "MySpring", "Height of the helix").Height = 30.0
      obj.addLockedProperty("App::PropertyLength", "BarDiameter", "MySpring", "Diameter of the bar").BarDiameter = 3.0
      obj.Proxy = self
