...
class DistanceBolt:
    def __init__(self, obj):
        ...
        obj.addLockedProperty("App::PropertyInteger","Edges","Bolt","Number of edges of the outline").Edges=6
        obj.addLockedProperty("App::PropertyLength","Length","Bolt","Length of the edges of the outline").Length=10.0
        obj.addLockedProperty("App::PropertyLength","Radius","Bolt","Radius of the inner circle").Radius=4.0
        obj.addLockedProperty("App::PropertyLength","Height","Bolt","Height of the extrusion").Height=20.0
        obj.Proxy = self
