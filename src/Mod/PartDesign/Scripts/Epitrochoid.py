...
class Epitrochoid:
    def __init__(self, obj):
        ...
        obj.addLockedProperty("App::PropertyLength","Radius1","Epitrochoid","Interior radius").Radius1=60.0
        obj.addLockedProperty("App::PropertyLength","Radius2","Epitrochoid","Exterior radius").Radius2=20.0
        obj.addLockedProperty("App::PropertyLength","Distance","Epitrochoid","Distance").Distance=10.0
        obj.addLockedProperty("App::PropertyInteger","Segments","Epitrochoid","Number of the line segments").Segments=72
        obj.Proxy = self
