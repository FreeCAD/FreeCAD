...
public:
    explicit TaskPipeParameters(ViewProviderPipe* PipeView,
                                bool newObj = false,
...
public:
    explicit TaskPipeOrientation(ViewProviderPipe* PipeView,
                                 bool newObj = false,
                                 QWidget* parent = nullptr);
...
public:
    explicit TaskPipeScaling(ViewProviderPipe* PipeView,
                             bool newObj = false,
                             QWidget* parent = nullptr);
