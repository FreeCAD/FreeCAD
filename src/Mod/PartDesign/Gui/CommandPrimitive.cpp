...
Gui::Action * CmdPrimtiveCompAdditive::createAction()
{
    ...
    p1->setObjectName(QLatin1String("PartDesign_AdditiveBox"));
    p1->setWhatsThis(QLatin1String("PartDesign_AdditiveBox"));
    QAction* p2 = pcAction->addAction(QString());
    p2->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_AdditiveCylinder"));
    p2->setObjectName(QLatin1String("PartDesign_AdditiveCylinder"));
    p2->setWhatsThis(QLatin1String("PartDesign_AdditiveCylinder"));
    QAction* p3 = pcAction->addAction(QString());
    p3->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_AdditiveSphere"));
    p3->setObjectName(QLatin1String("PartDesign_AdditiveSphere"));
    p3->setWhatsThis(QLatin1String("PartDesign_AdditiveSphere"));
    QAction* p4 = pcAction->addAction(QString());
    p4->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_AdditiveCone"));
    p4->setObjectName(QLatin1String("PartDesign_AdditiveCone"));
    p4->setWhatsThis(QLatin1String("PartDesign_AdditiveCone"));
    QAction* p5 = pcAction->addAction(QString());
    p5->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_AdditiveEllipsoid"));
    p5->setObjectName(QLatin1String("PartDesign_AdditiveEllipsoid"));
    p5->setWhatsThis(QLatin1String("PartDesign_AdditiveEllipsoid"));
    QAction* p6 = pcAction->addAction(QString());
    p6->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_AdditiveTorus"));
    p6->setObjectName(QLatin1String("PartDesign_AdditiveTorus"));
    p6->setWhatsThis(QLatin1String("PartDesign_AdditiveTorus"));
    QAction* p7 = pcAction->addAction(QString());
    p7->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_AdditivePrism"));
    p7->setObjectName(QLatin1String("PartDesign_AdditivePrism"));
    p7->setWhatsThis(QLatin1String("PartDesign_AdditivePrism"));
    QAction* p8 = pcAction->addAction(QString());
    p8->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_AdditiveWedge"));
    p8->setObjectName(QLatin1String("PartDesign_AdditiveWedge"));
    p8->setWhatsThis(QLatin1String("PartDesign_AdditiveWedge"));
...
Gui::Action * CmdPrimtiveCompSubtractive::createAction()
{
    ...
    p1->setObjectName(QLatin1String("PartDesign_SubtractiveBox"));
    p1->setWhatsThis(QLatin1String("PartDesign_SubtractiveBox"));
    QAction* p2 = pcAction->addAction(QString());
    p2->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_SubtractiveCylinder"));
    p2->setObjectName(QLatin1String("PartDesign_SubtractiveCylinder"));
    p2->setWhatsThis(QLatin1String("PartDesign_SubtractiveCylinder"));
    QAction* p3 = pcAction->addAction(QString());
    p3->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_SubtractiveSphere"));
    p3->setObjectName(QLatin1String("PartDesign_SubtractiveSphere"));
    p3->setWhatsThis(QLatin1String("PartDesign_SubtractiveSphere"));
    QAction* p4 = pcAction->addAction(QString());
    p4->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_SubtractiveCone"));
    p4->setObjectName(QLatin1String("PartDesign_SubtractiveCone"));
    p4->setWhatsThis(QLatin1String("PartDesign_SubtractiveCone"));
    QAction* p5 = pcAction->addAction(QString());
    p5->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_SubtractiveEllipsoid"));
    p5->setObjectName(QLatin1String("PartDesign_SubtractiveEllipsoid"));
    p5->setWhatsThis(QLatin1String("PartDesign_SubtractiveEllipsoid"));
    QAction* p6 = pcAction->addAction(QString());
    p6->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_SubtractiveTorus"));
    p6->setObjectName(QLatin1String("PartDesign_SubtractiveTorus"));
    p6->setWhatsThis(QLatin1String("PartDesign_SubtractiveTorus"));
    QAction* p7 = pcAction->addAction(QString());
    p7->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_SubtractivePrism"));
    p7->setObjectName(QLatin1String("PartDesign_SubtractivePrism"));
    p7->setWhatsThis(QLatin1String("PartDesign_SubtractivePrism"));
    QAction* p8 = pcAction->addAction(QString());
    p8->setIcon(Gui::BitmapFactory().iconFromTheme("PartDesign_SubtractiveWedge"));
    p8->setObjectName(QLatin1String("PartDesign_SubtractiveWedge"));
    p8->setWhatsThis(QLatin1String("PartDesign_SubtractiveWedge"));
