...
class PartDesignGuiExport TaskDraftParameters: public TaskDressUpParameters
{
    Q_OBJECT
...
class PartDesignGuiExport TaskDlgDraftParameters: public TaskDlgDressUpParameters
{
    Q_OBJECT
