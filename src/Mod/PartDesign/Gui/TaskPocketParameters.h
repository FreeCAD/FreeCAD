...
class PartDesignGuiExport TaskPocketParameters: public TaskExtrudeParameters
{
    Q_OBJECT
...
class PartDesignGuiExport TaskDlgPocketParameters: public TaskDlgExtrudeParameters
{
    Q_OBJECT
