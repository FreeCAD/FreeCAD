...
Выбранные края могут содержать геометрические элементы, которые невозможно скруглить вместе.
Попробуйте скруглить края по отдельности или с меньшим радиусом. </translation>
    </message>
    <message>
