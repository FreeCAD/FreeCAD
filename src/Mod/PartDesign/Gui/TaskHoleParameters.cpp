    ...
    , ui(new Ui_TaskHoleParameters)
{
    ...
    ui->ThreadFit->setItemText(0, tr("Normal / Medium", "Normal distance from threads to the hole wall"));
    ui->ThreadFit->setItemText(1, tr("Close / Fine", "Short distance from threads to the hole wall"));
    ui->ThreadFit->setItemText(2, tr("Loose / Coarse", "Long distance from threads to the hole wall"));
