...
{
    // Axis length of the CS is 1/3 of maximum bbox dimension, any smarter sizing will make it only
    // worse
    double axisLength;
    ...
    axisLabelYToZTrans->translation.setValue(
        SbVec3f(-labelOffset, -labelPos + labelOffset, labelPos));
}
