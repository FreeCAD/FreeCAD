...
{
    ui->offsetEdit->setToolTip(tr("Offset from the selected face at which the pad will end on side 1"));
    ui->offsetEdit2->setToolTip(tr("Offset from the selected face at which the pad will end on side 2"));
