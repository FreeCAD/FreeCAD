...
def parameterize():
    ...
    The original method is kept as-is. Each generated wrapper gets a
    `_fineGrained` attribute (True/False) which setUp can read.
    """
...
class FineGrainedRecomputeCases(unittest.TestCase):
    ...
    def testSimple(self):
        ...
        # assert
        self.assertTrue("Touched" in cube.State)
    ...
    def testIndependent(self):
        ...
        # assert
        self.assertTrue("Touched" in cube1.State)
        self.assertFalse("Touched" in cube2.State)
    ...
    def testOutputThroughExpression(self):
        ...
        # assert
        self.assertTrue("Touched" in cube2.State)
    ...
    def testRelabel(self):
        ...
        # assert
        self.assertFalse("Touched" in varSet.State)
        self.assertFalse("Touched" in cube.State)
    ...
    def testChangeVisibility(self):
        ...
        # assert
        self.assertFalse("Touched" in cube1.State)
        self.assertFalse("Touched" in cube2.State)
    ...
    def testInputProperty(self):
        ...
        # assert
        self.assertTrue(cube.Length.Value, 20.0)
    ...
    def testInputLink(self):
        ...
        # assert
        self.assertTrue(cube.Length.Value, 15.0)
