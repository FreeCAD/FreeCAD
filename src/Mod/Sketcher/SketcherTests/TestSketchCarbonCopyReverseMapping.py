...
class TestSketchCarbonCopyReverseMapping(unittest.TestCase):
    def setUp(self):
        ...
        self.Doc = FreeCAD.openDocument(os.path.join(location, "TestSketchCarbonCopyReverseMapping.FCStd"), True)
    ...
    def test_CarbonCopyReverseMapping(self):
        ...
        expected_geometries_pattern_001 = {
            "Sketch001": {
                ...
                1: {"start": FreeCAD.Vector(10,10,0), "end": FreeCAD.Vector(10+cos30*r,10+sin30*r,0)},
                2: {"start": FreeCAD.Vector(10,10,0), "end": FreeCAD.Vector(10+sin30*r,10+cos30*r,0)},
                3: {"start": FreeCAD.Vector(10,10,0), "end": FreeCAD.Vector(10-sin30*r,10+cos30*r,0)},
                4: {"location": FreeCAD.Vector(-10,10,0)},
                5: {"location": FreeCAD.Vector(10,-10,0)},
                6: {"start": FreeCAD.Vector( 5,15,0), "end": FreeCAD.Vector( 5+sin30*r,15+cos30*r,0)},
                7: {"start": FreeCAD.Vector(15,15,0), "end": FreeCAD.Vector(15-sin30*r,15+cos30*r,0)}
            },
            "Sketch002": {
                0: {"start": FreeCAD.Vector(-10,10,0), "end": FreeCAD.Vector(-20,10,0)},
                1: {"start": FreeCAD.Vector(-10,10,0), "end": FreeCAD.Vector(-10-cos30*r,10+sin30*r,0)},
