...
void Sketch::clearTemporaryConstraints(void)
{
    ...
    GCSsys.clearByTag(GCS::MainSubsystemTemporaryConstraint);
}
...
int Sketch::initMove(int geoId, PointPos pos, bool fine)
{
    ...
    if (Geoms[geoId].type == Point) {
        ...
        if (pos == mid) {
            ...
            *p1.x = *center.x;
            *p1.y = *center.y;
            int i=GCSsys.addConstraintP2PCoincident(p1,center,-pole?GCS::MainSubsystemTemporaryConstraint:GCS::DefaultTemporaryConstraint);
