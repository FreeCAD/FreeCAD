            ...
            if (sep->getNumChildren()
                ...
                if (constrIds) {
                    ...
                    if (combinedConstrBoxes.count(constrIdsStr) && dynamic_cast<SoImage*>(tail)) {
                        ...
                        SbVec3f constrAbsPos = translation->abPos.getValue();
                        SbVec3f constrTranslation = translation->translation.getValue();
                        float constrScaleFactor = translation->getScaleFactor();
                        ...
                        if (tail
                            ...
                            constrAbsPos += translation2->abPos.getValue();
                            constrTranslation += translation2->translation.getValue();
                            constrScaleFactor = translation2->getScaleFactor();
                        }
                        // Only the translation is scaled because this is how SoZoomTranslation
                        // works
                        SbVec3f constrPos = constrAbsPos + constrScaleFactor * constrTranslation;

                        SbVec2f constrCoords = ViewProviderSketchCoinAttorney::getScreenCoordinates(
                            viewProvider,
