...
Чтобы точки привязались, они должны быть установлены ближе, чем на одну пятую расстояния между линиями сетки.</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation type="unfinished">Ограничивает вертикальное расстояние между двумя точками или от точки до начала координат, если таковая выбрана</translation>
    </message>
  </context>
  <context>
