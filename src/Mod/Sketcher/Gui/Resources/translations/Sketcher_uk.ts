...
"Обидва": Ви матимете як розмірні інструменти, так і окремі.
Цей параметр стосується лише панелі інструментів. Незалежно від того, що ви вибрали, всі інструменти завжди доступні в меню та за комбінаціє клавіш.</translation>
    </message>
    <message>
