...
#ifndef DEBUGGER_PYTHONDEBUG_H
#define DEBUGGER_PYTHONDEBUG_H
 ...
 * @author Werner Mayer
 */
class DebuggerExport PythonDebugModule : public Py::ExtensionModule<PythonDebugModule>
{
public:
...
private:
    ...
    Py::Object close(const Py::Tuple &a);
    ...
    QProcess debugServer;
};

/**
 * @author Werner Mayer
 */
class DebuggerExport PythonDebugStdout : public Py::PythonExtension<PythonDebugStdout> 
{
public:
 ...
 * @author Werner Mayer
 */
class DebuggerExport PythonDebugStderr : public Py::PythonExtension<PythonDebugStderr> 
{
public:
    static void init_type(void);    // announce properties and methods
 ...
 * @author Werner Mayer
 */
class DebuggerExport PythonDebugExcept : public Py::PythonExtension<PythonDebugExcept> 
{
public:
    static void init_type(void);    // announce properties and methods
...
class DebugClient;
class DebuggerExport PythonDebugger : public QObject
{
    Q_OBJECT

public:
    PythonDebugger(DebugClient* client);
    ~PythonDebugger();
...
private:
    ...
    void sendContext(const QString&, int line);
