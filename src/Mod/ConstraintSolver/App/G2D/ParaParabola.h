...
#ifndef FREECAD_CONSTRAINTSOLVER_G2D_PARAPARABOLA_H
#define FREECAD_CONSTRAINTSOLVER_G2D_PARAPARABOLA_H
...
class ParaParabola;
typedef Base::UnsafePyHandle<ParaParabola> HParaParabola;
typedef Base::UnsafePyHandle<ParaShape<ParaParabola>> HShape_Parabola;

class FCSExport ParaParabola : public FCS::G2D::ParaCurve
{
...
public://methods
    ParaParabola();
    ParaParabola(HParaPoint p1, HParaPoint p2);
