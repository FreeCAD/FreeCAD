...
public:
    ...
    PyObject*  getStatusString(PyObject *args) const;
    ...
    PyObject*  resolve(PyObject *args) const;
    ...
    PyObject*  resolveSubElement(PyObject *args) const;
    ...
    PyObject*  getElementMapVersion(PyObject *args) const;
    /// callback for the isAttachedToDocument() method
    static PyObject * staticCallback_isAttachedToDocument (PyObject *self, PyObject *args);
    /// implementer for the isAttachedToDocument() method
    PyObject*  isAttachedToDocument(PyObject *args) const;
    //@}
