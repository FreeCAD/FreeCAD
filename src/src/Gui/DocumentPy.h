...
public:
    ...
    /// callback for the createView() method
    static PyObject * staticCallback_createView (PyObject *self, PyObject *args);
    /// implementer for the createView() method
    PyObject*  createView(PyObject *args);
    ...
    PyObject*  mdiViewsOfType(PyObject *args) const;
