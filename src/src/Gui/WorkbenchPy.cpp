...
PyTypeObject WorkbenchPy::Type = {
    ...
    .tp_name = "Gui.Workbench",
    .tp_basicsize = sizeof(WorkbenchPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "This is the base class for workbenches",
    .tp_methods = Gui::WorkbenchPy::Methods,
    .tp_getset = Gui::WorkbenchPy::GetterSetter,
    .tp_base = &Base::BaseClassPy::Type,
    .tp_init = __PyInit,
    .tp_new = Gui::WorkbenchPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef WorkbenchPy::Methods[] = {
    ...
    {"reloadActive",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) ()>( staticCallback_reloadActive )),
...
PyObject *WorkbenchPy::PyMake(PyTypeObject* /*type*/, PyObject* /*args*/, PyObject* /*kwds*/)
{
