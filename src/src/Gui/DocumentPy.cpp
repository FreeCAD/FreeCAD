...
PyTypeObject DocumentPy::Type = {
    ...
    .tp_doc = "This is a Document class",
    .tp_methods = Gui::DocumentPy::Methods,
    .tp_getset = Gui::DocumentPy::GetterSetter,
    .tp_base = &Base::PersistencePy::Type,
    .tp_init = __PyInit,
    .tp_new = Gui::DocumentPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef DocumentPy::Methods[] = {
    ...
    {"createView",
        reinterpret_cast<PyCFunction>( staticCallback_createView ),
        METH_VARARGS,
...
// createView() callback and implementer
// PyObject*  DocumentPy::createView(PyObject *args){};
// has to be implemented in DocumentPyImp.cpp
PyObject * DocumentPy::staticCallback_createView (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'createView' of 'Gui.Document' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<DocumentPy*>(self)->createView(args);
        if (ret != nullptr)
            static_cast<DocumentPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
