...
PyTypeObject LinkViewPy::Type = {
    ...
    .tp_name = "Gui.LinkView",
    .tp_basicsize = sizeof(LinkViewPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Helper class to link to a view object",
    .tp_methods = Gui::LinkViewPy::Methods,
    .tp_getset = Gui::LinkViewPy::GetterSetter,
    .tp_base = &Base::BaseClassPy::Type,
    .tp_init = __PyInit,
    .tp_new = Gui::LinkViewPy::PyMake
};
#if defined(__GNUC__)
...
int LinkViewPy::staticCallback_setCount (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<LinkViewPy*>(self)->setCount(Py::Long(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
void  LinkViewPy::setCount(Py::Long arg)
{
    throw Py::AttributeError("Not yet implemented");
}
