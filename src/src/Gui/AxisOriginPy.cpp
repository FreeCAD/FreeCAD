...
PyTypeObject AxisOriginPy::Type = {
    ...
    .tp_name = "Gui.AxisOrigin",
    .tp_basicsize = sizeof(AxisOriginPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Gui.AxisOrigin class.\n"
    "\n"
    "Class for creating a Coin3D representation of a coordinate system.",
    .tp_methods = Gui::AxisOriginPy::Methods,
    .tp_getset = Gui::AxisOriginPy::GetterSetter,
    .tp_base = &Base::BaseClassPy::Type,
    .tp_init = __PyInit,
    .tp_new = Gui::AxisOriginPy::PyMake
};
#if defined(__GNUC__)
