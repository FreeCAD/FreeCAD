...
PyTypeObject ViewProviderPy::Type = {
    ...
    .tp_methods = Gui::ViewProviderPy::Methods,
    .tp_getset = Gui::ViewProviderPy::GetterSetter,
    .tp_base = &App::ExtensionContainerPy::Type,
    .tp_init = __PyInit,
    .tp_new = Gui::ViewProviderPy::PyMake
};
#if defined(__GNUC__)
...
PyGetSetDef ViewProviderPy::GetterSetter[] = {
    ...
    {"ToggleVisibility",
        (getter) staticCallback_getToggleVisibility,
        (setter) staticCallback_setToggleVisibility,
...
PyObject * ViewProviderPy::staticCallback_addProperty (PyObject *self, PyObject *args, PyObject * kwd)
{
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<ViewProviderPy*>(self)->addProperty(args, kwd);
        if (ret != nullptr)
...
int ViewProviderPy::staticCallback_setDefaultMode (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<ViewProviderPy*>(self)->setDefaultMode(Py::Long(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
// ToggleVisibility() callback and implementer
// PyObject*  ViewProviderPy::ToggleVisibility(PyObject *args){};
// has to be implemented in ViewProviderPyImp.cpp
PyObject * ViewProviderPy::staticCallback_getToggleVisibility (PyObject *self, void * /*closure*/)
{
    if (!static_cast<PyObjectBase*>(self)->isValid()){
        PyErr_SetString(PyExc_ReferenceError, "This object is already deleted most likely through closing a document. This reference is no longer valid!");
        return nullptr;
    ...
    try {
        return Py::new_reference_to(static_cast<ViewProviderPy*>(self)->getToggleVisibility());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return nullptr;
    } catch (...) {
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while reading attribute 'ToggleVisibility' of object 'ViewProvider'");
        return nullptr;
    }
}

int ViewProviderPy::staticCallback_setToggleVisibility (PyObject *self, PyObject *value, void * /*closure*/)
{
    if (!static_cast<PyObjectBase*>(self)->isValid()){
        PyErr_SetString(PyExc_ReferenceError, "This object is already deleted most likely through closing a document. This reference is no longer valid!");
        return -1;
    ...
    try {
        static_cast<ViewProviderPy*>(self)->setToggleVisibility(Py::Object(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while writing attribute 'ToggleVisibility' of object 'ViewProvider'");
        return -1;
    }
}
...
PyObject* ViewProviderPy::addProperty(PyObject *args, PyObject *kwds)
{
