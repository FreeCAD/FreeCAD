...
PyTypeObject BezierCurve2dPy::Type = {
    ...
    .tp_name = "Part.Geom2d.BezierCurve2d",
    .tp_basicsize = sizeof(BezierCurve2dPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Describes a rational or non-rational Bezier curve in 2d space:\n"
    ...
    .tp_methods = Part::BezierCurve2dPy::Methods,
    .tp_getset = Part::BezierCurve2dPy::GetterSetter,
    .tp_base = &Part::Curve2dPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::BezierCurve2dPy::PyMake
};
#if defined(__GNUC__)
