...
PyTypeObject Line2dPy::Type = {
    ...
    .tp_name = "Part.Geom2d.Line2d",
    .tp_basicsize = sizeof(Line2dPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Describes an infinite line in 2D space\n"
    ...
    .tp_methods = Part::Line2dPy::Methods,
    .tp_getset = Part::Line2dPy::GetterSetter,
    .tp_base = &Part::Curve2dPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::Line2dPy::PyMake
};
#if defined(__GNUC__)
