...
PyTypeObject ArcOfHyperbola2dPy::Type = {
    ...
    .tp_name = "Part.Geom2d.ArcOfHyperbola2d",
    .tp_basicsize = sizeof(ArcOfHyperbola2dPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_methods = Part::ArcOfHyperbola2dPy::Methods,
    .tp_getset = Part::ArcOfHyperbola2dPy::GetterSetter,
    .tp_base = &Part::ArcOfConic2dPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::ArcOfHyperbola2dPy::PyMake
};
#if defined(__GNUC__)
