...
PyTypeObject BSplineCurvePy::Type = {
    ...
    .tp_name = "Part.BSplineCurve",
    .tp_basicsize = sizeof(BSplineCurvePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Describes a B-Spline curve in 3D space",
    .tp_methods = Part::BSplineCurvePy::Methods,
    .tp_getset = Part::BSplineCurvePy::GetterSetter,
    .tp_base = &Part::BoundedCurvePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::BSplineCurvePy::PyMake
};
#if defined(__GNUC__)
