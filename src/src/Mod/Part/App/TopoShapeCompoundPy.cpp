...
PyTypeObject TopoShapeCompoundPy::Type = {
    ...
    .tp_basicsize = sizeof(TopoShapeCompoundPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Create a compound out of a list of shapes",
    .tp_methods = Part::TopoShapeCompoundPy::Methods,
    .tp_getset = Part::TopoShapeCompoundPy::GetterSetter,
    .tp_base = &Part::TopoShapePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::TopoShapeCompoundPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef TopoShapeCompoundPy::Methods[] = {
    ...
    {"setFaces",
        reinterpret_cast<PyCFunction>( staticCallback_setFaces ),
        METH_VARARGS,
...
// setFaces() callback and implementer
// PyObject*  TopoShapeCompoundPy::setFaces(PyObject *args){};
// has to be implemented in TopoShapeCompoundPyImp.cpp
PyObject * TopoShapeCompoundPy::staticCallback_setFaces (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'setFaces' of 'Part.TopoShape' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<TopoShapeCompoundPy*>(self)->setFaces(args);
        if (ret != nullptr)
            static_cast<TopoShapeCompoundPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
PyObject *TopoShapeCompoundPy::PyMake(PyTypeObject* /*type*/, PyObject* /*args*/, PyObject* /*kwds*/)
{
