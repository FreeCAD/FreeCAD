...
PyTypeObject PolyHLRToShapePy::Type = {
    ...
    .tp_name = "Part.PolyHLRToShapePy",
    .tp_basicsize = sizeof(PolyHLRToShapePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "PolyHLRToShape(algo: HLRBRep_PolyAlgo) -> HLRBRep_PolyHLRToShape\n"
    "\n"
    ...
    .tp_methods = Part::PolyHLRToShapePy::Methods,
    .tp_getset = Part::PolyHLRToShapePy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Part::PolyHLRToShapePy::PyMake
};
#if defined(__GNUC__)
