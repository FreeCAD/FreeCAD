...
PyTypeObject ShapeFix_WirePy::Type = {
    ...
    .tp_name = "Part.ShapeFix.Wire",
    .tp_basicsize = sizeof(ShapeFix_WirePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Class for fixing operations on wires",
    .tp_methods = Part::ShapeFix_WirePy::Methods,
    .tp_getset = Part::ShapeFix_WirePy::GetterSetter,
    .tp_base = &Part::ShapeFix_RootPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::ShapeFix_WirePy::PyMake
};
#if defined(__GNUC__)
