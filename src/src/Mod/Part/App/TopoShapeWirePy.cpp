...
PyTypeObject TopoShapeWirePy::Type = {
    ...
    .tp_name = "Part.TopoShape",
    .tp_basicsize = sizeof(TopoShapeWirePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "TopoShapeWire is the OpenCasCade topological wire wrapper",
    .tp_methods = Part::TopoShapeWirePy::Methods,
    .tp_getset = Part::TopoShapeWirePy::GetterSetter,
    .tp_base = &Part::TopoShapePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::TopoShapeWirePy::PyMake
};
#if defined(__GNUC__)
