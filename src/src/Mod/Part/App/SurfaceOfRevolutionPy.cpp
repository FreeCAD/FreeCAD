...
// This File is normally built as an include in SurfaceOfRevolutionPyImp.cpp! It's not intended to be in a project!
...
PyTypeObject SurfaceOfRevolutionPy::Type = {
    ...
    .tp_name = "Part.SurfaceOfRevolution",
    .tp_basicsize = sizeof(SurfaceOfRevolutionPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Describes a surface of revolution",
    .tp_methods = Part::SurfaceOfRevolutionPy::Methods,
    .tp_getset = Part::SurfaceOfRevolutionPy::GetterSetter,
    .tp_base = &Part::GeometrySurfacePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::SurfaceOfRevolutionPy::PyMake
};
#if defined(__GNUC__)
...
PyObject * SurfaceOfRevolutionPy::staticCallback_getLocation (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while reading attribute 'Location' of object 'GeomSurfaceOfRevolution'");
        return nullptr;
    }
}
...
int SurfaceOfRevolutionPy::staticCallback_setLocation (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while writing attribute 'Location' of object 'GeomSurfaceOfRevolution'");
        return -1;
    }
}
...
PyObject * SurfaceOfRevolutionPy::staticCallback_getDirection (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while reading attribute 'Direction' of object 'GeomSurfaceOfRevolution'");
        return nullptr;
    }
}
...
int SurfaceOfRevolutionPy::staticCallback_setDirection (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while writing attribute 'Direction' of object 'GeomSurfaceOfRevolution'");
        return -1;
    }
}
...
PyObject * SurfaceOfRevolutionPy::staticCallback_getBasisCurve (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while reading attribute 'BasisCurve' of object 'GeomSurfaceOfRevolution'");
        return nullptr;
    }
}
...
int SurfaceOfRevolutionPy::staticCallback_setBasisCurve (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while writing attribute 'BasisCurve' of object 'GeomSurfaceOfRevolution'");
        return -1;
    }
}
...
//--------------------------------------------------------------------------
PyObject *SurfaceOfRevolutionPy::_repr()
{
...
//--------------------------------------------------------------------------
PyObject *SurfaceOfRevolutionPy::_getattr(const char *attr)			// __getattr__ function: note only need to handle new state
{
    try {
...
int SurfaceOfRevolutionPy::_setattr(const char *attr, PyObject *value) // __setattr__ function: note only need to handle new state
{
    try {
...
GeomSurfaceOfRevolution *SurfaceOfRevolutionPy::getGeomSurfaceOfRevolutionPtr() const
{
...
PyObject *SurfaceOfRevolutionPy::PyMake(PyTypeObject* /*type*/, PyObject* /*args*/, PyObject* /*kwds*/)
{
...
{
    return {"<GeomSurfaceOfRevolution object>"};
}
