...
PyTypeObject WaypointPy::Type = {
    ...
    .tp_name = "Robot.Waypoint",
    .tp_basicsize = sizeof(WaypointPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Waypoint class\n"
    "\n"
    "License: LGPL-2.1-or-later",
    .tp_methods = Robot::WaypointPy::Methods,
    .tp_getset = Robot::WaypointPy::GetterSetter,
    .tp_base = &Base::PersistencePy::Type,
    .tp_init = __PyInit,
    .tp_new = Robot::WaypointPy::PyMake
};
#if defined(__GNUC__)
