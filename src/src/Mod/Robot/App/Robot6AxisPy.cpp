...
PyTypeObject Robot6AxisPy::Type = {
    ...
    .tp_name = "Robot.Robot6Axis",
    .tp_basicsize = sizeof(Robot6AxisPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Robot6Axis class\n"
    "\n"
    "License: LGPL-2.1-or-later",
    .tp_methods = Robot::Robot6AxisPy::Methods,
    .tp_getset = Robot::Robot6AxisPy::GetterSetter,
    .tp_base = &Base::PersistencePy::Type,
    .tp_init = __PyInit,
    .tp_new = Robot::Robot6AxisPy::PyMake
};
#if defined(__GNUC__)
