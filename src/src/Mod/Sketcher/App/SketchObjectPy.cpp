...
PyTypeObject SketchObjectPy::Type = {
    ...
    .tp_name = "Sketcher.SketchObject",
    .tp_basicsize = sizeof(SketchObjectPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Represents a sketch object",
    .tp_methods = Sketcher::SketchObjectPy::Methods,
    .tp_getset = Sketcher::SketchObjectPy::GetterSetter,
    .tp_base = &Part::Part2DObjectPy::Type,
    .tp_init = __PyInit,
    .tp_new = Sketcher::SketchObjectPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef SketchObjectPy::Methods[] = {
    ...
    {"delConstraints",
        reinterpret_cast<PyCFunction>( staticCallback_delConstraints ),
        METH_VARARGS,
    ...
    {"setVisibility",
        reinterpret_cast<PyCFunction>( staticCallback_setVisibility ),
        METH_VARARGS,
    ...
    {"moveGeometries",
        reinterpret_cast<PyCFunction>( staticCallback_moveGeometries ),
        METH_VARARGS,
    ...
    {"setGeometryIds",
        reinterpret_cast<PyCFunction>( staticCallback_setGeometryIds ),
        METH_VARARGS,
...
// delConstraints() callback and implementer
// PyObject*  SketchObjectPy::delConstraints(PyObject *args){};
// has to be implemented in SketchObjectPyImp.cpp
PyObject * SketchObjectPy::staticCallback_delConstraints (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'delConstraints' of 'Sketcher.SketchObject' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<SketchObjectPy*>(self)->delConstraints(args);
        if (ret != nullptr)
            static_cast<SketchObjectPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// setVisibility() callback and implementer
// PyObject*  SketchObjectPy::setVisibility(PyObject *args){};
// has to be implemented in SketchObjectPyImp.cpp
PyObject * SketchObjectPy::staticCallback_setVisibility (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'setVisibility' of 'Sketcher.SketchObject' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<SketchObjectPy*>(self)->setVisibility(args);
        if (ret != nullptr)
            static_cast<SketchObjectPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// has to be implemented in SketchObjectPyImp.cpp
PyObject * SketchObjectPy::staticCallback_moveGeometry (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'moveGeometry' of 'Sketcher.SketchObject' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<SketchObjectPy*>(self)->moveGeometry(args);
        if (ret != nullptr)
            static_cast<SketchObjectPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// moveGeometries() callback and implementer
// PyObject*  SketchObjectPy::moveGeometries(PyObject *args){};
// has to be implemented in SketchObjectPyImp.cpp
PyObject * SketchObjectPy::staticCallback_moveGeometries (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'moveGeometries' of 'Sketcher.SketchObject' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<SketchObjectPy*>(self)->moveGeometries(args);
        if (ret != nullptr)
            static_cast<SketchObjectPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// setGeometryIds() callback and implementer
// PyObject*  SketchObjectPy::setGeometryIds(PyObject *args){};
// has to be implemented in SketchObjectPyImp.cpp
PyObject * SketchObjectPy::staticCallback_setGeometryIds (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'setGeometryIds' of 'Sketcher.SketchObject' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<SketchObjectPy*>(self)->setGeometryIds(args);
        if (ret != nullptr)
            static_cast<SketchObjectPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
