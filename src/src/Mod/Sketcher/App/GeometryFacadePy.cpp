...
PyTypeObject GeometryFacadePy::Type = {
    ...
    .tp_name = "Sketcher.GeometryFacade",
    .tp_basicsize = sizeof(GeometryFacadePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Describes a GeometryFacade",
    .tp_methods = Sketcher::GeometryFacadePy::Methods,
    .tp_getset = Sketcher::GeometryFacadePy::GetterSetter,
    .tp_base = &Base::BaseClassPy::Type,
    .tp_init = __PyInit,
    .tp_new = Sketcher::GeometryFacadePy::PyMake
};
#if defined(__GNUC__)
