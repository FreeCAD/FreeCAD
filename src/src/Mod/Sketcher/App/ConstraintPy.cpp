...
PyTypeObject ConstraintPy::Type = {
    ...
    .tp_name = "Sketcher.Constraint",
    .tp_basicsize = sizeof(ConstraintPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "With this object you can handle sketches",
    .tp_methods = Sketcher::ConstraintPy::Methods,
    .tp_getset = Sketcher::ConstraintPy::GetterSetter,
    .tp_base = &Base::PersistencePy::Type,
    .tp_init = __PyInit,
    .tp_new = Sketcher::ConstraintPy::PyMake
};
#if defined(__GNUC__)
