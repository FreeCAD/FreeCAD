...
PyTypeObject DrawParametricTemplatePy::Type = {
    ...
    .tp_name = "TechDraw.DrawParametricTemplate",
    .tp_basicsize = sizeof(DrawParametricTemplatePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Feature for creating and manipulating Technical Drawing Templates\n"
    "\n"
    "License: LGPL-2.1-or-later",
    .tp_methods = TechDraw::DrawParametricTemplatePy::Methods,
    .tp_getset = TechDraw::DrawParametricTemplatePy::GetterSetter,
    .tp_base = &TechDraw::DrawTemplatePy::Type,
    .tp_init = __PyInit,
    .tp_new = TechDraw::DrawParametricTemplatePy::PyMake
};
#if defined(__GNUC__)
...
PyObject *DrawParametricTemplatePy::PyMake(PyTypeObject* /*type*/, PyObject* /*args*/, PyObject* /*kwds*/)
{
...
{
    return {"<DrawParametricTemplate object>"};
}
