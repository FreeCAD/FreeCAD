...
PyTypeObject DrawViewPartPy::Type = {
    ...
    .tp_name = "TechDraw.DrawViewPart",
    .tp_basicsize = sizeof(DrawViewPartPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Feature for creating and manipulating Technical Drawing Part Views\n"
    "\n"
    "License: LGPL-2.1-or-later",
    .tp_methods = TechDraw::DrawViewPartPy::Methods,
    .tp_getset = TechDraw::DrawViewPartPy::GetterSetter,
    .tp_base = &TechDraw::DrawViewPy::Type,
    .tp_init = __PyInit,
    .tp_new = TechDraw::DrawViewPartPy::PyMake
};
#if defined(__GNUC__)
