...
PyTypeObject CenterLinePy::Type = {
    ...
    .tp_name = "TechDraw.CenterLine",
    .tp_basicsize = sizeof(CenterLinePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "CenterLine specifies additional mark up edges in a View\n"
    "\n"
    "License: LGPL-2.1-or-later",
    .tp_methods = TechDraw::CenterLinePy::Methods,
    .tp_getset = TechDraw::CenterLinePy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = TechDraw::CenterLinePy::PyMake
};
#if defined(__GNUC__)
