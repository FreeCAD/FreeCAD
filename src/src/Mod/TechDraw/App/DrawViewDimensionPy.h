...
public:
    ...
    /// callback for the getAreaPoints() method
    static PyObject * staticCallback_getAreaPoints (PyObject *self, PyObject *args);
    /// implementer for the getAreaPoints() method
    PyObject*  getAreaPoints(PyObject *args);
