...
PyTypeObject BlendPointPy::Type = {
    ...
    .tp_name = "Surface.BlendPoint",
    .tp_basicsize = sizeof(BlendPointPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Create BlendPoint from a point and some derivatives.\n"
    ...
    .tp_methods = Surface::BlendPointPy::Methods,
    .tp_getset = Surface::BlendPointPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Surface::BlendPointPy::PyMake
};
#if defined(__GNUC__)
...
PyObject *BlendPointPy::PyMake(PyTypeObject* /*type*/, PyObject* /*args*/, PyObject* /*kwds*/)
{
