...
public:
    ...
    PyObject*  containsPoint(PyObject *args) const;
    ...
    PyObject*  containsSegment(PyObject *args) const;
    ...
    PyObject*  isDegenerate(PyObject *args) const;
    ...
    PyObject*  getSource(PyObject *args) const;
    //@}
    ...
    Py::Long getSourceCategory() const;
