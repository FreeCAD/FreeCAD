...
PyTypeObject AreaPy::Type = {
    ...
    .tp_doc = "FreeCAD python wrapper of libarea\n"
    "\n"
    "Path.Area(key=value ...)\n"
    "\n"
    ...
    .tp_methods = Path::AreaPy::Methods,
    .tp_getset = Path::AreaPy::GetterSetter,
    .tp_base = &Base::BaseClassPy::Type,
    .tp_init = __PyInit,
    .tp_new = Path::AreaPy::PyMake
};
#if defined(__GNUC__)
