...
PyTypeObject VoronoiCellPy::Type = {
    ...
    .tp_name = "Path.VoronoiCell",
    .tp_basicsize = sizeof(VoronoiCellPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Cell of a Voronoi diagram\n"
    "\n"
    "License: LGPL-2.1-or-later",
    .tp_richcompare = Path::VoronoiCellPy::richCompare,
    .tp_methods = Path::VoronoiCellPy::Methods,
    .tp_getset = Path::VoronoiCellPy::GetterSetter,
    .tp_base = &Base::BaseClassPy::Type,
    .tp_init = __PyInit,
    .tp_new = Path::VoronoiCellPy::PyMake
};
#if defined(__GNUC__)
