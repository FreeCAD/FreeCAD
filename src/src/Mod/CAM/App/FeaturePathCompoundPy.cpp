...
PyTypeObject FeaturePathCompoundPy::Type = {
    ...
    .tp_name = "Path.FeaturePathCompound",
    .tp_basicsize = sizeof(FeaturePathCompoundPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "This class handles Path Compound features\n"
    "\n"
    "License: LGPL-2.1-or-later",
    .tp_methods = Path::FeaturePathCompoundPy::Methods,
    .tp_getset = Path::FeaturePathCompoundPy::GetterSetter,
    .tp_base = &App::DocumentObjectPy::Type,
    .tp_init = __PyInit,
    .tp_new = Path::FeaturePathCompoundPy::PyMake
};
#if defined(__GNUC__)
...
PyObject *FeaturePathCompoundPy::PyMake(PyTypeObject* /*type*/, PyObject* /*args*/, PyObject* /*kwds*/)
{
...
{
    return {"<FeaturePathCompound object>"};
}
