...
PyTypeObject VoronoiPy::Type = {
    ...
    .tp_name = "Path.Voronoi",
    .tp_basicsize = sizeof(VoronoiPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Voronoi([segments]): Create voronoi for given collection of line segments\n"
    "\n"
    "License: LGPL-2.1-or-later",
    .tp_methods = Path::VoronoiPy::Methods,
    .tp_getset = Path::VoronoiPy::GetterSetter,
    .tp_base = &Base::BaseClassPy::Type,
    .tp_init = __PyInit,
    .tp_new = Path::VoronoiPy::PyMake
};
#if defined(__GNUC__)
