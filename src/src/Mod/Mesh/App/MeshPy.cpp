...
PyTypeObject MeshPy::Type = {
    ...
    .tp_doc = "Mesh() -- Create an empty mesh object.\n"
    "\n"
    ...
    .tp_methods = Mesh::MeshPy::Methods,
    .tp_getset = Mesh::MeshPy::GetterSetter,
    .tp_base = &Data::ComplexGeoDataPy::Type,
    .tp_init = __PyInit,
    .tp_new = Mesh::MeshPy::PyMake
};
#if defined(__GNUC__)
