...
PyTypeObject ViewProviderFemConstraintPy::Type = {
    ...
    .tp_name = "FemGui.ViewProviderFemConstraint",
    .tp_basicsize = sizeof(ViewProviderFemConstraintPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "This is the ViewProviderFemConstraint class\n"
    "\n"
    "License: LGPL-2.1-or-later",
    .tp_methods = FemGui::ViewProviderFemConstraintPy::Methods,
    .tp_getset = FemGui::ViewProviderFemConstraintPy::GetterSetter,
    .tp_base = &Gui::ViewProviderGeometryObjectPy::Type,
    .tp_init = __PyInit,
    .tp_new = FemGui::ViewProviderFemConstraintPy::PyMake
};
#if defined(__GNUC__)
