...
public:
    ...
    //@{
    /// callback for the isInEditMode() method
    static PyObject * staticCallback_isInEditMode (PyObject *self, PyObject *args);
    /// implementer for the isInEditMode() method
    PyObject*  isInEditMode(PyObject *args);
    ...
    /// callback for the isolateComponents() method
    static PyObject * staticCallback_isolateComponents (PyObject *self, PyObject *args);
    /// implementer for the isolateComponents() method
    PyObject*  isolateComponents(PyObject *args);
    /// callback for the clearIsolate() method
    static PyObject * staticCallback_clearIsolate (PyObject *self, PyObject *args);
    /// implementer for the clearIsolate() method
    PyObject*  clearIsolate(PyObject *args);
    //@}
