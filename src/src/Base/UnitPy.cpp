...
PyTypeObject UnitPy::Type = {
    ...
    .tp_name = "Base.Unit",
    .tp_basicsize = sizeof(UnitPy),
    .tp_itemsize = 0,
    /* methods */
    .tp_dealloc = PyDestructor,
    .tp_repr = __repr,
    .tp_as_number = Base::UnitPy::Number,
    ...
    .tp_richcompare = Base::UnitPy::richCompare,
    .tp_methods = Base::UnitPy::Methods,
    .tp_getset = Base::UnitPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Base::UnitPy::PyMake
};
#if defined(__GNUC__)
