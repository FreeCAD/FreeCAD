...
PyTypeObject BoundBoxPy::Type = {
    ...
    .tp_name = "Base.BoundBox",
    .tp_basicsize = sizeof(BoundBoxPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_methods = Base::BoundBoxPy::Methods,
    .tp_getset = Base::BoundBoxPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Base::BoundBoxPy::PyMake
};
#if defined(__GNUC__)
