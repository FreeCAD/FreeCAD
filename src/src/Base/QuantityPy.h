...
public:
    ...
    PyObject*  toStr(PyObject *args) const;
    ...
    PyObject*  getUserPreferred(PyObject *args) const;
    ...
    PyObject*  getValueAs(PyObject *args) const;
    ...
    PyObject*  __round__(PyObject *args) const;
    //@}
