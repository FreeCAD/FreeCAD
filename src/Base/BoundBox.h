...
public:
    ...
    */
    ...
    void CalcPlane (unsigned short usPlane, Vector3<Precision>& rBase,
...
template <class Precision>
inline BoundBox3<Precision>::BoundBox3 (Precision fMinX, Precision fMinY, Precision fMinZ,
...
{
    switch (usPoint) {
    case TLB: return Vector3<Precision>(MinX, MinY, MaxZ);
    case TLF: return Vector3<Precision>(MaxX, MinY, MaxZ);
    case TRF: return Vector3<Precision>(MaxX, MaxY, MaxZ);
    case TRB: return Vector3<Precision>(MinX, MaxY, MaxZ);
    case BLB: return Vector3<Precision>(MinX, MinY, MinZ);
    case BLF: return Vector3<Precision>(MaxX, MinY, MinZ);
    case BRF: return Vector3<Precision>(MaxX, MaxY, MinZ);
    case BRB: return Vector3<Precision>(MinX, MaxY, MinZ);
    }
...
template <class Precision>
inline bool BoundBox3<Precision>::CalcEdge (unsigned short usEdge, Vector3<Precision>& rcP0,
                                            Vector3<Precision>& rcP1) const
{
    switch (usEdge) {
    case TLB_TLF:
...
// NOLINTEND(bugprone-easily-swappable-parameters)
{
    ...
    auto checkIntersect = [&](Base::Vector3<Precision> p1,
                              Base::Vector3<Precision> p2) {
...
{
    return Vector3<Precision>((MaxX + MinX) / 2,
                               (MaxY + MinY) / 2,
                               (MaxZ + MinZ) / 2);
}
