...
// NOLINTBEGIN(bugprone-reserved-identifier,bugprone-macro-parentheses,*macro-usage,*-avoid-do-while)
// clang-format off
#define FC_LOGLEVEL_DEFAULT -1
#define FC_LOGLEVEL_ERR 0
#define FC_LOGLEVEL_WARN 1
...
// clang-format on
// NOLINTEND(bugprone-reserved-identifier,bugprone-macro-parentheses,*macro-usage,*-avoid-do-while)
