...
const Quantity Quantity::NewtonPerMeter(1.00,
                                        Units::Stiffness);  // Newton per meter (N/m or kg/s^2)
...
const Quantity Quantity::Torr(
    101.325 / 760.0,
    Units::CompressiveStrength);  // Torr is a defined fraction of Pascal (kg/m/s^2 or N/m^2)
const Quantity Quantity::mTorr(
    0.101325 / 760.0,
    Units::CompressiveStrength);  // Torr is a defined fraction of Pascal (kg/m/s^2 or N/m^2)
const Quantity Quantity::yTorr(
    0.000101325 / 760.0,
    Units::CompressiveStrength);  // Torr is a defined fraction of Pascal (kg/m/s^2 or N/m^2)
