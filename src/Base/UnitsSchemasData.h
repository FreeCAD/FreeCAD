...
#ifndef BASE_DATAPACKDATA_H
#define BASE_DATAPACKDATA_H
...
{ 6, "MmMin", "mm" , false, false , "Metric small parts & CNC (mm, mm/min)", false,
    {
        { "Length",   {{ 0 , "mm"     , 1.0        }}},
        { "Angle",    {{ 0 , "°"      , 1.0        }}},
...
{ 9, "MeterDecimal", "m", false, false, "Meter decimal (m, m², m³)", false,
    {
        { "Length",             {{ 0 , "m"    , 1e3 }}},
        { "Area",               {{ 0 , "m²"   , 1e6 }}},
        { "Volume",             {{ 0 , "m³"   , 1e9 }}},
...
{ 3, "ImperialDecimal", "in", false, false, "Imperial decimal (in, lb)", false,
    {
        { "Length",       {{ 0 , "in"      , 25.4              }}},
        { "Angle",        {{ 0 , "°"       , 1.0               }}},
        { "Area",         {{ 0 , "in²"     , 645.16            }}},
...
{ 0, "Internal", "m", false, false, "Internal (m, m², m³)", true,
    {
        { "Length", {
            { 1e-6            , "mm"         , 1.0             },
            { 1e-3            , "nm"         , 1e-6            },
...
{ 1, "MKS", "m", false, false, "MKS (m, kg, s, °)" , false,
    {
        { "Length", {
            { 1e-6            , "mm"         , 1.0             },
            { 1e-3            , "nm"         , 1e-6            },
...
{ 4, "Centimeter", "cm", false, false, "Building Euro (cm, m², m³)" , false,
    {
        { "Length", {
            { 0              , "cm"          , 10.0             }}
        },
...
{ 8, "FEM", "mm", false , false , "FEM (mm, N, s)", false,
    {
        { "Length", {
            { 0             , "mm"           , 1.0               }}
        },
...
{ 2, "Imperial", "in", false, false, "US customary (in, lb)", false,
    {
        { "Length", {
            { 0.00000254      , "in"       , 25.4              },
            { 2.54            , "thou"     , 0.0254            },
...
{ 5, "ImperialBuilding", "ft", true, false , "Building US (ft-in, sqft, cft)", false,
    {
...
{ 7, "ImperialCivil", "ft", false, true, "Imperial for Civil Eng (ft, ft/s)", false,
    {
        { "Angle"    , {{ 0   , "toDMS"           , 0              }}}  // <== !
    }
};
...
{
    return specials.find(name) == specials.end() ? "" : specials.at(name)(value);
}
