...
# if commands.getstatustput("locate TemplatePyMod")[0] == 0:
...
sys.path.insert(0, str(Path('..', '..', 'Mod', 'TemplatePyMod').resolve()))
sys.path.insert(0, str(Path('..', '..', '..', 'build', 'lib').resolve()))
#sys.path.insert(0, str(Path('..', '..', 'Mod', 'BIM').resolve()))
sys.path.insert(0, str(Path('/usr/lib/python3/dist-packages/PySide2').resolve()))
