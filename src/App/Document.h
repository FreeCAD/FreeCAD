...
public:
    ...
    static ExportStatus isExporting(const App::DocumentObject *obj) ;
...
protected:
    ...
    static void _rebuildDependencyList(
        const std::vector<App::DocumentObject*> &objs = std::vector<App::DocumentObject*>());

    static std::string getTransientDirectoryName(const std::string& uuid, const std::string& filename) ;
