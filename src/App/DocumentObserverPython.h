...
private:
    ...
    void slotDocActiveContainer(App::Document* doc, App::PropertyContainer* newContainer, App::PropertyContainer* oldContainer);
    void slotAppActiveContainer(App::PropertyContainer* newContainer, App::PropertyContainer* oldContainer);
