...
that reference the same configurable object</source>
      <translation>Сохраняет последний выбор пользователя о том, следует ли применять настройку CopyOnChange ко всем ссылкам, которые ссылаются на один и тот же настраиваемый объект</translation>
    </message>
  </context>
  <context>
    <name>QObject</name>
...
The user should then click the Refresh button in the main toolbar.
      ...
      <translation>
Рекомендуется, чтобы пользователь щелкнул правой кнопкой мыши по корню документа и выбрал "Отметить для пересчета".
Затем пользователь должен нажать кнопку "Обновить" на главной панели инструментов.
</translation>
    </message>
  </context>
  <context>
