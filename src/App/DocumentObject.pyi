...
class DocumentObject(ExtensionContainer):
    ...
    def setElementVisible(self, element: Any, visible: bool) -> int:
        """
    ...
    def isElementVisible(self, element: Any) -> int:
        """
    ...
    def adjustRelativeLinks(self, parent: Any, recursive: bool = True) -> None:
        """
    ...
    @constmethod
    def getElementMapVersion(self, property_name: str) -> Any:
        """
