...
{
    return Py::Object(getDocumentPtr()->getActiveContainer().getPyObject(), true);
}
...
void DocumentPy::setActiveContainer(Py::Object newContainer)
{
    ...
    } else if (PyObject_TypeCheck(newContainer.ptr(), &(ContainerPy::Type))) {
        pcContainer = static_cast<ContainerPy*>(newContainer.ptr())->getContainerPtr()->object();
    ...
    this->getDocumentPtr()->setActiveContainer(Container(pcContainer));
}
