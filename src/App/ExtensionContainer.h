...
public:
    ...
    void restoreExtensions(Base::DocumentReader& reader,
    ...
    void handleChangedPropertyName(Base::DocumentReader &reader,
                                   const char * TypeName,
                                   const char *PropName) override;
    ...
    void handleChangedPropertyType(Base::DocumentReader &reader,
                                   const char * TypeName,
                                   Property * prop) override;

    void readExtension(Base::DocumentReader &reader,
                       XERCES_CPP_NAMESPACE_QUALIFIER DOMElement *ExtensionDOM);
