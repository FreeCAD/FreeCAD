...
void DocumentObserverPython::slotDocActiveContainer(App::Document* doc, App::PropertyContainer* newContainer, App::PropertyContainer* oldContainer)
{
    Base::PyGILStateLocker lock;
    try {
...
void DocumentObserverPython::slotAppActiveContainer(App::PropertyContainer* newContainer, App::PropertyContainer* oldContainer)
{
    Base::PyGILStateLocker lock;
    try {
