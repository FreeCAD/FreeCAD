...
def sogui_atexit(*args):
  """sogui_atexit(sogui_atexit_f fp, int priority)"""
  return _soqt.sogui_atexit(*args)
...
class SoQtSpaceball(SoQtDevice):
    """Proxy of C++ SoQtSpaceball class"""
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def initClass(*args):
        """initClass()"""
        return _soqt.SoQtSpaceball_initClass(*args)

    initClass = staticmethod(initClass)
    def getClassTypeId(*args):
        """getClassTypeId() -> SoType"""
        return _soqt.SoQtSpaceball_getClassTypeId(*args)

    getClassTypeId = staticmethod(getClassTypeId)
    def getTypeId(*args):
        """getTypeId(self) -> SoType"""
        return _soqt.SoQtSpaceball_getTypeId(*args)

    def createInstance(*args):
        """createInstance() -> void"""
        return _soqt.SoQtSpaceball_createInstance(*args)

    createInstance = staticmethod(createInstance)
    MOTION_EVENT = _soqt.SoQtSpaceball_MOTION_EVENT
    MOTION = _soqt.SoQtSpaceball_MOTION
    PRESS_EVENT = _soqt.SoQtSpaceball_PRESS_EVENT
    PRESS = _soqt.SoQtSpaceball_PRESS
    RELEASE_EVENT = _soqt.SoQtSpaceball_RELEASE_EVENT
    RELEASE = _soqt.SoQtSpaceball_RELEASE
    ALL_EVENTS = _soqt.SoQtSpaceball_ALL_EVENTS
    ALL = _soqt.SoQtSpaceball_ALL
    SPACE_BALL = _soqt.SoQtSpaceball_SPACE_BALL
    MAGELLAN_SPACE_MOUSE = _soqt.SoQtSpaceball_MAGELLAN_SPACE_MOUSE
    def __init__(self, *args): 
        """
        __init__(self, int events=ALL_EVENTS) -> SoQtSpaceball
        __init__(self) -> SoQtSpaceball
        """
        this = _soqt.new_SoQtSpaceball(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _soqt.delete_SoQtSpaceball
    __del__ = lambda self : None;
    def enable(*args):
        """enable(self, QWidget widget, SoQtEventHandler handler, void closure)"""
        return _soqt.SoQtSpaceball_enable(*args)

    def disable(*args):
        """disable(self, QWidget widget, SoQtEventHandler handler, void closure)"""
        return _soqt.SoQtSpaceball_disable(*args)

    def translateEvent(*args):
        """translateEvent(self, QEvent event) -> SoEvent"""
        return _soqt.SoQtSpaceball_translateEvent(*args)

    def setRotationScaleFactor(*args):
        """setRotationScaleFactor(self, float f)"""
        return _soqt.SoQtSpaceball_setRotationScaleFactor(*args)

    def getRotationScaleFactor(*args):
        """getRotationScaleFactor(self) -> float"""
        return _soqt.SoQtSpaceball_getRotationScaleFactor(*args)

    def setTranslationScaleFactor(*args):
        """setTranslationScaleFactor(self, float f)"""
        return _soqt.SoQtSpaceball_setTranslationScaleFactor(*args)

    def getTranslationScaleFactor(*args):
        """getTranslationScaleFactor(self) -> float"""
        return _soqt.SoQtSpaceball_getTranslationScaleFactor(*args)

    def exists(*args):
        """exists() -> SbBool"""
        return _soqt.SoQtSpaceball_exists(*args)

    exists = staticmethod(exists)
    def setFocusToWindow(*args):
        """setFocusToWindow(self, SbBool flag)"""
        return _soqt.SoQtSpaceball_setFocusToWindow(*args)

    def isFocusToWindow(*args):
        """isFocusToWindow(self) -> SbBool"""
        return _soqt.SoQtSpaceball_isFocusToWindow(*args)

SoQtSpaceball_swigregister = _soqt.SoQtSpaceball_swigregister
SoQtSpaceball_swigregister(SoQtSpaceball)

def SoQtSpaceball_initClass(*args):
  """SoQtSpaceball_initClass()"""
  return _soqt.SoQtSpaceball_initClass(*args)

def SoQtSpaceball_getClassTypeId(*args):
  """SoQtSpaceball_getClassTypeId() -> SoType"""
  return _soqt.SoQtSpaceball_getClassTypeId(*args)

def SoQtSpaceball_createInstance(*args):
  """SoQtSpaceball_createInstance() -> void"""
  return _soqt.SoQtSpaceball_createInstance(*args)

def SoQtSpaceball_exists(*args):
  """SoQtSpaceball_exists() -> SbBool"""
  return _soqt.SoQtSpaceball_exists(*args)
