...
"""Public stub layout and support-AST helpers.
...
- map overlay paths and filter source-adjacent support nodes

The public API model and renderer own semantic declarations; this module only
contains filesystem layout and AST support utilities.
"""
