...
When binding `.pyi` classes use `typing_extensions.deprecated(...)`, the public
stub generator preserves those decorators on the emitted class and method
stubs. When binding classes use `@deprecated_attributes(...)`, the public stub
