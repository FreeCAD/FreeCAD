...
{
    setupRotationDragger("xRotatorDragger", rotationIncrementCountX, SbVec3d(1.0, 0.0, 0.0));
    setupRotationDragger("yRotatorDragger", rotationIncrementCountY, SbVec3d(0.0, 1.0, 0.0));
    setupRotationDragger("zRotatorDragger", rotationIncrementCountZ, SbVec3d(0.0, 0.0, 1.0));
}

void SoTransformDragger::setupRotationDragger(const std::string& name, SoSFInt32& incrementCount, const SbVec3d& rotDir)
{
