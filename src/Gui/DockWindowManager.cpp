...
void DockWindowItems::addDockWidget(const char* name,
...
public:
    bool eventFilter(QObject* o, QEvent* e)
    {
        ...
        bool bottom =
            QRect(topLeft.x() - cursorMargin, bottomRight.y(), w, cursorMargin).contains(pos);
 ...
 */
QDockWidget*
DockWindowManager::addDockWindow(const char* name, QWidget* widget, Qt::DockWidgetArea pos)
{
    if (!widget) {
        return nullptr;
    }
