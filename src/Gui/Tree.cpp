...
void TreeWidget::selectAll()
{
    ...
    inSelectAllOperation = true;
    lastSelectAllParent = targetNode;
    ...
    if (isGrp) {
        const auto* vp = static_cast<const DocumentObjectItem*>(current)->object();
