...
public:
    ...
    void importObjects(const std::vector<App::DocumentObject*>&,
                       Base::Reader&,
    ...
    std::vector<std::pair<ViewProviderDocumentObject*, int>>
    getViewProvidersByPath(SoPath* path) const;
    ...
    MDIView* setActiveView(const ViewProviderDocumentObject* vp = nullptr,
    ...
    ViewProvider* getInEdit(ViewProviderDocumentObject** parentVp = nullptr,
                            ...
                            int* mode = nullptr,
                            std::string* subElement = nullptr) const;
