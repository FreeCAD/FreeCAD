...
const char* ActionPanelWinXPBlueStyle1 =
    ...
    "QFrame[class='panel'] {"
    "background-color: qlineargradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #7ba2e7, stop: 1 "
    "#6375d6);"
    "}"
...
const char* ActionPanelWinXPBlueStyle2 =
    ...
    "border-top-left-radius: 4px;"
    "border-top-right-radius: 4px;"
    "background-color: qlineargradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #ffffff, stop: 1 "
    "#c6d3f7);"
    "}"
...
WinXPPanelScheme::WinXPPanelScheme()
    : ActionPanelScheme()
{
    headerSize = 25;
...
WinXPPanelScheme2::WinXPPanelScheme2()
    : ActionPanelScheme()
{
    headerSize = 25;
    headerAnimation = false;
