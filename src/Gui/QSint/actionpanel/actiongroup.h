...
class QSINT_EXPORT ActionGroup: public QWidget
{
    ...
    Q_PROPERTY(
        bool header READ hasHeader WRITE setHeader)  // clazy:exclude=qproperty-without-notify
...
public:
    ...
    /** Adds \a label to the group.
      ...
      */
    ActionLabel*
    addActionLabel(ActionLabel* label, bool addToLayout = true, bool addStretch = true);
