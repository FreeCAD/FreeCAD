...
bool ViewProvider::mouseButtonPressed(int button,
                                      bool pressed,
...
bool ViewProvider::mouseWheelEvent(int delta,
                                   const SbVec2s& cursorPos,
                                   const View3DInventorViewer* viewer)
{
    (void)delta;
...
bool ViewProvider::canDragObjectToTarget(App::DocumentObject* obj,
                                         [[maybe_unused]] App::DocumentObject* target) const
{
...
bool ViewProvider::canDropObjectEx(App::DocumentObject* obj,
...
std::string ViewProvider::dropObjectEx(App::DocumentObject* obj,
                                       App::DocumentObject* owner,
                                       const char* subname,
...
bool ViewProvider::getDetailPath(const char* subname,
                                 SoFullPath* pPath,
                                 bool append,
                                 SoDetail*& det) const
{
...
Base::BoundBox3d
ViewProvider::getBoundingBox(const char* subname, bool transform, MDIView* view) const
{
