...
#ifndef GUI_ONSHAPENAVIGATIONSTYLE_H
#define GUI_ONSHAPENAVIGATIONSTYLE_H
...
class GuiExport OnshapeNavigationStyle: public NavigationStateChart
{
...
public:
    ...
    ~OnshapeNavigationStyle() override;
...
#endif  // GUI_ONSHAPENAVIGATIONSTYLE_H
