...
TYPESYSTEM_SOURCE(Gui::RevitNavigationStyle, Gui::MappedNavigationStyle)

RevitNavigationStyle::RevitNavigationStyle() = default;

RevitNavigationStyle::~RevitNavigationStyle() = default;

const NavigationProfile& RevitNavigationStyle::profile() const
{
    return revitProfile;
}
