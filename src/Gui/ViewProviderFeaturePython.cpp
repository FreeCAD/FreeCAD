...
ViewProviderFeaturePythonImp::ValueT
ViewProviderFeaturePythonImp::getDetailPath(const char* name,
                                            SoFullPath* path,
                                            bool append,
                                            SoDetail*& det) const
{
    ...
    try {
        PyObject* pivy = nullptr;
        pivy = Base::Interpreter().createSWIGPointerObj("pivy.coin",
                                                        "SoFullPath *",
...
ViewProviderFeaturePythonImp::getSelectionShape(const char* /*Element*/) const
{
    return {};
}
...
bool ViewProviderFeaturePythonImp::dropObjectEx(App::DocumentObject* obj,
                                                App::DocumentObject* owner,
                                                const char* subname,
...
ViewProviderFeaturePythonImp::ValueT
ViewProviderFeaturePythonImp::replaceObject(App::DocumentObject* oldObj,
...
bool ViewProviderFeaturePythonImp::getLinkedViewProvider(ViewProviderDocumentObject*& vp,
                                                         std::string* subname,
