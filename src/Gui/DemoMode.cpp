...
{
    connect(ui->playButton, &QPushButton::clicked, this, &DemoMode::onPlayButtonToggled);
    connect(ui->fullscreen, &QCheckBox::toggled, this, &DemoMode::onFullscreenToggled);
    connect(ui->timerCheck, &QCheckBox::toggled, this, &DemoMode::onTimerCheckToggled);
    connect(ui->speedSlider, &QSlider::valueChanged, this, &DemoMode::onSpeedSliderValueChanged);
    connect(ui->angleSlider, &QSlider::valueChanged, this, &DemoMode::onAngleSliderValueChanged);
    connect(ui->timeout,
            qOverload<int>(&QSpinBox::valueChanged),
            this,
            &DemoMode::onTimeoutValueChanged);
}
