...
void MDIViewPy::init_type()
{
    ...
    add_varargs_method("setActiveObject",
    ...
    add_varargs_method("cast_to_base",
                       &MDIViewPy::cast_to_base,
                       "cast_to_base() cast to MDIView class");
}

PyObject* MDIViewPy::extension_object_new(struct _typeobject* /*type*/,
                                          PyObject* /*args*/,
                                          PyObject* /*kwds*/)
{
...
Py::Object MDIViewPy::getActiveObject(const Py::Tuple& args)
{
    ...
    if (obj) {
        return Py::TupleN(Py::asObject(obj->getPyObject()),
