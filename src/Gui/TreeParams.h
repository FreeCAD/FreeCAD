...
public:
    ...
    // Auto generated code (Tools/params_utils.py:138)
    //@{
    /// Accessor for parameter TreeActiveFontWeight
    static const long & getTreeActiveFontWeight();
    static const long & defaultTreeActiveFontWeight();
    static void removeTreeActiveFontWeight();
    static void setTreeActiveFontWeight(const long &v);
    static const char *docTreeActiveFontWeight();
    //@}
