    ...
    const std::function<QWidget*(const QString&, QWidget*, const QString&)>& callableFunc)
{
    ...
    QWidget* widget = callableFunc(QString::fromLatin1(className.c_str()),
                                   parent,
    ...
    : Py::ExtensionModule<PySideUicModule>("PySideUic")
{
    ...
    add_varargs_method("createCustomWidget",
...
std::unique_ptr<UiLoader> UiLoader::newInstance(QObject* parent)
{
    ...
    app->setLibraryPaths(
        QStringList {});  //< backup library paths, so QUiLoader won't load plugins by default
...
void UiLoaderPy::init_type()
{
    ...
    add_varargs_method("isLanguageChangeEnabled",
                       &UiLoaderPy::isLanguageChangeEnabled,
                       "isLanguageChangeEnabled()");
    add_varargs_method("setLanguageChangeEnabled",
                       &UiLoaderPy::setLanguageChangeEnabled,
                       "setLanguageChangeEnabled()");
    add_varargs_method("setWorkingDirectory",
                       &UiLoaderPy::setWorkingDirectory,
                       "setWorkingDirectory()");
...
Py::Object UiLoaderPy::createWidget(const Py::Tuple& args)
{
    ...
    return wrapFromWidgetFactory(args,
                                 std::bind(&UiLoader::createWidget,
                                           loader.get(),
                                           std::placeholders::_1,
                                           std::placeholders::_2,
                                           std::placeholders::_3));
