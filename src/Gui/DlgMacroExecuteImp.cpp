...
public:
    ...
    /**
     * Override setText method to additionally set toolTip with text of absolute
     * file path. There may be different macros with same names from different
     * system paths. So it could be helpful for user to show where exactly macro
     * is placed.
     */
