...
PyMethodDef Application::Methods[] = {
    {"activateWorkbench",
     (PyCFunction)Application::sActivateWorkbenchHandler,
     METH_VARARGS,
    ...
    {"addWorkbench",
     (PyCFunction)Application::sAddWorkbenchHandler,
     METH_VARARGS,
     ...
     "    Workbench class."},
    {"removeWorkbench",
     (PyCFunction)Application::sRemoveWorkbenchHandler,
     METH_VARARGS,
    ...
    {"getWorkbench",
     (PyCFunction)Application::sGetWorkbenchHandler,
     METH_VARARGS,
    ...
    {"listWorkbenches",
     (PyCFunction)Application::sListWorkbenchHandlers,
     METH_VARARGS,
     "listWorkbenches() -> dict\n"
     "\n"
     "Get a dictionary with all workbenches."},
    {"activeWorkbench",
     (PyCFunction)Application::sActiveWorkbenchHandler,
     METH_VARARGS,
     "activeWorkbench() -> Workbench\n"
     "\n"
     "Return the active workbench object."},
    {"addResourcePath",
     (PyCFunction)Application::sAddResPath,
     METH_VARARGS,
    ...
    {"addLanguagePath",
     (PyCFunction)Application::sAddLangPath,
     METH_VARARGS,
    ...
    {"addIconPath",
     (PyCFunction)Application::sAddIconPath,
     METH_VARARGS,
     ...
     "path : str, bytes, bytearray\n    Path to icon files."},
    {"addIcon",
     (PyCFunction)Application::sAddIcon,
     METH_VARARGS,
     ...
     "format : str\n    Format of the icon."},
    {"getIcon",
     (PyCFunction)Application::sGetIcon,
     METH_VARARGS,
     ...
     "name : str\n    Name of the icon."},
    {"isIconCached",
     (PyCFunction)Application::sIsIconCached,
     METH_VARARGS,
     ...
     "name : str\n    Name of the icon."},
    {"getMainWindow",
     (PyCFunction)Application::sGetMainWindow,
     METH_VARARGS,
     "getMainWindow() -> QMainWindow\n"
     "\n"
     "Return the main window instance."},
    {"updateGui",
     (PyCFunction)Application::sUpdateGui,
     METH_VARARGS,
     "updateGui() -> None\n"
     "\n"
     "Update the main window and all its windows."},
    {"updateLocale",
     (PyCFunction)Application::sUpdateLocale,
     METH_VARARGS,
     "updateLocale() -> None\n"
     "\n"
     "Update the localization."},
    {"getLocale",
     (PyCFunction)Application::sGetLocale,
     METH_VARARGS,
     "getLocale() -> str\n"
     "\n"
     "Returns the locale currently used by FreeCAD."},
    {"setLocale",
     (PyCFunction)Application::sSetLocale,
     METH_VARARGS,
     "setLocale(name) -> None\n"
     "\n"
     ...
     "name : str\n    Locale name."},
    {"supportedLocales",
     (PyCFunction)Application::sSupportedLocales,
     METH_VARARGS,
    ...
    {"createDialog",
     (PyCFunction)Application::sCreateDialog,
     METH_VARARGS,
     ...
     "path : str\n    UI file path."},
    {"addPreferencePage",
     (PyCFunction)Application::sAddPreferencePage,
     METH_VARARGS,
     ...
     "dialog : type\n    Preference page."},
    {"addCommand",
     (PyCFunction)Application::sAddCommand,
     METH_VARARGS,
    ...
    {"runCommand",
     (PyCFunction)Application::sRunCommand,
     METH_VARARGS,
    ...
    {"SendMsgToActiveView",
     (PyCFunction)Application::sSendActiveView,
     METH_VARARGS,
    ...
    {"sendMsgToFocusView",
     (PyCFunction)Application::sSendFocusView,
     METH_VARARGS,
    ...
    {"show",
     ...
     "name : str\n    Feature name."},
    {"hideObject",
     (PyCFunction)Application::sHideObject,
     METH_VARARGS,
     "hideObject(obj) -> None\n"
     "\n"
    ...
    {"showObject",
     (PyCFunction)Application::sShowObject,
     METH_VARARGS,
     "showObject(obj) -> None\n"
     "\n"
    ...
    {"insert",
     (PyCFunction)Application::sInsert,
     METH_VARARGS,
     ...
     "docName : str\n    Document name."},
    {"export",
     (PyCFunction)Application::sExport,
     METH_VARARGS,
    ...
    {"activeView",
     (PyCFunction)Application::sActiveView,
     METH_VARARGS,
     ...
     "typeName : str\n    Type name."},
    {"activateView",
     (PyCFunction)Application::sActivateView,
     METH_VARARGS,
     ...
     "create : bool"},
    {"editDocument",
     (PyCFunction)Application::sEditDocument,
     METH_VARARGS,
    ...
    {"doCommand",
     (PyCFunction)Application::sDoCommand,
     METH_VARARGS,
     "doCommand(cmd) -> None\n"
     "\n"
     ...
     "cmd : str"},
    {"doCommandGui",
     (PyCFunction)Application::sDoCommandGui,
     METH_VARARGS,
     ...
     "cmd : str"},
    {"doCommandEval",
     (PyCFunction)Application::sDoCommandEval,
     METH_VARARGS,
     ...
     "cmd : str"},
    {"doCommandSkip",
     (PyCFunction)Application::sDoCommandSkip,
     METH_VARARGS,
     ...
     "cmd : str"},
    {"addModule",
     (PyCFunction)Application::sAddModule,
     METH_VARARGS,
     "addModule(mod) -> None\n"
     "\n"
     ...
     "mod : str"},
    {"showDownloads",
     (PyCFunction)Application::sShowDownloads,
     METH_VARARGS,
     "showDownloads() -> None\n\n"
     "Show the downloads manager window."},
    {"showPreferences",
     (PyCFunction)Application::sShowPreferences,
     METH_VARARGS,
     ...
     "index : int\n    Page index."},
    {"createViewer",
     (PyCFunction)Application::sCreateViewer,
     METH_VARARGS,
     ...
     "name : str\n    Viewer title."},
    {"getMarkerIndex",
     (PyCFunction)Application::sGetMarkerIndex,
     METH_VARARGS,
    ...
    {"addWorkbenchManipulator",
     (PyCFunction)Application::sAddWbManipulator,
     METH_VARARGS,
    ...
    {"removeWorkbenchManipulator",
     (PyCFunction)Application::sRemoveWbManipulator,
     METH_VARARGS,
     ...
     "obj : object"},
    {"listUserEditModes",
     (PyCFunction)Application::sListUserEditModes,
     METH_VARARGS,
     "listUserEditModes() -> list\n"
     "\n"
     "List available user edit modes."},
    {"getUserEditMode",
     (PyCFunction)Application::sGetUserEditMode,
     METH_VARARGS,
     "getUserEditMode() -> str\n"
     "\n"
     "Get current user edit mode."},
    {"setUserEditMode",
     (PyCFunction)Application::sSetUserEditMode,
     METH_VARARGS,
     ...
     "mode : str"},
    {"reload",
     (PyCFunction)Application::sReload,
     METH_VARARGS,
    ...
    {"coinRemoveAllChildren",
     (PyCFunction)Application::sCoinRemoveAllChildren,
     METH_VARARGS,
