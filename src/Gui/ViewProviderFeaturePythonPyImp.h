...
#ifndef GUI_VIEWPROVIDERFEATUREPYTHONPYIMP_H
#define GUI_VIEWPROVIDERFEATUREPYTHONPYIMP_H
 ...
 */
template <class PyT>
class ViewProviderFeaturePythonPyT : public PyT
{
public:
...
public:
    ViewProviderFeaturePythonPyT(ViewProviderDocumentObject *pcObject, PyTypeObject *T = &Type);
    virtual ~ViewProviderFeaturePythonPyT();
...
#include "ViewProviderFeaturePythonPyImp.inl"

#endif // GUI_VIEWPROVIDERFEATUREPYTHONPYIMP_H
