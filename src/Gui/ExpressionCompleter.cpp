...
public:
    ...
    //    |-- doc 1 (non contextual)                 - (row 0, [-1,-1,-1,0]) = encode as parent =>
    //    [0,-1,-1,0]
    //    |-- doc 2 (non contextual)                 - (row 1, [-1,-1,-1,0]) = encode as parent =>
    //    [1,-1,-1,0] |   |- doc 2.obj1                          - (row 0, [1,-1,-1,0])  = encode as
    //    parent => [1, 0,-1,0] |   |- doc 2.obj2                          - (row 1, [1,-1,-1,0])  =
    //    encode as parent => [1, 1,-1,0] |   |- doc 2.obj3                          - (row 2,
    //    [1,-1,-1,0])  = encode as parent => [1, 2,-1,0] |      |- doc 2.obj3.prop1 - (row 0, [1,
    //    2,-1,0])  = encode as parent => [1, 2, 0,0] |      |- doc 2.obj3.prop2                 -
    //    (row 1, [1, 2,-1,0])  = encode as parent => [1, 2, 1,0] |      |- doc 2.obj3.prop3 - (row
    //    2, [1, 2,-1,0])  = encode as parent => [1, 2, 2,0] |         |- doc 2.obj3.prop3.path0 -
    //    (row 0, [1, 2, 2,0])  = encode as parent => INVALID, LEAF ITEM |         |-
    //    doc 2.obj3.prop3.path1        - (row 1, [1, 2, 2,0])  = encode as parent => INVALID, LEAF
    //    ITEM
    //    |
    //    |
    //    |-- doc 3 (non contextual)                 - (row 2, [-1,-1,-1,0]) = encode as parent =>
    //    [2,-1,-1,0]
    //    |
    //    |-- obj1 (current doc - contextual)        - (row 3, [-1,-1,-1,0]) = encode as parent =>
    //    [3,-1,-1,1]
    //    |-- obj2 (current doc - contextual)        - (row 4, [-1,-1,-1,0]) = encode as parent =>
    //    [4,-1,-1,1] |   |- obj2.prop1 (contextual)             - (row 0, [4,-1,-1,1])  = encode as
    //    parent => [4,-1,0,1] |   |- obj2.prop2 (contextual)             - (row 1, [4,-1,-1,1])  =
    //    encode as parent => [4,-1,1,1] |      | - obj2.prop2.path1 (contextual)   - (row 0,
    //    [4,-1,0 ,1])  = encode as parent => INVALID, LEAF ITEM |      | - obj2.prop2.path2
    //    (contextual)   - (row 1, [4,-1,1 ,1])  = encode as parent => INVALID, LEAF ITEM
    //    |
    //    |-- prop1 (current obj - contextual)       - (row 5, [-1,-1,-1,0]) = encode as parent =>
    //    [5,-1,-1,1]
    //    |-- prop2 (current obj - contextual)       - (row 6, [-1,-1,-1,0]) = encode as parent =>
    //    [6,-1,-1,1]
    //        |-- prop2.path1 (contextual)           - (row 0, [ 6,-1,-1,0]) = encode as parent =>
    //        INVALID, LEAF ITEM
    //        |-- prop2.path2 (contextual)           - (row 1, [ 6,-1,-1,0]) = encode as parent =>
    //        INVALID, LEAF ITEM
    //
