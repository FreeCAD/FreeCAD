...
public:
    ...
    std::unordered_map<const char*, void (*)(TreeParamsP*), App::CStringHasher, App::CStringHasher>
        funcs;
...
const char* TreeParams::docVisibilityIcon()
{
    return QT_TRANSLATE_NOOP("TreeParams",
                             "If enabled, show an eye icon before the tree view items, showing the "
                             "items visibility status. When clicked the visibility is toggled");
}
