...
public:
    ...
    TreeParamsP() {
        ...
        TreeActiveFontWeight = handle->GetInt("TreeActiveFontWeight", 70);
        funcs["TreeActiveFontWeight"] = &TreeParamsP::updateTreeActiveFontWeight;
    ...
    // Auto generated code (Tools/params_utils.py:288)
    static void updateTreeActiveFontWeight(TreeParamsP *self) {
        self->TreeActiveFontWeight = self->handle->GetInt("TreeActiveFontWeight", 70);
    }
    // Auto generated code (Tools/params_utils.py:296)
...
// Auto generated code (Tools/params_utils.py:350)
const char *TreeParams::docTreeActiveFontWeight() {
    return "";
}

// Auto generated code (Tools/params_utils.py:358)
const long & TreeParams::getTreeActiveFontWeight() {
    return instance()->TreeActiveFontWeight;
}

// Auto generated code (Tools/params_utils.py:366)
const long & TreeParams::defaultTreeActiveFontWeight() {
    const static long def = 70;
    return def;
}

// Auto generated code (Tools/params_utils.py:375)
void TreeParams::setTreeActiveFontWeight(const long &v) {
    instance()->handle->SetInt("TreeActiveFontWeight",v);
    instance()->TreeActiveFontWeight = v;
}

// Auto generated code (Tools/params_utils.py:384)
void TreeParams::removeTreeActiveFontWeight() {
    instance()->handle->RemoveInt("TreeActiveFontWeight");
}
