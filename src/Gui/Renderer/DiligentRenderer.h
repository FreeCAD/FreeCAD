...
#ifndef GUI_DILIGENT_RENDERER_H
#define GUI_DILIGENT_RENDERER_H
...
class DiligentRendererLib : public RendererLib
{
public:
    DiligentRendererLib();
...
{
public:
    DiligentRenderer(QOpenGLWidget *widget);
    ~DiligentRenderer();
    ...
    friend class DiligentRendererLib;
    friend class DiligentRendererLibP;
