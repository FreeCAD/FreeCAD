...
void TaskAppearance::setupConnections()
{
    ...
    connect(ui->changeMode,
            qOverload<const QString&>(&QComboBox::activated),
            this,
            &TaskAppearance::onChangeModeActivated);
    connect(ui->changePlot,
            qOverload<const QString&>(&QComboBox::activated),
            this,
            &TaskAppearance::onChangePlotActivated);
#else
    connect(ui->changeMode,
    ...
    connect(ui->changePlot,
            ...
            &TaskAppearance::onChangePlotActivated);
#endif
    connect(ui->spinTransparency,
            qOverload<int>(&QSpinBox::valueChanged),
            this,
            &TaskAppearance::onTransparencyValueChanged);
    connect(ui->spinPointSize,
            qOverload<int>(&QSpinBox::valueChanged),
            this,
            &TaskAppearance::onPointSizeValueChanged);
    connect(ui->spinLineWidth,
            qOverload<int>(&QSpinBox::valueChanged),
            this,
            &TaskAppearance::onLineWidthValueChanged);
}
