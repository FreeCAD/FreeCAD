...
QIcon ViewProviderSuppressibleExtension::extensionMergeColorfullOverlayIcons(
...
void ViewProviderSuppressibleExtension::extensionSetupContextMenu(QMenu* menu,
                                                                  QObject*,
                                                                  const char*)
{
    auto vp = getExtendedViewProvider();
...
namespace Gui
{
EXTENSION_PROPERTY_SOURCE_TEMPLATE(Gui::ViewProviderSuppressibleExtensionPython,
