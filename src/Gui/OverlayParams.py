...
Params = [
    ...
    ParamInt(
        ...
        title="Layout delay (ms)",
        proxy=ParamSpinBox(0, 5000, 100),
    ),
    ParamInt("DockOverlayRevealDelay", 2000),
    ParamInt(
        "DockOverlaySplitterHandleTimeout",
        0,
        title="Splitter auto hide delay (ms)",
        proxy=ParamSpinBox(0, 99999, 100),
    ...
    ParamInt(
        ...
        1000,
        title="Delay mouse wheel pass through (ms)",
        proxy=ParamSpinBox(0, 99999, 1),
