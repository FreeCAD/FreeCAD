...
using GraphLinkContainer = boost::multi_index_container<
    ...
    BMI::indexed_by<
        ...
        BMI::ordered_unique<BMI::tag<GraphLinkRecord::ByVPDObject>,
                            BMI::member<GraphLinkRecord,
                                        const Gui::ViewProviderDocumentObject*,
                                        &GraphLinkRecord::VPDObject>>,
        BMI::ordered_unique<
        ...
        BMI::ordered_unique<BMI::tag<GraphLinkRecord::ByVertex>,
...
bool hasRecord(const ViewProviderDocumentObject* VPDObjectIn,
