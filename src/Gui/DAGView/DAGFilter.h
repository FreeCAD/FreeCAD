...
public:
    ...
    virtual bool goFilter(const Vertex& vertexIn,
                          const Graph& graphIn,
                          const GraphLinkContainer& linkIn) const = 0;
    QString name;
    bool enabled = true;
...
public:
    FilterOrigin();
    bool goFilter(const Vertex& vertexIn,
                  const Graph& graphIn,
                  const GraphLinkContainer& linkIn) const override;
};
