...
private:
    ...
    void slotChangeObject(const Gui::ViewProviderDocumentObject& VPDObjectIn,
    ...
    void slotChangeIcon(const Gui::ViewProviderDocumentObject& VPDObjectIn,
    ...
    Vertex lastAddedVertex =
        Graph::null_vertex();  //!< needed because python objects are not ready.
