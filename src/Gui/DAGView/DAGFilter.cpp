...
FilterBase::FilterBase()
    : name(QString::fromLatin1("empty name"))
{}
...
bool FilterOrigin::goFilter(const Vertex& vertexIn,
                            const Graph& graphIn,
...
FilterTyped::FilterTyped(const std::string& typeIn)
    : FilterBase()
    , type(typeIn)
{
...
bool FilterTyped::goFilter(const Gui::DAG::Vertex& vertexIn,
                           const Graph& graphIn,
                           const GraphLinkContainer& linkIn) const
{
    Q_UNUSED(graphIn);
