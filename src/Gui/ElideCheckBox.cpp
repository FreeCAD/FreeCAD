...
ElideCheckBox::ElideCheckBox(QWidget *parent)
    : QCheckBox(parent)
    , m_IndicatorWidth(style()->pixelMetric(QStyle::PM_IndicatorWidth, nullptr, this))
    , m_CheckBoxLabelSpacing(style()->pixelMetric(QStyle::PM_CheckBoxLabelSpacing, nullptr, this))
{
}
...
QSize ElideCheckBox::sizeHint() const {
    QFontMetrics fm(font());
    int width = fm.horizontalAdvance(this->text()) + m_IndicatorWidth + m_CheckBoxLabelSpacing;
...
QSize ElideCheckBox::minimumSizeHint() const {
    ...
    int width = fm.horizontalAdvance(minimumText) + m_IndicatorWidth + m_CheckBoxLabelSpacing;
    int height = fm.height();
    return {width, height};
}
