...
Py::Object MainWindowPy::createWrapper(MainWindow *mw)
{
    ...
    // copy attributes
    const std::initializer_list<const char*> attr = {"getWindows",
                                                     "getWindowsOfType",
                                                     "setActiveWindow",
                                                     "getActiveWindow",
                                                     "addWindow",
...
Py::Object MainWindowPy::showHint(const Py::Tuple& args)
{
    ...
    static auto hintFromPyObject = [](const Py::Object& object) -> Gui::InputHint {
        ...
        return {
            .message = object.getAttr("message").as_string(),
            .sequences = sequences
        };
    };
