...
public:
    ...
    ValueT canDropObjectEx(App::DocumentObject* obj,
                           App::DocumentObject*,
                           const char*,
                           const std::vector<std::string>& elements) const;
    /** Add an object with full qualified name to the view provider by drag and drop */
    bool dropObjectEx(App::DocumentObject* obj,
                      App::DocumentObject*,
                      const char*,
...
public:
    ...
    bool
    getDetailPath(const char* name, SoFullPath* path, bool append, SoDetail*& det) const override
    {
    ...
    bool canDropObjectEx(App::DocumentObject* obj,
    ...
    /** Add an object with full qualified name to the view provider by drag and drop */
    std::string dropObjectEx(App::DocumentObject* obj,
                             App::DocumentObject* owner,
                             const char* subname,
