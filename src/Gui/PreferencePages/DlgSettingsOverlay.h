...
#ifndef GUI_DIALOG_DLGSETTINGSOVERLAY_H
#define GUI_DIALOG_DLGSETTINGSOVERLAY_H
...
DlgSettingsOverlay.declare_begin()
]]]*/
 ...
 * This class is auto generated by Gui/PreferencePages/DlgSettingsOverlay.py. Modify that file
 ...
 * @code
 *     python3 -m cogapp -r Gui/PreferencePages/DlgSettingsOverlay.h Gui/PreferencePages/DlgSettingsOverlay.cpp
 * @endcode
 */
class DlgSettingsOverlay : public Gui::Dialog::PreferencePage
{
    Q_OBJECT

public:
    DlgSettingsOverlay( QWidget* parent = 0 );
    ~DlgSettingsOverlay();
...
/*[[[cog
import DlgSettingsOverlay
DlgSettingsOverlay.declare_end()
]]]*/
...
//[[[end]]]
#endif // GUI_DIALOG_DLGSETTINGSOVERLAY_H
