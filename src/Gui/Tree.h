...
private:
    ...
    bool dropInObject(QDropEvent* event,
                      TargetItemInfo& targetInfo,
                      std::vector<ObjectItemSubname> items);
    bool dropInDocument(QDropEvent* event,
                        TargetItemInfo& targetInfo,
                        std::vector<ObjectItemSubname> items);
    bool canDragFromParents(DocumentObjectItem* parentItem,
                            App::DocumentObject* obj,
                            App::DocumentObject* target);
    void sortDroppedObjects(TargetItemInfo& targetInfo,
...
protected:
    ...
    void slotHighlightObject(const Gui::ViewProviderDocumentObject&,
                             const Gui::HighlightMode&,
                             bool,
                             const App::DocumentObject* parent,
                             const char* subname);
    void slotExpandObject(const Gui::ViewProviderDocumentObject&,
    ...
    DocumentObjectItem*
    findItemByObject(bool sync, App::DocumentObject* obj, const char* subname, bool select = false);

    DocumentObjectItem*
    findItem(bool sync, DocumentObjectItem* item, const char* subname, bool select = true);
...
private:
    ...
    void applyExpandedSnapshot(const std::vector<bool>& snapshot,
