...
{
    connect(ui->buttonRatioScreen,
            &QToolButton::clicked,
            this,
            &DlgSettingsImageImp::onButtonRatioScreenClicked);
    connect(ui->buttonRatio4x3,
            &QToolButton::clicked,
            this,
            &DlgSettingsImageImp::onButtonRatio4x3Clicked);
    connect(ui->buttonRatio16x9,
            &QToolButton::clicked,
            this,
            &DlgSettingsImageImp::onButtonRatio16x9Clicked);
    connect(ui->buttonRatio1x1,
            &QToolButton::clicked,
            this,
            &DlgSettingsImageImp::onButtonRatio1x1Clicked);
    connect(ui->standardSizeBox,
            qOverload<int>(&QComboBox::activated),
            this,
            &DlgSettingsImageImp::onStandardSizeBoxActivated);
    connect(ui->comboMethod,
            qOverload<int>(&QComboBox::activated),
            this,
            &DlgSettingsImageImp::onComboMethodActivated);
}
