 ...
 * toolbox with removeItem(). Combining removeItem() and insertItem() allows to move items to
 * different positions.
 *
 ...
 * removeItem(), which also deletes the item to be removed. \author Werner Mayer
 */
