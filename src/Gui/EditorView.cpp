    ...
    , WindowParameter("Editor")
{
    ...
    connect(d->activityTimer, &QTimer::timeout, this, &EditorView::checkTimestamp);
    connect(d->textEdit->document(),
            &QTextDocument::modificationChanged,
            this,
            &EditorView::setWindowModified);
    connect(d->textEdit->document(),
            &QTextDocument::undoAvailable,
            this,
            &EditorView::undoAvailable);
    connect(d->textEdit->document(),
            &QTextDocument::redoAvailable,
            this,
            &EditorView::redoAvailable);
    connect(d->textEdit->document(),
            &QTextDocument::contentsChange,
            this,
            &EditorView::contentsChange);
}
