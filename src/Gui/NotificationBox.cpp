...
class NotificationLabel: public QLabel
{
    Q_OBJECT
public:
    NotificationLabel(const QString& text,
                      const QPoint& pos,
                      int displayTime,
                      int minShowTime = 0,
                      int width = 0);
...
NotificationLabel::NotificationLabel(const QString& text,
                                     const QPoint& pos,
                                     int displayTime,
                                     int minShowTime,
                                     int width)
...
void NotificationLabel::reuseNotification(const QString& text,
                                          int displayTime,
                                          const QPoint& pos,
                                          int width)
{
...
bool NotificationBox::showText(const QPoint& pos,
                               const QString& text,
