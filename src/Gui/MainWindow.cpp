...
void MainWindow::showHints(const std::list<InputHint>& hints)
{
    ...
    static const auto maybeIconPath = [](const InputHint::UserInput key) -> std::optional<const char*> {
        switch (key) {
    ...
    static const auto generateKeyIcon = [](const InputHint::UserInput key,
        ...
        const QString text = QString::fromUtf8(stringifyUserInput(key));
