...
{
    sGroup        = "Macro";
    sMenuText     = QT_TR_NOOP("Open containing folder");
    sToolTipText  = QT_TR_NOOP("Open containing folder by default system file manager");
    sWhatsThis    = "Std_OpenMacrosFolder";
    sStatusTip    = QT_TR_NOOP("Open containing folder by default system file manager");
    sPixmap       = nullptr;
    sAccel        = "";
    eType         = 0;
}
