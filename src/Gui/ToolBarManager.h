...
public:
    ...
    QString currentAutoArrangeToolbarLayoutLabel() const;
    QString currentShowRecommendedOnlyLabel() const;
    void autoArrangeCurrentToolbarLayout();
...
private:
    ...
    void moveToolBarToMainWindow(QToolBar* toolbar, bool preserveHostedPlacement = false) const;
    ...
    ParameterGrp::handle sharedToolBarLayoutGroup() const;
    void saveWorkbenchToolBarLayout(const ToolbarScopeId& context) const;
    void autoArrangeMainWindowToolBarLayout(const ToolbarScopeId& context) const;
    bool recommendedToolBarVisibility(const QToolBar* toolbar) const;
    void applyRecommendedToolBarVisibility(const ToolbarScopeId& context);
...
private:
    ...
    ParameterGrp::handle hMainWindowParams;
    ...
    bool sharedToolBarLayoutReady = false;
};
