...
public:
    ...
    View3DInventorViewer(const QtGLFormat& format,
                         QWidget* parent,
    ...
    void startAnimation(const SbRotation& orientation,
    ...
    void
    imageFromFramebuffer(int width, int height, int samples, const QColor& bgcolor, QImage& img);
     ...
     */
    SoPickedPoint*
    getPointOnRay(const SbVec3f& pos, const SbVec3f& dir, const ViewProvider* vp) const;
    ...
    void toggleClippingPlane(int toggle = -1,
