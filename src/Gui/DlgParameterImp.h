...
protected Q_SLOTS:
     ...
     */
    bool
    edit(const QModelIndex& index, QAbstractItemView::EditTrigger trigger, QEvent* event) override;
...
public:
    /// Constructor
    ParameterText(QTreeWidget* parent,
                  QString label1,
                  const char* value,
...
public:
    /// Constructor
    ParameterInt(QTreeWidget* parent,
                 QString label1,
                 long value,
                 const Base::Reference<ParameterGrp>& hcGrp);
...
public:
    /// Constructor
    ParameterUInt(QTreeWidget* parent,
                  QString label1,
                  unsigned long value,
                  const Base::Reference<ParameterGrp>& hcGrp);
...
public:
    /// Constructor
    ParameterFloat(QTreeWidget* parent,
                   QString label1,
                   double value,
                   const Base::Reference<ParameterGrp>& hcGrp);
...
public:
    /// Constructor
    ParameterBool(QTreeWidget* parent,
                  QString label1,
                  bool value,
                  const Base::Reference<ParameterGrp>& hcGrp);
