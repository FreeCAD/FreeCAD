...
TEST(Expression, tokenize)
{
    ...
    EXPECT_EQ(App::ExpressionTokenizer().perform(QString::fromUtf8("0.00000 \xC2\xB0-s"), 11), QLatin1String("s"));
    EXPECT_EQ(App::ExpressionTokenizer().perform(QString::fromUtf8("0.00000 \xC2\xB0-ss"), 12), QLatin1String("ss"));
    EXPECT_EQ(App::ExpressionTokenizer().perform(QString::fromUtf8("0.00000 deg"), 5), QString());
    EXPECT_EQ(App::ExpressionTokenizer().perform(QString::fromUtf8("0.00000 deg"), 11), QLatin1String("deg"));
}
...
{
    EXPECT_EQ(App::ExpressionTokenizer().perform(QLatin1String("p"), 1), QLatin1String("p"));
    EXPECT_EQ(App::ExpressionTokenizer().perform(QLatin1String("pi"), 2), QString());
    EXPECT_EQ(App::ExpressionTokenizer().perform(QLatin1String("pi "), 3), QString());
    EXPECT_EQ(App::ExpressionTokenizer().perform(QLatin1String("pi r"), 4), QLatin1String("r"));
    EXPECT_EQ(App::ExpressionTokenizer().perform(QLatin1String("pi ra"), 5), QLatin1String("ra"));
    EXPECT_EQ(App::ExpressionTokenizer().perform(QLatin1String("pi rad"), 6), QLatin1String("rad"));
    EXPECT_EQ(App::ExpressionTokenizer().perform(QLatin1String("pi rad"), 2), QString());
}
