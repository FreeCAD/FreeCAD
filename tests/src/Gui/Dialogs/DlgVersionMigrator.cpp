...
private Q_SLOTS:
    ...
    {
        std::string userConfigDir = Base::FileInfo::stringToPath(
            std::filesystem::temp_directory_path() / "Config"
        );
        std::string userAppDataDir = Base::FileInfo::stringToPath(
    ...
    void generateNewUserAppPathString_no_version_now()
    {
        ...
        std::string expectedPath = Base::FileInfo::stringToPath(testPath / expectedAddition);
    ...
    void generateNewUserAppPathString_version_in_current()
    {
        ...
        std::string expectedPath = Base::FileInfo::stringToPath(
    ...
    void locateNewPreferences()
    {
        ...
        std::string actualNewPreferencesString = worker->testableLocateNewPreferences();
