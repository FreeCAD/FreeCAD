...
13. If PR contains work of another author, for example is cherry-picked from some fork by non-author, the message MUST contain proper attribution as first line of the message, for example: "This is work of XYZ cherry-picked from <link>".
