...
14. Contributions must meet existing quality standards. Raw AI output is not accepted under any circumstances. This is not limited to code. It also applies to tests, documentation, translations, UI text, issue reports, pull request descriptions, review comments, design discussions, and any other project contribution. AI-generated content must not be submitted as-is in any part of the project. AI may be used only as an assistive tool; in all cases, the resulting content must be reviewed, validated, and justifiable by the contributor. The contributor should be able to explain design and code decisions, answer reviewers’ questions, and ensure that AI use does not waste reviewers’ time during review. Maintainers are expected to enforce this policy and may use any appropriate tools or take any necessary initiative to do so. That being said, the use of AI is not recommended under any circumstances or in any manner.
