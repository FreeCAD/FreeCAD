...
!define APP_NAME "Parashell"
!define APP_VERSION_NUMBER "${APP_VERSION_MAJOR}.${APP_VERSION_MINOR}.${APP_VERSION_PATCH}.${APP_VERSION_BUILD}"
# For the proposed install folder we use the scheme "Parashell 0.18"
# however for the Registry, we need the scheme "Parashell 0.18.x" in order
...
# Fixme: should use different preferences folder for every release
...
!define APP_WEBPAGE "https://www.parashell.cloud/"
!define APP_WEBPAGE_INFO "${APP_NAME} Website"
!define APP_WIKI "https://www.parashell.cloud/docs"
!define APP_WIKI_INFO "${APP_NAME} Documentation"
!define APP_COPYRIGHT "${APP_NAME} is Copyright © 2001-${COPYRIGHT_YEAR} by the ${APP_NAME} Team (built upon FreeCAD)"
