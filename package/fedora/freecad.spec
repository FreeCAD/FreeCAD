...
skip="${skip-}${skip+}FileInfoTest.TestDirectoryPath|"
...
skip="${skip-}${skip+}PropertyTopoShapeTest.testRestore|"
skip="${skip-}${skip+}PadTest.TestMidPlaneTwoLength|"
skip="${skip-}${skip+}BackwardCompatibilityTest.TestOpenV021Model|"
skip="${skip-}${skip+}SketchObjectTest.testSplitLineSegment|"
skip="${skip-}${skip+}SketchObjectTest.testSplitCircle|"
skip="${skip-}${skip+}SketchObjectTest.testSplitEllipse|"
skip="${skip-}${skip+}SketchObjectTest.testSplitArcOfCircle|"
skip="${skip-}${skip+}SketchObjectTest.testSplitArcOfConic|"
skip="${skip-}${skip+}SketchObjectTest.testSplitNonPeriodicBSpline|"
skip="${skip-}${skip+}SketchObjectTest.testSplitPeriodicBSpline|"
skip="${skip-}${skip+}SketchObjectTest.testTrimWithoutIntersection|"
skip="${skip-}${skip+}SketchObjectTest.testTrimLineSegmentEnd|"
skip="${skip-}${skip+}SketchObjectTest.testTrimLineSegmentMid|"
skip="${skip-}${skip+}SketchObjectTest.testTrimCircleEnd|"
skip="${skip-}${skip+}SketchObjectTest.testTrimCircleMid|"
skip="${skip-}${skip+}SketchObjectTest.testTrimArcOfCircleEnd|"
skip="${skip-}${skip+}SketchObjectTest.testTrimArcOfCircleMid|"
skip="${skip-}${skip+}SketchObjectTest.testTrimEllipseEnd|"
skip="${skip-}${skip+}SketchObjectTest.testTrimEllipseMid|"
skip="${skip-}${skip+}SketchObjectTest.testTrimPeriodicBSplineEnd|"
skip="${skip-}${skip+}SketchObjectTest.testTrimPeriodicBSplineMid|"
skip="${skip-}${skip+}SketchObjectTest.testTrimNonPeriodicBSplineEnd|"
skip="${skip-}${skip+}SketchObjectTest.testTrimNonPeriodicBSplineMid|"
skip="${skip-}${skip+}SketchObjectTest.testTrimEffectOnConstruction|"
skip="${skip-}${skip+}SketchObjectTest.testTrimEndEffectOnFullLengthConstraints|"
skip="${skip-}${skip+}SketchObjectTest.testTrimEndEffectOnSymmetricConstraints|"
skip="${skip-}${skip+}SketchObjectTest.testTrimEndEffectOnUnrelatedTangent|"
skip="${skip-}${skip+}SketchObjectTest.testModifyKnotMultInNonPeriodicBSplineToZero|"
skip="${skip-}${skip+}SketchObjectTest.testModifyKnotMultInNonPeriodicBSplineToDisallowed|"
skip="${skip-}${skip+}SketchObjectTest.testModifyKnotMultInNonPeriodicBSpline|"
skip="${skip-}${skip+}SketchObjectTest.testModifyKnotMultInPeriodicBSplineToZero|"
skip="${skip-}${skip+}SketchObjectTest.testModifyKnotMultInPeriodicBSplineToDisallowed|"
skip="${skip-}${skip+}SketchObjectTest.testModifyKnotMultInPeriodicBSpline|"
skip="${skip-}${skip+}SketchObjectTest.testInsertKnotInNonPeriodicBSpline|"
skip="${skip-}${skip+}SketchObjectTest.testInsertKnotInPeriodicBSpline|"
skip="${skip-}${skip+}SketchObjectTest.testJoinCurves|"
skip="${skip-}${skip+}SketchObjectTest.testJoinCurvesWhenTangent|"
skip="${skip-}${skip+}SketchObjectTest.testGetPointFromGeomPoint|"
skip="${skip-}${skip+}SketchObjectTest.testGetPointFromGeomLineSegment|"
skip="${skip-}${skip+}SketchObjectTest.testGetPointFromGeomCircle|"
skip="${skip-}${skip+}SketchObjectTest.testGetPointFromGeomEllipse|"
skip="${skip-}${skip+}SketchObjectTest.testGetPointFromGeomArcOfCircle|"
skip="${skip-}${skip+}SketchObjectTest.testGetPointFromGeomArcOfEllipse|"
skip="${skip-}${skip+}SketchObjectTest.testGetPointFromGeomArcOfHyperbola|"
skip="${skip-}${skip+}SketchObjectTest.testGetPointFromGeomArcOfParabola|"
skip="${skip-}${skip+}SketchObjectTest.testGetPointFromGeomBSplineCurveNonPeriodic|"
skip="${skip-}${skip+}SketchObjectTest.testGetPointFromGeomBSplineCurvePeriodic|"
skip="${skip-}${skip+}SketchObjectTest.testConstraintAfterDeletingGeo|"
skip="${skip-}${skip+}SketchObjectTest.testDeleteExposeInternalGeometryOfEllipse|"
skip="${skip-}${skip+}SketchObjectTest.testDeleteExposeInternalGeometryOfHyperbola|"
skip="${skip-}${skip+}SketchObjectTest.testDeleteExposeInternalGeometryOfParabola|"
skip="${skip-}${skip+}SketchObjectTest.testDeleteExposeInternalGeometryOfBSpline|"
