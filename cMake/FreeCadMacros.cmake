...
function(SET_BIN_DIR ProjectName)
    ...
    elseif(RELATIVE_RPATH)
        ...
        if(APPLE)
            set(RPATH "@loader_path/${RPATH}")
            set_property(TARGET ${ProjectName} PROPERTY BUILD_RPATH_USE_ORIGIN ON)
        else()
            set(RPATH "$ORIGIN/${RPATH}")
        endif()
        set_property(TARGET ${ProjectName} PROPERTY INSTALL_RPATH "${RPATH}")
