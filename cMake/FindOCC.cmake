...
if (OCC_FOUND)
    ...
    foreach(lib IN LISTS OCC_LIBRARIES OCC_OCAF_LIBRARIES)
        if(NOT TARGET ${lib})
            message(SEND_ERROR "OpenCASCADE library ${lib} could not be found. Did you install all the required packages?")
        endif()
    endforeach()
endif () 
