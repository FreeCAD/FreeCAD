...
if (OCE_FOUND)
    ...
    # Disable this define. For more details see bug #0001872 add_definitions (-DHAVE_CONFIG_H)
    ...
    if (NOT OCCT_CMAKE_FALLBACK)
        ...
        if (NOT (CMAKE_VERSION VERSION_LESS 3.6.0))
            ...
            # OCCT 7.5 adds this define that causes hundreds of compiler warnings with Qt5.x, so
            # remove it again
    ...
    if (OpenCASCADE_FOUND)
        ...
        if (WIN32)
            if (CYGWIN OR MINGW)
                find_path (
                    OCC_INCLUDE_DIR Standard_Version.hxx /usr/include/opencascade
                    /usr/local/include/opencascade /opt/opencascade/include /opt/opencascade/inc)
...
# handle the QUIETLY and REQUIRED arguments and set OCC_FOUND to TRUE if all listed variables are
# TRUE
include (FindPackageHandleStandardArgs)
find_package_handle_standard_args (
    OCC
    REQUIRED_VARS OCC_INCLUDE_DIR
    VERSION_VAR OCC_VERSION_STRING)
...
if (OCC_FOUND)
    ...
    # message(SEND_ERROR "Neither OpenCASCADE Community Edition nor OpenCasCade were found: will not
    # build CAD modules!")
endif (OCC_FOUND)
