macro(SetupSalomeSMESH)
    ...
    if(BUILD_SMESH)
        # set the internal smesh version: see src/3rdParty/salomonemesh/CMakeLists.txt and commit
        # https://github.com/FreeCAD/FreeCAD/commit/666a3e5 and
        # https://forum.freecad.org/viewtopic.php?f=10&t=30838
        ...
        if(UNIX OR WIN32)
            # Module names changed between 8 and 9, so do a QUIET find for 9 and its module name
            # first, and fall back to v7 minimum with the old component name if it is not found.
            find_package(
                VTK 9
            ...
            if(${VTK_MAJOR_VERSION} LESS 9)
                ...
                list(
                    APPEND
                    VTK_COMPONENTS
                    "IOMPIParallel;ParallelMPI;hdf5;FiltersParallelDIY2;RenderingCore;InteractionStyle;RenderingFreeType;RenderingOpenGL2"
                )
                foreach(_module ${VTK_COMPONENTS})
        ...
        if(AVAILABLE_VTK_COMPONENTS)
            ...
            find_package(
                VTK
                COMPONENTS ${AVAILABLE_VTK_COMPONENTS}
                REQUIRED NO_MODULE)
        else()
        ...
        if(NOT FREECAD_USE_EXTERNAL_SMESH)
            ...
            if(MSVC)
                ...
                if(${matchres} EQUAL -1)
                    ...
                    set(HDF5_PREFER_PARALLEL TRUE) # if pkg-config fails, find_package(HDF5) needs
                                                   # this
                endif()
            ...
            # If this definition is not set, linker errors will occur against SMESH on 64 bit
            # machines.
        ...
        configure_file(${CMAKE_SOURCE_DIR}/src/SMESH_Version.h.cmake
                       ${CMAKE_CURRENT_BINARY_DIR}/SMESH_Version.h)
    endif(BUILD_SMESH)
