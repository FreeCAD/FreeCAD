macro(PrintFinalReport)
    ...
    message(STATUS "Qt Core:             ${Qt6Core_VERSION}${Qt5Core_VERSION}")
    message(STATUS "Qt Network:          ${Qt6Network_VERSION}${Qt5Network_VERSION}")
    message(STATUS "Qt Xml:              ${Qt6Xml_VERSION}${Qt5Xml_VERSION}")
    message(STATUS "Qt Core5Compat:      ${Qt6Core5Compat_VERSION}${Qt5Core5Compat_VERSION}")
    if (BUILD_GUI)
        message(STATUS "Qt Widgets:          ${Qt6Widgets_VERSION}${Qt5Widgets_VERSION}")
        message(STATUS "Qt PrintSupport:     ${Qt6PrintSupport_VERSION}${Qt5PrintSupport_VERSION}")
        message(STATUS "Qt OpenGL:           ${Qt6OpenGL_VERSION}${Qt5OpenGL_VERSION}")
        message(STATUS "Qt Svg:              ${Qt6Svg_VERSION}${Qt5Svg_VERSION}")
        message(STATUS "Qt UiTools:          ${Qt6UiTools_VERSION}${Qt5UiTools_VERSION}")
        message(STATUS "Qt Concurrent:       ${Qt6Concurrent_VERSION}${Qt5Concurrent_VERSION}")
        message(STATUS "Qt WinExtras:        ${Qt6WinExtras_VERSION}${Qt5WinExtras_VERSION}")
        message(STATUS "Qt WebKitWidgets:    ${Qt6WebKitWidgets_VERSION}${Qt5WebKitWidgets_VERSION} (BUILD_WEB)")
        message(STATUS "Qt WebEngineWidgets: ${Qt6WebEngineWidgets_VERSION}${Qt5WebEngineWidgets_VERSION} (BUILD_WEB)")
        message(STATUS "Designer plugin:     ${DESIGNER_PLUGIN_LOCATION}/${libFreeCAD_widgets} (BUILD_DESIGNER_PLUGIN)")
    endif()
