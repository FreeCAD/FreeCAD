    ...
    if(MSVC)
        ...
        if(FREECAD_LIBPACK_USE AND LIBPACK_FOUND)
            if(FREECAD_COPY_DEPEND_DIRS_TO_BUILD)
                ...
                file(COPY ${FREECAD_LIBPACK_DIR}/translations/qtwebengine_locales
            ...
            if(FREECAD_INSTALL_DEPEND_DIRS)
                ...
                install(DIRECTORY ${FREECAD_LIBPACK_DIR}/translations/qtwebengine_locales DESTINATION ${CMAKE_INSTALL_PREFIX}/bin)
