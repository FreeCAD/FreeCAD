macro(PrintFinalReport)
    ...
    if(BUILD_PDF_EXPORT_3D)
        conditional(libPRC libPRC_FOUND "not found" "Found")
        conditional(libharu libharu_FOUND "not found" "Found")
    else()
        simple(libPRC "not enabled (BUILD_PDF_EXPORT_3D is OFF)")
        simple(libharu "not enabled (BUILD_PDF_EXPORT_3D is OFF)")
    endif()
