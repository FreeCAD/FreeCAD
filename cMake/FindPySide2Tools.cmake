...
# Since Qt v5.14, pyside2-uic and pyside2-rcc are directly provided by Qt5Core uic and rcc, with '-g
# python' option We test Qt5Core version to act accordingly
...
if (Qt5Core_VERSION VERSION_LESS 5.14)
    # Legacy (< 5.14)
    find_program (
        PYSIDE2_UIC_EXECUTABLE
        NAMES python2-pyside2-uic pyside2-uic
              pyside2-uic-${PYTHON_VERSION_MAJOR}.${PYTHON_VERSION_MINOR} pyuic5
        HINTS ${PYSIDE_BIN_DIR})
    find_program (
        PYSIDE2_RCC_EXECUTABLE
        NAMES pyside2-rcc pyside2-rcc-${PYTHON_VERSION_MAJOR}.${PYTHON_VERSION_MINOR} pyrcc5
        HINTS ${PYSIDE_BIN_DIR})
    set (UICOPTIONS "")
    set (RCCOPTIONS "")
else ()
