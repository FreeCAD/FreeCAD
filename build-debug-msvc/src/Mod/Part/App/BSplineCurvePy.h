 ...
 */
class PartExport BSplineCurvePy : public Part::BoundedCurvePy
{
protected:
    ~BSplineCurvePy() override;
...
public:
    ...
    using PointerType = GeomBSplineCurve*;
    ...
    GeomBSplineCurve *getGeomBSplineCurvePtr() const;
