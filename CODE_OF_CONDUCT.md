...
Parashell is a fork of [FreeCAD](https://github.com/FreeCAD/FreeCAD), and we proudly adopt the FreeCAD Project Code of Conduct, reproduced below. It applies to everyone who takes part in the Parashell community — users, contributors, and maintainers alike.

## Statement

The Parashell and FreeCAD community covers people from a wide variety of countries, backgrounds, and positions. This global diversity is a great strength of the project, but can also lead to communication issues, which may in turn cause unhappiness. To maximise the happiness of the community taken as a whole, all members (whether users, contributors, or committers) are expected to abide by this code of conduct. At a high level the code can be summarized as *"be excellent to each other"*. Expanding on this:

- **Be respectful**: disagreements between people are to be expected and are usually the sign of healthy debate and engagement. Disagreements can lead to frustration and even anger for some members. Turning to personal insults, intimidation, or threatening behaviour does not improve the situation though. Participants should thus take care to ensure all communications and interactions stay professional at all times.

- **Be considerate**: remember that the community has members with a diverse background, many of whom have English as a second language. What might appear impolite may simply be the result of a lack of knowledge of the English language. Bear in mind that actions will have an impact on other community members and the project as a whole, so take potential consequences into account before pursuing a course of action.
...
Instances of abusive, harassing, or otherwise unacceptable behavior within the Parashell community may be reported by contacting the Parashell team at **ops@parashell.cloud**. For incidents that occur within upstream FreeCAD spaces, you may also contact the FreeCAD community admins or moderators at https://forum.freecad.org/memberlist.php?mode=team.
...
This Code of Conduct is adapted from the FreeCAD Project Code of Conduct, which is itself adapted from the [Contributor Covenant][homepage], version 1.4, available at https://www.contributor-covenant.org/version/1/4/code-of-conduct.html, and the [libvirt Code of Conduct][libvirtcoc], available at https://libvirt.org/governance.html.
